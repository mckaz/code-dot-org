...
"branches":function(d){return "ветки"},
...
"createSnowflakeSquare":function(d){return "создать снежинку в форме квадрата"},
"createSnowflakeParallelogram":function(d){return "создать снежинку в форме параллелограмма"},
"createSnowflakeLine":function(d){return "создать снежинку в форме линии"},
"createSnowflakeSpiral":function(d){return "создать снежинку в форме спирали"},
"createSnowflakeFlower":function(d){return "создать снежинку в форме цветка"},
"createSnowflakeFractal":function(d){return "создать снежинку фрактальной формы"},
"createSnowflakeRandom":function(d){return "создать снежинку произвольной формы"},
"createASnowflakeBranch":function(d){return "создать разветвленную снежинку"},
"degrees":function(d){return "градусов"},
"depth":function(d){return "глубина"},
"dots":function(d){return "пиксели"},
"drawACircle":function(d){return "нарисовать круг"},
...
"drawARocket":function(d){return "рисовать ракету"},
...
"jumpNortheastTooltip":function(d){return "Перемещает художника на северо-восток, не оставляя следов."},
"jumpNorthwestTooltip":function(d){return "Перемещает художника на северо-запад, не оставляя следов."},
"jumpSouthTooltip":function(d){return "Перемещает художника на юг, не оставляя следов."},
"jumpSoutheastTooltip":function(d){return "Перемещает художника на юго-восток, не оставляя следов."},
"jumpSouthwestTooltip":function(d){return "Перемещает художника на юго-запад, не оставляя следов."},
"jumpWestTooltip":function(d){return "Перемещает художника на запад, не оставляя следов."},
"lengthFeedback":function(d){return "У вас все правильно, кроме длины движения."},
"lengthParameter":function(d){return "длина"},
"loopVariable":function(d){return "счётчик"},
"moveBackward":function(d){return "переместить назад на"},
"moveEastTooltip":function(d){return "Перемещает художника на восток."},
"moveForward":function(d){return "переместить вперед на"},
...
"moveNortheastTooltip":function(d){return "Перемещает художника на северо-восток."},
"moveNorthwestTooltip":function(d){return "Перемещает художника на северо-запад."},
"moveSouthTooltip":function(d){return "Перемещает художника на юг."},
"moveSoutheastTooltip":function(d){return "Перемещает художника на юго-восток."},
"moveSouthwestTooltip":function(d){return "Перемещает художника на юго-запад."},
...
"notBlackColour":function(d){return "Для этой головоломки нужно выбрать цвет, отличный от черного."},
"numBlocksNeeded":function(d){return "Эта головоломка может быть решена с помощью %1 блоков. Использовано %2."},
...
"reinfFeedbackMsg":function(d){return "Вот твой рисунок! Продолжай над ним работать или перейди к следующей головоломке."},
"setAlpha":function(d){return "задать прозрачность"},
"setCharacter":function(d){return "set character to "+turtle_locale.v(d,"character")},
"setColour":function(d){return "задать цвет"},
"setPattern":function(d){return "задать шаблон"},
"setWidth":function(d){return "задать ширину"},
"shareDrawing":function(d){return "Поделиться рисунком:"},
...
"tooFewColours":function(d){return "Для этой головоломки нужно не менее %1 разных цветов. Ты использовал(а) только %2."},

...
module.exports = __webpack_require__(3424);
...
$(function () {
  ...
  if (appOptions.dialog.preTitle) {
    ...
    window.setTimeout(function () {
      return (0, _dialogHelper.showDialog)(_react2.default.createElement(_LegacyDialogContents.MatchAngiGifDialog, null));
    }, 1000);
  }
...
(0, _codeStudioLevels.registerGetResult)(function () {
  ...
  for (var index = 0; index < elements.length; index++) {
    var originalIndex = elements[index].getAttribute("originalIndex");
  ...
  return {
    response: response,
    result: !wrongAnswer,
    errorDialog: wrongAnswer ? _react2.default.createElement(_LegacyDialogContents.MatchErrorDialog, null) : null
  };
});

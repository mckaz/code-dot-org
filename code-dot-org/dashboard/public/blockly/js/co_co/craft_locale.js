...
"blockActionCollect":function(d){return "culletà"},
...
"blockActionMoveForward":function(d){return "avanzà"},
...
"blockMoveBackward":function(d){return "rinculà"},
"blockMoveForward":function(d){return "avanzà"},
...
"blockTurn":function(d){return "girà"},
"blockTurnLeft":function(d){return "girà à manca"},
"blockTurnRight":function(d){return "girà à diritta"},
...
"blockTypeGlass":function(d){return "bichjeru"},
"blockTypeGlowstone":function(d){return "glowstone"},
"blockTypeGrass":function(d){return "erba"},
"blockTypeGravel":function(d){return "gravetta"},
"blockTypeLava":function(d){return "lava"},
"blockTypeLogAcacia":function(d){return "troncu d'acacia"},
"blockTypeLogBirch":function(d){return "troncu di biolu"},
"blockTypeLogJungle":function(d){return "troncu di ghjangala"},
"blockTypeLogOak":function(d){return "troncu di querciu"},
"blockTypeLogSpruce":function(d){return "troncu d'abetu"},
"blockTypeOreCoal":function(d){return "minerale di carbone"},
"blockTypeOreDiamond":function(d){return "minerale di diamante"},
"blockTypeOreEmerald":function(d){return "minerale di smeraldu"},
"blockTypeOreGold":function(d){return "minerale d'oru"},
"blockTypeOreIron":function(d){return "minerale di feru"},
"blockTypeOreLapis":function(d){return "minerale di lapis-lazuli"},
"blockTypeOreRedstone":function(d){return "minerale di redstone"},
"blockTypePlanksAcacia":function(d){return "tavula d'acacia"},
"blockTypePlanksBirch":function(d){return "tavula di biolu"},
"blockTypePlanksJungle":function(d){return "tavula di legnu trupicale"},
"blockTypePlanksOak":function(d){return "tavula di querciu"},
...
"miniBlockGravel":function(d){return "gravetta"},
...
"miniBlockLogAcacia":function(d){return "troncu d'acacia"},
"miniBlockLogBirch":function(d){return "troncu di biolu"},
"miniBlockLogJungle":function(d){return "troncu di ghjangala"},
"miniBlockLogOak":function(d){return "troncu di querciu"},
"miniBlockLogSpruce":function(d){return "troncu d'abetu"},
"miniBlockMilk":function(d){return "milk"},
"miniBlockPlanksAcacia":function(d){return "tavula d'acacia"},
"miniBlockPlanksBirch":function(d){return "tavula di biolu"},
"miniBlockPlanksJungle":function(d){return "tavula di legnu trupicale"},
"miniBlockPlanksOak":function(d){return "tavula di querciu"},

...
"startButton":function(d){return "เริ่มต้น"},
...
"filterGrades":function(d){return "ระดับชั้น"},
"filterGradesAll":function(d){return "ทุกเพศทุกวัย"},
"filterGradesPre":function(d){return "อ่านก่อน"},
...
"filterStudentExperienceBeginner":function(d){return "ผู้เริ่มต้น"},
...
"filterPlatformNoComputers":function(d){return "ไม่มีคอมพิวเตอร์หรืออุปกรณ์"},
"filterTopics":function(d){return "หัวข้อ"},
"filterTopicsScience":function(d){return "วิทยาศาสตร์"},
"filterTopicsMath":function(d){return "คำนวณ"},
"filterTopicsHistory":function(d){return "สังคมศึกษา"},
"filterTopicsLa":function(d){return "ศิลปะการใช้ภาษา"},
"filterTopicsArt":function(d){return "ศิลปะ สื่อ เพลง"},
"filterTopicsCsOnly":function(d){return "วิทยาการคอมพิวเตอร์เท่านั้น"},
"filterActivityType":function(d){return "ชนิดกิจกรรม"},
...
"filterLength":function(d){return "ความยาว"},
"filterLength1Hour":function(d){return "หนึ่งชั่วโมง"},
"filterLength1HourFollow":function(d){return "One hour with follow-on"},
"filterLengthFewHours":function(d){return "ไม่กี่ขั่วโมง"},
"filterProgrammingLanguage":function(d){return "ภาษา"},
"filterProgrammingLanguageBlocks":function(d){return "บล็อก"},
"filterProgrammingLanguageTyping":function(d){return "กำลังพิมพ์"},
"filterProgrammingLanguageOther":function(d){return "อาชีพอื่น ๆ"},
"filterActivityTypeRobotics":function(d){return "หุ่นยนต์"},
"backButtonBack":function(d){return "กลับไปที่กิจกรรมทั้งหมด"},
"filterHeaderShowFilters":function(d){return "Filters"},
"filterHeaderHideFilters":function(d){return "นำไปใช้"},
"filterHeaderTutorialCountSingle":function(d){return "1 ผลลัพธ์"},
"filterHeaderTutorialCountPlural":function(d){return tutorialExplorer_locale.v(d,"tutorial_count")+" ผลลัพธ์"},
...
"tutorialDetailInternationalLanguages":function(d){return "ภาษา"},
"tutorialDetailStandards":function(d){return "มาตรฐาน"},
"tutorialDetailDisabled":function(d){return "This tutorial is temporarily unavailable."},
"headingTutorialsYourLanguage":function(d){return "กิจกรรมในภาษาของคุณ"},
"showAllTutorialsButton":function(d){return "แสดงกิจกรรมสำหรับหลายภาษา"},
"hideAllTutorialsButton":function(d){return "ซ่อนกิจกรรมสำหรับหลายภาษา"},
"noTutorialsYourLanguage":function(d){return "ไม่มีกิจกรรมที่รองรับภาษาของคุณ ลองกิจกรรมในภาษาอื่นโดยกดปุ่มด้านล่าง"},

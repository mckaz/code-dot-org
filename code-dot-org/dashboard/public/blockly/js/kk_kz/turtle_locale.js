...
"jumpNortheastTooltip":function(d){return "Ешқандай белгі қалдырмастан ойыншыны солтүстік-шығысқа қарай қозғалту."},
"jumpNorthwestTooltip":function(d){return "Ешқандай белгі қалдырмастан ойыншыны солтүстік-батысқа қарай қозғалту."},
"jumpSouthTooltip":function(d){return "Ешқандай белгі қалдырмастан ойыншыны оңтүстікке қарай қозғалту."},
"jumpSoutheastTooltip":function(d){return "Ешқандай белгі қалдырмастан ойыншыны оңтүстік-шығысқа қарай қозғалту."},
"jumpSouthwestTooltip":function(d){return "Ешқандай белгі қалдырмастан ойыншыны оңтүстік-батысқа қарай қозғалту."},
...
"moveNortheastTooltip":function(d){return "Ойыншыны солтүстік-шығысқа қарай қозғалтады."},
"moveNorthwestTooltip":function(d){return "Ойыншыны солтүстік-батысқа қарай қозғалтады."},
"moveSouthTooltip":function(d){return "Ойыншыны оңтүстікке қарай қозғалту."},
"moveSoutheastTooltip":function(d){return "Ойыншыны оңтүстік-шығысқа қарай қозғалтады."},
"moveSouthwestTooltip":function(d){return "Ойыншыны оңтүстік-батысқа қарай қозғалтады."},

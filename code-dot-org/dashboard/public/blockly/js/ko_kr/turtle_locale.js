...
"jumpNortheastTooltip":function(d){return "이동하는 흔적 없이 예술가를 오른쪽 위로 점프시킵니다."},
"jumpNorthwestTooltip":function(d){return "이동하는 흔적 없이 예술가를 왼쪽 위로 점프시킵니다."},
"jumpSouthTooltip":function(d){return "예술가를 아래쪽으로 점프시킵니다."},
"jumpSoutheastTooltip":function(d){return "이동하는 흔적 없이 예술가를 오른쪽 아래로 점프시킵니다."},
"jumpSouthwestTooltip":function(d){return "이동하는 흔적 없이 예술가를 왼쪽 아래로 점프시킵니다."},
...
"moveNortheastTooltip":function(d){return "예술가를 오른쪽 위로 이동시킵니다."},
"moveNorthwestTooltip":function(d){return "예술가를 왼쪽 위로 이동시킵니다."},
"moveSouthTooltip":function(d){return "예술가를 아래쪽으로 이동시킵니다."},
"moveSoutheastTooltip":function(d){return "예술가를 오른쪽 아래로 이동시킵니다."},
"moveSouthwestTooltip":function(d){return "예술가를 왼쪽 아래로 이동시킵니다."},

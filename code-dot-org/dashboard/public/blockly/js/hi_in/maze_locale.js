...
"collect":function(d){return "एकत्र"},
"collectiblePresent":function(d){return "वहाँ कुछ खजाना है"},
"collectorCollectTooltip":function(d){return "कोई आइटम ले लीजिए"},
...
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"hi",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
...
"corn":function(d){return "मकई"},
"cornTooltip":function(d){return "कुछ मकई फसल"},
"didNotCollectAllCrops":function(d){return "सुनिश्चित करें कि आप किसी भी फसलों के पीछे मत छोड़ो!"},
"didNotCollectEverything":function(d){return "सुनिश्चित करें कि आप किसी भी अमृत या शहद के पीछे मत छोड़ो!"},
"didNotPlantEverywhere":function(d){return "सुनिश्चित करें कि आप कुछ हर मिट्टी पैच में संयंत्र!"},
...
"emptyCropError":function(d){return "जो फसल सब चला गया है।"},
...
"has":function(d){return "है"},
"haslettuce":function(d){return "सलाद पत्ता है"},
"hascorn":function(d){return "मकई है"},
"haspumpkin":function(d){return "कद्दू हैं"},
...
"lettuce":function(d){return "सलाद पत्ता"},
"lettuceTooltip":function(d){return "कुछ सलाद फसल"},
"make":function(d){return "कर"},
...
"pick":function(d){return "उठाओ"},
"pilePresent":function(d){return "वहाँ एक ढेर है"},
"plant":function(d){return "संयंत्र"},
...
"word":function(d){return "शब्द को ढूंडे"},

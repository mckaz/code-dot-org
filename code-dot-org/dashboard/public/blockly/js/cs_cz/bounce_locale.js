...
"basketballLaunchBall":function(d){return "hoď nový míč"},
"basketballLaunchBallTooltip":function(d){return "Hodit míč do hry."},
"basketballSetPaddle":function(d){return "Nastavit ručně"},
"basketballSetPaddleSpeedFast":function(d){return "nastavit vysokou rychlost ruky"},
"basketballSetPaddleSpeedNormal":function(d){return "nastavit normální rychlost ruky"},
"basketballSetPaddleSpeedRandom":function(d){return "nastavit náhodnou rychlost ruky"},
"basketballSetPaddleSpeedSlow":function(d){return "nastavit pomalou rychlost ruky"},
"basketballSetPaddleSpeedTooltip":function(d){return "Nastaví rychlost ruky"},
"basketballSetPaddleSpeedVeryFast":function(d){return "nastavit velmi rychlou rychlost ruky"},
"basketballSetPaddleSpeedVerySlow":function(d){return "nastavit velmi pomalou rychlost ruky"},
"basketballWhenBallMissesPaddle":function(d){return "když míč mine ruku"},
"basketballWhenPaddleCollided":function(d){return "když míč udeří do ruky"},
"bounceBall":function(d){return "odrazit míč"},
"bounceBallTooltip":function(d){return "Odrazit míč mimo předmět."},
...
"playSoundCheer":function(d){return "přehrát zvuk jásotu"},
...
"playSoundKick":function(d){return "přehrát zvuk kopnutí"},
...
"playSoundSlapshot":function(d){return "přehrej zvuk foťáku"},
"playSoundSwish":function(d){return "přehrát zvuk švihnutí sítí"},
"playSoundTooltip":function(d){return "Přehraj vybraný zvuk."},
"playSoundWhistle":function(d){return "přehrát zvuk pískání"},
...
"setBackground":function(d){return "nastavit"+bounce_locale.v(d,"background")+" scény"},
...
"setBall":function(d){return "nastavit"+bounce_locale.v(d,"ball")+" míč"},
...
"setBallSpeedTooltip":function(d){return "Nastavit rychlost míče"},
...
"setPaddle":function(d){return "nastavit pádlo"},
...
"setPaddleSpeedTooltip":function(d){return "Nastavit rychlost odpalu"},
...
"setPaddleTooltip":function(d){return "Nastavit vzhled pálky"},
"setPlayer":function(d){return "nastavit hráče"},
"setPlayerSpeedFast":function(d){return "nastavit vysokou rychlost hráče"},
"setPlayerSpeedNormal":function(d){return "nastavit normální rychlost hráče"},
"setPlayerSpeedRandom":function(d){return "nastavit náhodnou rychlost hráče"},
"setPlayerSpeedSlow":function(d){return "nastavit pomalou rychlost hráče"},
"setPlayerSpeedTooltip":function(d){return "Nastaví rychlost hráče"},
"setPlayerSpeedVeryFast":function(d){return "nastavit velkou rychlost hráče"},
"setPlayerSpeedVerySlow":function(d){return "nastavit velmi pomalou rychlost hráče"},
"setTeamTooltip":function(d){return "Nastavit logo a barevné schéma"},
"setTeam":function(d){return "Nastavit tým"+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Nastavit tým náhodně"},
...
"whenBallMissesPlayer":function(d){return "když míč mine hráče"},
...
"whenPlayerCollided":function(d){return "kryž míč zasáhne hráče"},
"whenPlayerCollidedTooltip":function(d){return "Spusťte níže uvedené akce, když se míč dotkne hráče."},

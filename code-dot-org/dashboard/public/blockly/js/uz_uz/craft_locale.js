...
"blockActionAdd":function(d){return "qo‘shing"},
...
"blockActionRepeat":function(d){return "takrorlash"},
...
"blockTypeGrass":function(d){return "maysa"},
...
"blockTypeStone":function(d){return "tosh"},
"blockTypeTnt":function(d){return "tnt"},
"blockTypeTree":function(d){return "daraxt"},
"blockTypeWater":function(d){return "water"},
"blockTypeWool":function(d){return "jun"},
...
"cancel":function(d){return "Bekor qilish"},
...
"houseSelectHard":function(d){return "Qiyin"},
...
"miniBlockWool":function(d){return "jun"},
...
"playerSelectChooseSelectButton":function(d){return "Tanlang"},
"playerSelectLetsGetStarted":function(d){return "Keling boshlaymiz."},
"quantity":function(d){return "quantity"},
"reinfFeedbackMsg":function(d){return "O'ynayotgan o'yiningizga qaytish uchun \"O'ynashni davom etish\" tugmasini bosing."},
"relative":function(d){return "relative"},
"runAgent":function(d){return "Run Agent"},
"score":function(d){return "Score"},
"seconds":function(d){return "second(s)"},
"selectChooseButton":function(d){return "Tanlang"},
...
"timeDay":function(d){return "kun"},
"timeLong":function(d){return "long"},
"timeMedium":function(d){return "medium"},
"timeNight":function(d){return "qorong‘u"},
"timeRandom":function(d){return "tasodifiy"},

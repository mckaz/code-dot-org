...
"flapTooltip":function(d){return "Flyg Flakse oppover."},
...
"shareFlappyTwitter":function(d){return "Sjekk ut Flakse-spillet eg har laga! Eg laga det sjølv med @codeorg"},
"shareFlappyTwitterDonor":function(d){return "Sjekk flaksespelet eg har laga! (Takk til "+flappy_locale.v(d,"donor")+" for å støtte @codeorg)"},
...
"whenCollideGroundTooltip":function(d){return "Utfør setningane nedanfor når Flakse treff bakken."},
"whenCollideObstacle":function(d){return "når ein hindring blir treft"},
"whenCollideObstacleTooltip":function(d){return "Utfør handlingane nedanfor når Flakse treff ei hindring."},
"whenEnterObstacle":function(d){return "når passerer hindring"},
"whenEnterObstacleTooltip":function(d){return "Utfør handlingane nedanfor når Flakse passerar ei hindring."},

...
"createSnowflakeSquare":function(d){return "kar tanesinden bir kare oluştur"},
"createSnowflakeParallelogram":function(d){return "kar tanesinden bir paralelkenar oluştur"},
"createSnowflakeLine":function(d){return "kar tanesinden bir çizgi oluştur"},
"createSnowflakeSpiral":function(d){return "kar tanesinden bir helezon oluştur"},
"createSnowflakeFlower":function(d){return "kar tanesinden bir çiçek oluştur"},
"createSnowflakeFractal":function(d){return "kar tanesinden bir fraktal oluştur"},
"createSnowflakeRandom":function(d){return "kar tanesinden rastgele şekil oluştur"},
...
"drawACircle":function(d){return "bir çember çiz"},
...
"drawARhombus":function(d){return "bir eşkenar dörtgen (baklava şekli) çiz"},
...
"jumpNortheastTooltip":function(d){return "Sanatçıyı kuzey doğuya hiç iz bırakmadan taşır."},
"jumpNorthwestTooltip":function(d){return "Sanatçıyı kuzey batıya hiç iz bırakmadan taşır."},
"jumpSouthTooltip":function(d){return "Sanatçıyı güneye hiç iz bırakmadan taşır."},
"jumpSoutheastTooltip":function(d){return "Sanatçıyı güney doğuya hiç iz bırakmadan taşır."},
"jumpSouthwestTooltip":function(d){return "Sanatçıyı güney batıya hiç iz bırakmadan taşır."},
...
"moveForwardTooltip":function(d){return "Sanatçıyı ilerletir."},
"moveNorthTooltip":function(d){return "Sanatçıyı kuzeye hareket ettirir."},
"moveNortheastTooltip":function(d){return "Sanatçıyı kuzey doğuya hareket ettirir."},
"moveNorthwestTooltip":function(d){return "Sanatçıyı kuzey batıya hareket ettirir."},
"moveSouthTooltip":function(d){return "Sanatçıyı güneye hareket ettirir."},
"moveSoutheastTooltip":function(d){return "Sanatçıyı güney doğuya hareket ettirir."},
"moveSouthwestTooltip":function(d){return "Sanatçıyı güney batıya hareket ettirir."},
...
"notBlackColour":function(d){return "Bu bulmaca için siyahtan başka bir renk ayarlamanız gerekir."},
"numBlocksNeeded":function(d){return "Bu Bulmaca %1 blok ile çözülebilir.  %2'yi kullandık."},
"penDown":function(d){return "kalemi indir"},
"penTooltip":function(d){return "Çizimi başlatmak veya durdurmak için kalemi kaldırır ya da indirir."},
"penUp":function(d){return "Kalemi kaldır"},
"reinfFeedbackMsg":function(d){return "Çiziminiz burada! Çiziminiz üzerinde çalışmaya devam edin veya sonraki bulmacaya geçin."},
"setAlpha":function(d){return "alfa değerini ayarla"},
"setCharacter":function(d){return "karakteri "+turtle_locale.v(d,"character")+" olarak ayarla"},
...
"turnRightTooltip":function(d){return "Sanatçıyı belirtilen açı kadar sağa döndürür."},
"turnTooltip":function(d){return "Sanatçıyı sağa ya da sola belirtilen derecede döndürür."},
"turtleVisibilityTooltip":function(d){return "Sanatçıyı, görünür ya da görünmez yapar."},
"widthTooltip":function(d){return "Kalemin kalınlığını değiştirir."},

...
"actions":function(d){return "اقدامات"},
"add":function(d){return "اضافه کردن"},
...
"addStudentsMultiple":function(d){return "اضافه کردن چند دانش آموز"},
...
"age":function(d){return "سن"},
"all":function(d){return "All"},
"allHandouts":function(d){return "All handouts"},
"allStudents":function(d){return "All"},
"allowEditing":function(d){return "اجازه‌ی ویرایش"},
"allowEditingInstructions":function(d){return "«اجازه‌ی ویرایش بدهید» در حالی که دانش‌آموزان باید ارزیابی شوند."},
"and":function(d){return "و"},
"animationMode":function(d){return "کارتون"},
"announcements":function(d){return "اطلاعیه‌ها"},
...
"answersVisible":function(d){return "نمایش پاسخها (فقط خواندنی)"},
"archiveSection":function(d){return "Archive Section"},
"applabMarketingButton":function(d){return "بیشتر بیاموزید"},
...
"applabTutorialButton":function(d){return "شروع"},
...
"assessmentSteps":function(d){return "مراحل ارزیابی برای"},
"assessmentSettings":function(d){return "تنظیمات ارزیابی"},
"assign":function(d){return "اختصاص دادن"},
...
"autoGenerated":function(d){return "تولید شده به صورت خودکار"},
"autolock":function(d){return "توجه: مرحله پس از 24 ساعت قفل خودکار می شود."},
...
"builtOnCodeStudio":function(d){return "ساخته شده در کد استودیو"},
...
"censusInvalidEmail":function(d){return "لطفا یک آدرس ایمیل معتبر را وارد کنید"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"fa",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"choosePrefix":function(d){return "انتخاب کن..."},
...
"completed":function(d){return "انجام شد"},
...
"congratsCertificatePersonalize":function(d){return "گواهینامه خود را طراحی کنید"},
"congratsCertificateShare":function(d){return "موفقیت خود را به اشتراک بگذارید"},
"congratsCertificateThanks":function(d){return "با سپاس از شما برای ثبت اطلاعات!"},
...
"contractMatchBadDomainName":function(d){return "اسم یک یا تعدادی از موارد ورودی تابع شما اشتباه است."},
"contractMatchBadDomainSize":function(d){return "تابع شما تعداد درست موارد لازم در ورودی را ندارد."},
"contractMatchBadDomainType":function(d){return "یکی یا بیشتر از ورودی های تابع شما نوع اشتباه دارند، یا ترتیب آن ها اشتباه است."},
"contractMatchBadName":function(d){return "نام تابع شما اشتباه است."},
"contractMatchBadNameCase":function(d){return "اسامی تابع ها به بزرگی و کوچکی حروف حساس هستند. عوض کردن بزرگی و کوچکی اسم تابع خود را امتحان کنید."},
"contractMatchBadRange":function(d){return "محدوده ی تابع شما اشتباه است."},
"controlProjectSharing":function(d){return "Control project sharing"},
"copy":function(d){return "رونوشت‌"},
"copyright":function(d){return "حق کپی برداری و نشر"},
"correct":function(d){return "صحیح است"},
"correctAnswer":function(d){return "این پاسخ صحیح است"},
"country":function(d){return "کشور"},
"course":function(d){return "دوره"},
...
"courseBlocksToolsAppLab":function(d){return "آزمایشگاه نرم افزار"},
...
"courses":function(d){return "مراحل"},
...
"coursesHeadingStudent":function(d){return "در استودیو ی کد یاد بگیرید"},
...
"createSectionsInfo":function(d){return "ایجاد بخش های جدید و افزودن دانش آموزان به آنها. بخش ها به شما کمک میکنند دانش آموزان را در گروه های کوچکتر سازماندهی کنید تا شما بتوانید پیشرفت آنهای را پیگیری و حساب کاربری آنها را مدیریت نمایید."},
...
"currentVersion":function(d){return "نسخه فعلی"},
"curriculum":function(d){return "برنامه آموزشی"},
"dataLimitAlert":function(d){return "این نرم افزار بیش از حد اطلاعات به پایگاه دادهها ارسال می کند که ممکن است منجر به از کار افتادن غیر منتظره شود. در صورت مواجه شدن با این مشکل لطفا به صاحب نرم افزار اطلاع دهید."},
...
"dataTableNamePlaceholder":function(d){return "نام جدول"},
"dataWorkspaceHeader":function(d){return "مرورگر داده"},
...
"debugWatchHeader":function(d){return "تماشا کردن"},
"debugWatchNotAvailable":function(d){return "<موجود نیست>"},
...
"delete":function(d){return "پاک کردن"},
"deleteConfirm":function(d){return "پاک گردد؟"},
...
"directionNorthwestLetter":function(d){return "شمال غربی"},
"directionNortheastLetter":function(d){return "شمال شرقی"},
"directionSouthwestLetter":function(d){return "جنوب غربی"},
"directionSoutheastLetter":function(d){return "جنوب شرقی"},
"disabledButtonsInfo":function(d){return "پیشرفت و کد برنامه شما از تاریخ ۳ تا ۱۱ دسامبر به علت ترافیک بالا ذخیره نخواهد شد."},
"disabledButtonsWarning":function(d){return "اخطار:"},
"disabledButtonsWhy":function(d){return "چرا حبابهای من خاکستری هستند?"},
"disabledProgress1":function(d){return "پیشرفت و کد برنامه شما از تاریخ ۳ تا ۱۱ دسامبر به علت ترافیک بالا ذخیره نخواهد شد."},
"disabledProgress2":function(d){return "این دلیل خاکستری بودن تمام حبابها است. (نگران نباشید، پیشرفت شما در طول این هفته هنوز امن است)."},
"disabledProgress3":function(d){return "ما شما را به امتحان کردن برنامه آموزشی ساعت کد تشویق می کنیم."},
...
"done":function(d){return "انجام شد"},
"dontForget":function(d){return "فراموش نکنید که"},
...
"dropletBlock_comment_description":function(d){return "شرح برخی از کد ها رو بنویس"},
"dropletBlock_comment_signatureOverride":function(d){return "توضیحات"},
...
"dropletBlock_greaterThanOrEqualOperator_description":function(d){return "بررسی میکند که آیا یک مقدار بزرگتر یا مساوی یک مقدار دیگر است. اگر مقدار سمت چپی عبارت بزرگتر یا مساوی مقدار سمت راست عبارت است، عبارت \"درست\" را نشان میدهد."},
"dropletBlock_greaterThanOrEqualOperator_signatureOverride":function(d){return "عامل بزرگتر یا مساوی"},
...
"dropletBlock_lessThanOrEqualOperator_description":function(d){return "بررسی میکند که آیا یک مقدار کوچکتر یا مساوی یک مقدار دیگر است. اگر مقدار سمت چپی عبارت کوچکتر یا مساوی مقدار سمت راست عبارت است، عبارت \"درست\" را نشان میدهد."},
"dropletBlock_lessThanOrEqualOperator_signatureOverride":function(d){return "عامل کمتر یا مساوی"},
...
"dropletBlock_mathRandom_description":function(d){return "یک عدد تصادفی بین صفر و یک بر می گرداند ( که شامل صفر می تواند باشد ولی یک نمی تواند باشد)"},
"dropletBlock_mathRandom_signatureOverride":function(d){return "ریاضیات.تصادفی()"},
...
"dropletBlock_playSound_description":function(d){return "فایل صوتی MP3 از آدرس مشخص شده پخش می کند."},
"dropletBlock_playSound_param0_description":function(d){return "لینک به یک فایل صوتی. این لینک می تواند فایل صوتی پروژه یا لینک به خارج از سایت باشد."},
"dropletBlock_playSound_param1_description":function(d){return "If true, loop the sound until asked to stop."},
"dropletBlock_randomNumber_description":function(d){return "یک عدد تصادفی در بازه ای مشخص شده بین مینیمم و ماکزیمم بر می گرداند"},
...
"dropletBlock_randomNumber_param1_description":function(d){return "بزگرترین عدد را برمی گرداند"},
"dropletBlock_return_description":function(d){return "Return a value from a function"},
"dropletBlock_return_signatureOverride":function(d){return "بازگشت"},
"dropletBlock_setAttribute_description":function(d){return "Sets the given value"},
"dropletBlock_stopSound_description":function(d){return "پخش فایلهای صوتی از لینک مشخصی یا تمام اصوات را اگر لینک داده نشده باشد، متوقف می کند."},
"dropletBlock_stopSound_param0_description":function(d){return "لینک به یک فایل صوتی. این لینک می تواند فایل صوتی پروژه یا لینک به خارج از سایت باشد."},
"dropletBlock_subtractOperator_description":function(d){return "Subtract two numbers"},
"dropletBlock_subtractOperator_signatureOverride":function(d){return "Subtract operator"},
"dropletBlock_whileBlock_description":function(d){return "Repeat something while a condition is true"},
"dropletBlock_whileBlock_signatureOverride":function(d){return "while loop"},
"edit":function(d){return "ویرایش"},
"editAll":function(d){return "Edit all"},
"editSectionDetails":function(d){return "Edit Section Details"},
"editable":function(d){return "قابل ویرایش"},
...
"errorGenericLintError":function(d){return "برنامه شما حاوی یک هشدار از طرف ویرایشگر میباشد که باید اصلاح شود. برای توضیحات بیشتر بروی آیکون نزدیک به شماره خط در ویرایشگر بروید."},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"fa",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"fa",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"findGuestSpeaker":function(d){return "یک سنخنران مهمان پیدا کن"},
...
"forTeachersOnly":function(d){return "تنها برای معلمان"},
"gender":function(d){return "جنسیت"},
"genderMale":function(d){return "مرد"},
"genderFemale":function(d){return "زن"},
...
"hidden":function(d){return "پنهان"},
...
"hintPromptInline":function(d){return "آیا مایل به اشاره هستید؟"},
"hintRequest":function(d){return "راهنمایی را ببینید"},
"hintReviewTitle":function(d){return "راهنماهایت را مرور کن"},
"hintSelectInstructions":function(d){return "دستورالعملها و نکات قدیمی"},
...
"homepageUiTipsBeforeDialogConfirm":function(d){return "نمایش بده"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "تمام کن"},
"homepageUiTipsAfterDialogConfirm":function(d){return "بیشتر بیاموزید"},
"iconSearchPlaceholder":function(d){return "جستجوی یک شمایل..."},
...
"incorrectAnswer":function(d){return "پاسخ اشتباه"},
"incorrectAnswerBody":function(d){return "پاسخی که وارد کرده‌اید صحیح نیست. لطفا دوباره امتحان کنید!"},
"incorrectSolution":function(d){return "راه‌حل نادرست"},
"incorrectSolutionBody":function(d){return "راه‌حلی که شما وارد کرده‌اید صحیح نیست. لطفا دوباره امتحان کنید!"},
...
"joinSectionPlaceholder":function(d){return "انتخاب کد (ABCDEF)"},
"joinCommunity":function(d){return "Join community"},
"joinText":function(d){return "عضویت"},
"joinTextTooltip":function(d){return "با به هم چسباندن چند مورد یک متن ایجاد کنید."},
"joinUs":function(d){return "به ما بپیوندید"},
"jump":function(d){return "پرش"},
"justDidHourOfCode":function(d){return "من HourOfCode# رو تموم کردم - امتحانش کنید! codeorg@"},
...
"keyValuePairLink":function(d){return "جفت کلید/مقدار"},
"lastEdited":function(d){return "Last Edited"},
"learnMore":function(d){return "بیشتر بیاموزید"},
"leaveSection":function(d){return "Leave section"},
"less":function(d){return "کمتر"},
"lessonName":function(d){return "نام درس"},
"lessonNumbered":function(d){return "درس "+common_locale.v(d,"lessonNumber")+": "+common_locale.v(d,"lessonName")},
"lessonPlans":function(d){return "برنامه های درسی"},
...
"levelN":function(d){return "سطح "+common_locale.v(d,"levelNumber")},
"levelStatus":function(d){return "Level Status"},
"levelType":function(d){return "Level Type"},
"listVariable":function(d){return "فهرست"},
"loading":function(d){return "در حال بارگذاری..."},
"locked":function(d){return "قفل شده"},
"lockFollowing":function(d){return "مراحلی که در حال حاضر باز شده هستند را قفل کنید:"},
"lockAssessment":function(d){return "ارزیابی قفل"},
...
"lockStage":function(d){return "مرحله قفل"},
"lockStageInstructions":function(d){return "وقتی زمان تمام شد، \"مرحله را قفل کنید\" تا جواب ها مخفی شوند."},
"lockWhenDone":function(d){return "زمانی که دانش آموزان تمام کردند قفل کنید"},
"loginInfo":function(d){return "Login Info"},
"loginType":function(d){return "نوع ورود"},
...
"makeMyOwn":function(d){return "مال مرا بساز"},
...
"manageStudents":function(d){return "مدیریت دانش آموزان"},
"manageStudentsNotificationFailure":function(d){return "Something went wrong."},
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"fa",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"fa",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"minecraftMarketingButton":function(d){return "شروع"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "نه کاملا. سعی کن از بلوکی که تاکنون استفاده نکرده ای، استفاده کنی."},
"missingRequiredBlocksErrorMsg":function(d){return "نه کاملا. باید از بلوکی که تاکنون استفاده نکرده ای استفاده کنی."},
"more":function(d){return "بیشتر"},
"moreInfo":function(d){return "More info."},
"myCourses":function(d){return "My Courses"},
"myProjects":function(d){return "پروژه های من"},
"name":function(d){return "نام"},
...
"newPassword":function(d){return "گذرواژه‌ی تازه"},
"newSection":function(d){return "بخش تازه"},
...
"noIconsFound":function(d){return "هیچ نمادی پیدا نشد"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"fa",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"numBlocksUsedLabel":function(d){return "بلوک ها"},
...
"ok":function(d){return "باشه"},
"okay":function(d){return "باشه"},
"online":function(d){return "آنلاین"},
"openWorkspace":function(d){return "چگونه کار می کند"},
"or":function(d){return "یا"},
...
"pairProgramming":function(d){return "برنامه نویسی دوتایی"},
"parent":function(d){return "پدر/مادر"},
"parents":function(d){return "Parents"},
"parentsAndStudents":function(d){return "Parents and Students"},
"password":function(d){return "رمز عبور"},
...
"playzoneArtistDescription":function(d){return "با نقاش چند عکس و طرح باحال بکش!"},
"playzoneArtistTitle":function(d){return "New Drawing"},
"playzoneContinueButton":function(d){return "Go on to the next Stage"},
"playzonePlaylabDescription":function(d){return "یک داستان بنویس یا یک بازی با آزمایشگاه بازی بساز!"},
...
"predictionInstructions":function(d){return "قبل از اینکه برنامه را اجرا کنید حدسی بزنید."},
"printCertificate":function(d){return "چاپ گواهینامه"},
"printCertificates":function(d){return "Print certificates"},
"printLoginCards":function(d){return "Print Login Cards"},
"privacyPolicy":function(d){return "قوانین حفظ حریم خصوصی"},
...
"progress":function(d){return "پیشرفت"},
...
"projectGroupMath":function(d){return "ریاضی"},
"projectGroupMinecraft":function(d){return "ماینکرفت"},
...
"projectType":function(d){return "نوع"},
...
"projectTypeAlgebra":function(d){return "جبر"},
"projectTypeApplab":function(d){return "آزمایشگاه نرم افزار"},
"projectTypeArtist":function(d){return "هنرمند"},
...
"projectTypePlaylab":function(d){return "آزمایشگاه بازی"},
...
"projectTypeEvents":function(d){return "رویدادها"},
"projectTypeFrozen":function(d){return "منجمد"},
"projectTypeK1":function(d){return "Pre-reader"},
"projectTypeMinecraft":function(d){return "ماینکرفت"},
...
"projectTypeStarwars":function(d){return "جنگ ستارگان"},
"projectTypeStarwarsBlocks":function(d){return "Star Wars (Blocks)"},
"projectTypeFlappy":function(d){return "فلاپی"},
"projectTypeSports":function(d){return "Sports"},
"projectTypeBasketball":function(d){return "Basketball"},
"projectTypeBounce":function(d){return "پریدن"},
"projectTypeInfinity":function(d){return "بی نهایت"},
"projectTypeIceage":function(d){return "عصر یخبندان"},
...
"projects":function(d){return "پروژه ها"},
"projectsSubHeading":function(d){return "Over 20 million projects created"},
"print":function(d){return "چاپ کن"},
"projectWarning":function(d){return "توجه: شما در سطحی هستید که خود بخشی از یک پروژه بزرگتراست. تغییراتی که در این سطح ایجاد میشود در سطوح دیگر پروژه نیز ظاهر خواهند شد."},
...
"question":function(d){return "سوال"},
...
"recommendedBlockContextualHintTitle":function(d){return "سعی کن از یک بلوک اینگونه برای حل کردن پازل استفاده کنی."},
"reloadPage":function(d){return "Reload Page"},
"relockStage":function(d){return "قفل دوباره مرحله"},
"relockStageInstructions":function(d){return "\"Re-lock stage\" to prevent sharing of answers with other classes/schools."},
"remix":function(d){return "ترکیب دوباره"},
...
"rename":function(d){return "تغییر نام"},
"repeat":function(d){return "تکرار کن"},
"replayButton":function(d){return "تکرار"},
"reportAbuse":function(d){return "گزارش سوء استفاده"},
"reset":function(d){return "تنظیم مجدد"},
"resetProgram":function(d){return "تنظیم مجدد"},
"resetPassword":function(d){return "تنظیم مجدد گذرواژه"},
"resources":function(d){return "Resources"},
"restoreThisVersion":function(d){return "این نسخه را ذخیره کنید"},
...
"save":function(d){return "ذخيره"},
"saveAll":function(d){return "ذخیره‌ی همه"},
"saveAndPublish":function(d){return "Save & Publish"},
"savedToGallery":function(d){return "در گالری ذخیره شد!"},
"saving":function(d){return "در حال ذخیره سازی..."},
...
"schoolTypeOther":function(d){return "دیگر"},
...
"section":function(d){return "بخش"},
"sectionCode":function(d){return "بخش کد"},
"sectionName":function(d){return "نام بخش"},
...
"secret":function(d){return "عکس مخفی"},
...
"selectSection":function(d){return "انتخاب بخش"},
...
"shareWarningsStoreData":function(d){return "این نرم افزار که در کارگاه کدنویسی ساخته شده است، داده ذخیره میکند که هرکسی میتواند از طریق این لینک آنها را رؤیت کند، لذا اگر از شما خواسته شد که اطلاعات شخصیتان را ارائه دهید، احتیاط کنید."},
...
"show":function(d){return "نمایش"},
"showAnswers":function(d){return "نمایش پاسخ ها"},
"showAnswersInstructions":function(d){return "\"Show answers\" to put the assessment into a read-only mode."},
"showBlock":function(d){return "یک بلوک بگیر"},
...
"showSecret":function(d){return "نمایش محرمانه"},
...
"signupFormSchoolType":function(d){return "نوع"},
...
"stageLocked":function(d){return "مرحله قفل شده است."},
"stageNotFullyLocked":function(d){return "مرحله برای همه قفل نشده است."},
"stageRewards":function(d){return "مرحله پاداش"},
...
"standardsAndFramework":function(d){return "برنامه‌ها و منابع درس"},
"standardsAndFrameworkDescription":function(d){return "Information about standards alignment for Code.org courses."},
"startLearning":function(d){return "یادگیری را شروع کنید"},
"startOver":function(d){return "دوباره شروع کنید"},
"startOverTitle":function(d){return "آیا مطمئنی که می خواهی دوباره شروع کنی؟"},
"startOverBody":function(d){return "این کار معما را به حالت اولیه اش تنظیم خواهد کرد و تمام داده هایی که شما اضافه کرده یا تغییر داده اید را بازنشانی می کند."},
...
"student":function(d){return "دانش آموز"},
"students":function(d){return "دانش آموزان"},
"studentAccountsAndProgress":function(d){return "حساب کاربری دانش‌ آموزان و پیشرفت آنها"},
"studentControl":function(d){return "کنترل فردی دانش آموز"},
"studentLockStateInstructions":function(d){return "از جدول زیر برای کنترل وضع فردی هر دانش آموز استفاده کنید."},
"studentName":function(d){return "نام دانش آموز"},
...
"submitYourProjectConfirm":function(d){return "بعد از ارسال طرحتان نمیتوانید آنرا ویرایش کنید. آیا واقعا میخواهید ارسال نمائید?"},
...
"syntaxErrorMsg":function(d){return "برنامه شما یک اشتباه تایپی دارد. لطفا خط "+common_locale.v(d,"lineNumber")+" را حذف کنید و دوباره برنلمه را اجرا نمائید."},
"teacher":function(d){return "دبیر"},
"teachers":function(d){return "دبیران"},
...
"teacherCourseHoc":function(d){return "ساعت کد نویسی"},
...
"teacherHomePage":function(d){return "صفحه اصلی معلم"},
"teacherPanel":function(d){return "پنل معلم"},
"teacherResources":function(d){return "Teacher resources"},
"text":function(d){return "متن"},
"textVariable":function(d){return "متن"},
"thanksForYourResponse":function(d){return "برای پاسختان سپاسگزارم!"},
"thankyou":function(d){return "متشکرم"},
"thankyouForAnswer":function(d){return "برای ثبت یک پاسخ از شما تشکر میکنم."},
...
"tryBlocksBelowFeedback":function(d){return "استفاده از یکی از بلوکهای زیر را امتحان کن:"},
"tryHOC":function(d){return "ساعتِ کد نویسی را امتحان کنید"},
"tryIt":function(d){return "آن را امتحان کنید"},
"tryNow":function(d){return "هم اکنون امتحان کنید"},
...
"unattachedBlockTipTitle":function(d){return "بلوک وصل نشده"},
"unattachedBlockTipBody":function(d){return "بلوکی که متصل نشده عملی انجام نخواهد داد. اگر تمایل به انجام کاری توسط این بلوکها در برنامه تان دارید، آنها را به بقیه بلوکها متصل نمایید."},
...
"unplugged":function(d){return "آنپلاگد"},
"unpluggedActivity":function(d){return "فعالیت کلاسی"},
...
"usingHints":function(d){return "با استفاده از نکات"},
...
"unsubmitYourProject":function(d){return "ارسال طرح را لغو کن"},
"unsubmitYourProjectConfirm":function(d){return "لغو ارسال طرحتان، تاریخ ارسال را تغییر میدهد، واقعا میخواهید ارسال را لغو کنید?"},
...
"viewCode":function(d){return "مشاهده کد"},
"viewCourse":function(d){return "مشاهده ی دوره"},
...
"viewLessonPlan":function(d){return "مشاهده طرح درس"},
"viewMyProjects":function(d){return "View my projects"},
"viewMore":function(d){return "View more"},
"viewPageAs":function(d){return "مشاهده صفحه بصورت:"},
"viewSection":function(d){return "مشاهده بخش"},
"viewUnitOverview":function(d){return "View Unit Overview"},
"visible":function(d){return "نمایان"},
...
"withoutHints":function(d){return "بدون استفاده از هر گونه نکته!"},

...
"basketballLaunchBall":function(d){return "নতুন বল ছুঁড়ো"},
"basketballLaunchBallTooltip":function(d){return "খেলতে একটা বল মারুন."},
"basketballSetPaddle":function(d){return "হাত ঠিক করুন "},
"basketballSetPaddleSpeedFast":function(d){return "দ্রুত গতির প্যাডেল বিন্যাস করুন"},
"basketballSetPaddleSpeedNormal":function(d){return "স্বাভাবিক গতির বল সেট করুন"},
"basketballSetPaddleSpeedRandom":function(d){return "এলোমেলো বল গতির বিন্যাস করুন"},
"basketballSetPaddleSpeedSlow":function(d){return "মন্থর গতির বল সেট করুন"},
"basketballSetPaddleSpeedTooltip":function(d){return "বল এর গতি সেট করে"},
"basketballSetPaddleSpeedVeryFast":function(d){return "খুব দ্রুত গতির বল  বিন্যাস করুন"},
"basketballSetPaddleSpeedVerySlow":function(d){return "অতি মন্থর গতির বল সেট করুন"},
"basketballWhenBallMissesPaddle":function(d){return "বল যখন প্যাডেলে আঘাত করবে না"},
"basketballWhenPaddleCollided":function(d){return "দেয়ালে বল আঘাত করলে"},

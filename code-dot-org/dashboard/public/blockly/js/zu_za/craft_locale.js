...
"blockActionMoveForward":function(d){return "qubekela phambili"},
...
"blockMoveBackward":function(d){return "qubekela emuva"},
"blockMoveForward":function(d){return "qubekela phambili"},
"blockPlace":function(d){return "beka noma indawo"},
"blockPlaceTorch":function(d){return "place torch"},
"blockPlaceXAheadAhead":function(d){return "ngaphambili"},
"blockPlaceXAheadPlace":function(d){return "beka noma indawo"},
"blockPlaceXPlace":function(d){return "beka noma indawo"},
"blockPlantCrop":function(d){return "isitshalo"},
...
"blockTypeBricks":function(d){return "izitini"},
"blockTypeClay":function(d){return "udongo"},
"blockTypeClayHardened":function(d){return "hardened clay"},
"blockTypeCobblestone":function(d){return "cobblestone"},
"blockTypeDirt":function(d){return "ukuncola"},
"blockTypeDirtCoarse":function(d){return "coarse dirt"},
"blockTypeDoorIron":function(d){return "iron door"},
"blockTypeEmpty":function(d){return "akukho lutho"},
"blockTypeFarmlandWet":function(d){return "indawo yepulazi"},
"blockTypeGlass":function(d){return "ingilazi"},
"blockTypeGlowstone":function(d){return "glowstone"},
"blockTypeGrass":function(d){return "utshani"},
"blockTypeGravel":function(d){return "uhlwayi"},
...
"blockTypeRail":function(d){return "ileli"},
"blockTypeRailsRedstoneTorch":function(d){return "redstone torch"},
"blockTypeRedstoneWire":function(d){return "redstone wire"},
"blockTypeSand":function(d){return "isihlabathi"},
"blockTypeSandstone":function(d){return "amatshe esihlabathi"},
"blockTypeStone":function(d){return "itshe"},
"blockTypeTnt":function(d){return "tnt"},
"blockTypeTree":function(d){return "isihlahla"},
"blockTypeWater":function(d){return "amanzi"},
"blockTypeWool":function(d){return "ukotini"},
...
"blockWhileXAheadAhead":function(d){return "ngaphambili"},
"blockWhileXAheadDo":function(d){return "yenza"},
"blockWhileXAheadWhile":function(d){return "while"},
"cancel":function(d){return "Hoxisa"},
...
"houseSelectEasy":function(d){return "Kulula"},
"houseSelectHard":function(d){return "Kunzima"},
...
"miniBlockBricks":function(d){return "izitini"},
...
"miniBlockDirt":function(d){return "ukuncola"},
...
"miniBlockGravel":function(d){return "uhlwayi"},
...
"miniBlockSand":function(d){return "isihlabathi"},
"miniBlockSandstone":function(d){return "amatshe esihlabathi"},
"miniBlockSheep":function(d){return "sheep"},
"miniBlockWheat":function(d){return "wheat"},
"miniBlockWool":function(d){return "ukotini"},
...
"playerSelectChooseCharacter":function(d){return "Khetha umlingiswa wakho."},
"playerSelectChooseSelectButton":function(d){return "Khetha"},
"playerSelectLetsGetStarted":function(d){return "Asiqale."},
...
"selectChooseButton":function(d){return "Khetha"},

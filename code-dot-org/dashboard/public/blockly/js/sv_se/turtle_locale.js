...
"jumpNortheastTooltip":function(d){return "Flyttar konstnären åt nordöst utan att lämna några märken."},
"jumpNorthwestTooltip":function(d){return "Flyttar konstnären åt nordväst utan att lämna några märken."},
"jumpSouthTooltip":function(d){return "Flyttar konstnären åt söder utan att lämna några märken."},
"jumpSoutheastTooltip":function(d){return "Flyttar konstnären åt sydöst utan att lämna några märken."},
"jumpSouthwestTooltip":function(d){return "Flyttar konstnären åt sydväst utan att lämna några märken."},
...
"moveNortheastTooltip":function(d){return "Flyttar artisten nordost."},
"moveNorthwestTooltip":function(d){return "Flyttar artisten nordväst."},
"moveSouthTooltip":function(d){return "Flyttar konstnären söderut."},
"moveSoutheastTooltip":function(d){return "Flyttar artisten sydost."},
"moveSouthwestTooltip":function(d){return "Flyttar artisten sydväst."},

...
"basketballLaunchBall":function(d){return "پرتاب توپ جدید"},
"basketballLaunchBallTooltip":function(d){return "یک توپ وارد بازی کن."},
"basketballSetPaddle":function(d){return "تنظیم دست"},
"basketballSetPaddleSpeedFast":function(d){return "تنظیم سرعت دست به سریع"},
"basketballSetPaddleSpeedNormal":function(d){return "تنظیم سرعت دست به نرمال"},
"basketballSetPaddleSpeedRandom":function(d){return "تنظیم سرعت دست به تصادفی"},
"basketballSetPaddleSpeedSlow":function(d){return "تنظیم سرعت دست به آهسته"},
"basketballSetPaddleSpeedTooltip":function(d){return "سرعت دست را تنظیم می کند"},
"basketballSetPaddleSpeedVeryFast":function(d){return "تنظیم سرعت دست به بسیار سریع"},
"basketballSetPaddleSpeedVerySlow":function(d){return "تنظیم سرعت دست به بسیار آهسته"},
"basketballWhenBallMissesPaddle":function(d){return "زمانی که توپ با دست برخورد نکند"},
"basketballWhenPaddleCollided":function(d){return "هنگامی که توپ با دست برخورد کند"},
...
"playSoundCheer":function(d){return "پخش صدای تشویق"},
...
"playSoundKick":function(d){return "پخش صدای ضربه"},
...
"playSoundSlapshot":function(d){return "پخش صدای ضربه محکم"},
"playSoundSwish":function(d){return "پخش صدای فش فش"},
"playSoundTooltip":function(d){return "صدای انتخاب شده را پخش کن."},
"playSoundWhistle":function(d){return "پخش صدای سوت"},
...
"setBackground":function(d){return "تنظیم "+bounce_locale.v(d,"background")+" پشت صحنه"},
...
"setBall":function(d){return "تنظیم توپ "+bounce_locale.v(d,"ball")},
...
"setPaddle":function(d){return "تنظیم دست و پا زدن"},
...
"setPlayerSpeedFast":function(d){return "تنظیم سرعت پخش کننده به سریع"},
"setPlayerSpeedNormal":function(d){return "تنظیم سرعت پخش به عادی"},
"setPlayerSpeedRandom":function(d){return "تنظیم سرعت پخش به تصادفی"},
"setPlayerSpeedSlow":function(d){return "تنظیم سرعت پخش به آهسته"},
"setPlayerSpeedTooltip":function(d){return "تنظیم سرعت بازیکن"},
"setPlayerSpeedVeryFast":function(d){return "تنظیم سرعت بازیکن به بسیار سریع"},
"setPlayerSpeedVerySlow":function(d){return "تنظیم سرعت پخش به بسیار کند"},
"setTeamTooltip":function(d){return "تنظیم آرم و رنگ بندی"},
"setTeam":function(d){return "تنظیم تیم "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "تنظیم تیم به تصادفی"},
...
"whenBallMissesPlayer":function(d){return "زمانی که توپ به بازیکن نمی رسد"},
...
"whenPlayerCollided":function(d){return "هنگامی که توپ با بازیکن برخورد میکند"},
"whenPlayerCollidedTooltip":function(d){return "اقدامات زیر در هنگام برخورد توپ با بازیکن اجرا می شود."},

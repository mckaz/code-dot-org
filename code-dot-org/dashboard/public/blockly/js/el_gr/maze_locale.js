...
"collect":function(d){return "σύλλεξε"},
"collectiblePresent":function(d){return "υπάρχει κάποιος θυσαυρός"},
"collectorCollectTooltip":function(d){return "Σύλλεξε ένα αντικείμενο"},
"collectorCollectedEverything":function(d){return "Συγχαρητήρια! Συλλέξατε "+maze_locale.p(d,"count",0,"el",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNothing":function(d){return "Συνέχισε να γράφεις κώδικα! Θα χρειαστείς να μαζέψεις όσο το δυνατόν περισσότερα αντικείμενα."},
"collectorCollectedSome":function(d){return "Μπράβο! Συλλέξατε "+maze_locale.p(d,"count",0,"el",{"one":"1 item","other":maze_locale.n(d,"count")+" αντικείμενα"})+"!"},
"collectorCollectedNotEnough":function(d){return "Συνέχισε να γράφεις κώδικα! Χρειάζεσαι να συλλέξεις τουλάχιστον  "+maze_locale.p(d,"goal",0,"el",{"one":"1 item","other":maze_locale.n(d,"goal")+" αντικείμενα"})+". "},
"collectorCollectedTooMany":function(d){return "Εκείνο το διάστημα δεν έχει αρκετά στοιχεία για να συλλέξω."},
"collectorTooManyBlocks":function(d){return "Μπορείτε να χρησιμοποιήσετε μόνο "+maze_locale.v(d,"blockLimit")+" μπλοκ. Ρίξτε μια ματιά στον κώδικά σας και προσπαθήστε ξανά!"},
"continue":function(d){return "Συνέχεια"},
"corn":function(d){return "καλαμπόκι"},
"cornTooltip":function(d){return "Μάζεψε λίγο καλαμπόκι"},
"didNotCollectAllCrops":function(d){return "Βεβαιωθείτε ότι δεν αφήνετε καλλιέργειες!"},
"didNotCollectEverything":function(d){return "Βεβαιώσου ότι δεν αφήνεις νέκταρ ή μέλι πίσω!"},
"didNotPlantEverywhere":function(d){return "Βεβαιωθείτε ότι φυτεύετε σε κάθε παρτέρι κάτι!"},
...
"emptyCropError":function(d){return "Η καλλιέργεια έχει φύγει."},
...
"has":function(d){return "έχει"},
"haslettuce":function(d){return "υπάρχει μαρούλι"},
"hascorn":function(d){return "υπάρχει καλαμπόκι"},
"haspumpkin":function(d){return "υπάρχουν κολοκύθες"},
...
"lettuce":function(d){return "μαρούλι"},
"lettuceTooltip":function(d){return "Συλλέξτε λίγο μαρούλι"},
...
"pick":function(d){return "διαλέξτε"},
"pilePresent":function(d){return "υπάρχει ένας σωρός"},
"plant":function(d){return "plant"},
"plantInNonSoilError":function(d){return "Μπορώ να φυτέψω κάτι μόνο σε φρέσκο χώμα."},
"plantTooltip":function(d){return "Να φυτέψετε ένα βλαστάρι"},
"pumpkin":function(d){return "κολοκύθα"},
"pumpkinTooltip":function(d){return "Συλλέξτε μια κολοκύθα"},
...
"soil":function(d){return "χώμα"},
"sprout":function(d){return "βλαστάρι"},
...
"wrongCropError":function(d){return "Δεν είναι δυνατό να συλλέξω αυτή την καλλιέργεια από εδώ."},

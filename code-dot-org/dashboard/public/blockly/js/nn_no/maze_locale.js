...
"collectiblePresent":function(d){return "det er meir igjen"},
"collectorCollectTooltip":function(d){return "Samle eit element"},
"collectorCollectedEverything":function(d){return "Gratulerer! Du har samla "+maze_locale.p(d,"count",0,"en",{"one":"ting","other":"alle "+maze_locale.n(d,"count")+" tinga"})+"!"},
"collectorCollectedNothing":function(d){return "Fortset å kode! Du skal samle så mange element som du kan."},
"collectorCollectedSome":function(d){return "Godt jobba! Du har samla "+maze_locale.p(d,"count",0,"en",{"one":"1 ting","other":maze_locale.n(d,"count")+" ting"})+"!"},
"collectorCollectedNotEnough":function(d){return "Hald fram med kodinga! Du treng å samle minst "+maze_locale.p(d,"goal",0,"en",{"one":"1 element","other":maze_locale.n(d,"goal")+" element"})+"."},
"collectorCollectedTooMany":function(d){return "Den plassen har ikkje nok element eg kan samle."},
"collectorTooManyBlocks":function(d){return "Du kan berre bruke "+maze_locale.v(d,"blockLimit")+" byggjeklossar. Ta ein kikk på koden din og prøv igjen!"},
"continue":function(d){return "Hald fram"},
"corn":function(d){return "mais"},
"cornTooltip":function(d){return "Haust litt mais"},
"didNotCollectAllCrops":function(d){return "Pass på at du ikkje legg igjen noko av avlinga!"},
"didNotCollectEverything":function(d){return "Pass på at du ikkje legg igjen noko nektar eller honning!"},
"didNotPlantEverywhere":function(d){return "Pass på at du plantar noko i alle jordlappane!"},
...
"emptyCropError":function(d){return "Heile avlinga er borte."},
...
"lettuceTooltip":function(d){return "Plukk litt salat"},
...
"plantInNonSoilError":function(d){return "Eg kan berre plante i fersk jord."},
"plantTooltip":function(d){return "Plant ei spire"},
"pumpkin":function(d){return "gresskar"},
"pumpkinTooltip":function(d){return "Haust eit gresskar"},
...
"wrongCropError":function(d){return "Eg kan ikkje hauste avlinga herfra."},

...
"absolute":function(d){return "апсолутно"},
...
"agentDiamondPathCongrats":function(d){return "Congratulations, you found the diamond path! You have collected "+craft_locale.p(d,"count",0,"mk",{"one":"1 diamond","other":craft_locale.n(d,"count")+" diamonds"})+" so far!"},
"blockActionAdd":function(d){return "add"},
"blockActionAttack":function(d){return "напад"},
...
"blockActionCollectAll":function(d){return "собери сѐ"},
"blockActionDestroyEntity":function(d){return "Исчезни"},
"blockActionDetect":function(d){return "лоцирај"},
"blockActionDetectRedstone":function(d){return "лоцирај црвен камен"},
"blockActionDrop":function(d){return "фрли"},
"blockActionDropAll":function(d){return "фрли сѐ"},
"blockActionExecute":function(d){return "изврши команда"},
"blockActionExplodeEntity":function(d){return "експлодирај"},
"blockActionFill":function(d){return "fill from"},
"blockActionFlashEntity":function(d){return "светло"},
"blockActionGetItemCount":function(d){return "изброј материјали"},
...
"blockActionGive":function(d){return "дади"},
"blockActionInspect":function(d){return "истражи"},
"blockActionInspectData":function(d){return "inspect data"},
"blockActionKill":function(d){return "убиј ја метата"},
"blockActionMove":function(d){return "move"},
"blockActionMoveAway":function(d){return "одалечи се од"},
"blockActionMoveForward":function(d){return "move forward"},
"blockActionMoveRandom":function(d){return "move random"},
"blockActionMoveTo":function(d){return "помести се до"},
"blockActionMoveToward":function(d){return "помести се чекор кон"},
"blockActionPlaySound":function(d){return "пушти звук"},
...
"blockActionSpawn":function(d){return "место на раѓање"},
"blockActionSummon":function(d){return "креирај"},
"blockActionTeleport":function(d){return "телепортирај ја метата"},
"blockActionTeleportToPlayer":function(d){return "телепортирај се до играчот"},
...
"blockDestroyBlock":function(d){return "одстрани блок"},
"blockIf":function(d){return "ако"},
"blockIfLavaAhead":function(d){return "ако има лава напред"},
...
"blockPlace":function(d){return "намести"},
"blockPlaceTorch":function(d){return "постави факел"},
"blockPlaceXAheadAhead":function(d){return "напред"},
"blockPlaceXAheadPlace":function(d){return "намести"},
"blockPlaceXPlace":function(d){return "намести"},
"blockPlantCrop":function(d){return "засади растение"},
"blockShear":function(d){return "стрижи"},
"blockTill":function(d){return "till"},
"blockTillSoil":function(d){return "копај земја"},
...
"blockTypeBedrock":function(d){return "темел"},
"blockTypeBricks":function(d){return "тули"},
"blockTypeClay":function(d){return "глина"},
"blockTypeClayHardened":function(d){return "стврдната глина"},
"blockTypeCobblestone":function(d){return "калдрма"},
"blockTypeDirt":function(d){return "земја"},
"blockTypeDirtCoarse":function(d){return "груткава земја"},
"blockTypeDoorIron":function(d){return "iron door"},
"blockTypeEmpty":function(d){return "празно"},
"blockTypeFarmlandWet":function(d){return "обработливо земјиште"},
...
"blockTypeGravel":function(d){return "шакач"},
"blockTypeLava":function(d){return "лава"},
"blockTypeLogAcacia":function(d){return "багремово дрво"},
"blockTypeLogBirch":function(d){return "брезово дрво"},
"blockTypeLogJungle":function(d){return "дрво од џунгла"},
"blockTypeLogOak":function(d){return "дабово дрво"},
"blockTypeLogSpruce":function(d){return "дрво од смрека"},
"blockTypeOreCoal":function(d){return "јаглен"},
"blockTypeOreDiamond":function(d){return "дијаманти"},
"blockTypeOreEmerald":function(d){return "смаград"},
"blockTypeOreGold":function(d){return "злато"},
"blockTypeOreIron":function(d){return "железна руда"},
...
"eventTypeWhenRun":function(d){return "Кога трча"},
...
"miniBlockBricks":function(d){return "тули"},
...
"miniBlockDirt":function(d){return "земја"},
"miniBlockDirtCoarse":function(d){return "груткава земја"},
"miniBlockEgg":function(d){return "egg"},
"miniBlockEmerald":function(d){return "emerald"},
"miniBlockGravel":function(d){return "шакач"},
...
"miniBlockLogAcacia":function(d){return "багремово дрво"},
"miniBlockLogBirch":function(d){return "брезово дрво"},
"miniBlockLogJungle":function(d){return "дрво од џунгла"},
"miniBlockLogOak":function(d){return "дабово дрво"},
"miniBlockLogSpruce":function(d){return "дрво од смрека"},
...
"soundTypeExplode":function(d){return "експлодирај"},
...
"timeRandom":function(d){return "случајно"},

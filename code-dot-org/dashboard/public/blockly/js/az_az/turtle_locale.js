...
"branches":function(d){return "budaqlar"},
...
"createSnowflakeSquare":function(d){return "kvadrat tipli qar dənəsi düzəldin"},
"createSnowflakeParallelogram":function(d){return "paralelloqram tipli qar dənəsi düzəldin"},
"createSnowflakeLine":function(d){return "düz xətt tipli qar dənəsi düzəldin"},
"createSnowflakeSpiral":function(d){return "spiral tipli qar dənəsi düzəldin"},
"createSnowflakeFlower":function(d){return "çiçək tipli qar dənəsi düzəldin"},
"createSnowflakeFractal":function(d){return "fraktal tipli qar dənəsi düzəldin"},
"createSnowflakeRandom":function(d){return "təsadüfi tipli qar dənəsi düzəldin"},
"createASnowflakeBranch":function(d){return "qar dənəsi budağını düzəldin"},
...
"drawAPlanet":function(d){return "planet çək"},
"drawARhombus":function(d){return "romb çək"},
"drawARobot":function(d){return "robot çək"},
"drawARocket":function(d){return "roket çək"},
...
"drawUpperWave":function(d){return "üst dalğa çək"},
"drawLowerWave":function(d){return "alt dalğa çək"},
"drawSticker":function(d){return "etiket çək"},
"heightParameter":function(d){return "hündürlük"},
"hideTurtle":function(d){return "rəssamı gizlət"},
"jump":function(d){return "atıl"},
"jumpTo":function(d){return "tullan"},
...
"jumpEastTooltip":function(d){return "Artisti şərqə heç iz buraxmadan aparır."},
"jumpNorthTooltip":function(d){return "Artisti şimala heç iz buraxmadan aparır."},
"jumpNortheastTooltip":function(d){return "Artisti şimal-şərqə iz buraxmadan aparır."},
"jumpNorthwestTooltip":function(d){return "Artisti şimal-qərbə iz buraxmadan aparır."},
"jumpSouthTooltip":function(d){return "Artisti cənuba heç iz buraxmadan aparır."},
"jumpSoutheastTooltip":function(d){return "Artisti cənub-şərqə iz buraxmadan aparır."},
"jumpSouthwestTooltip":function(d){return "Artisti cənub-qərbə iz buraxmadan aparır."},
"jumpWestTooltip":function(d){return "Artisti qərbə heç bir iz buraxmadan aparır."},
"lengthFeedback":function(d){return "Hərəkət məsafələrini düzgün anlamısan."},
"lengthParameter":function(d){return "uzunluq"},
"loopVariable":function(d){return "sayğac"},
"moveBackward":function(d){return "geriyə get"},
"moveEastTooltip":function(d){return "Artisti şərqə aparır."},
"moveForward":function(d){return "irəli get"},
"moveForwardTooltip":function(d){return "Rəssamı irəli aparır."},
"moveNorthTooltip":function(d){return "Artisti şimala aparır."},
"moveNortheastTooltip":function(d){return "Artisti şimal-şərqə aparır."},
"moveNorthwestTooltip":function(d){return "Artisti şimal-qərbə aparır."},
"moveSouthTooltip":function(d){return "Artisti cənuba aparır."},
"moveSoutheastTooltip":function(d){return "Artisti canub-şərqə aparır."},
"moveSouthwestTooltip":function(d){return "Artisti cənub-qərbə aparır."},
"moveWestTooltip":function(d){return "Artisti qərbə aparır."},

...
"basketballSetPaddleSpeedFast":function(d){return "postavi ruke brzo"},
"basketballSetPaddleSpeedNormal":function(d){return "postavi normalnu brzinu ruku"},
"basketballSetPaddleSpeedRandom":function(d){return "postavi nasumičnu brzinu ruku"},
"basketballSetPaddleSpeedSlow":function(d){return "postavi ruke sporo"},
"basketballSetPaddleSpeedTooltip":function(d){return "Postavljanje brzine ruku"},
"basketballSetPaddleSpeedVeryFast":function(d){return "vrlo brzo postavi ruke"},
"basketballSetPaddleSpeedVerySlow":function(d){return "postavi ruke vrlo sporo"},
"basketballWhenBallMissesPaddle":function(d){return "kad lopta promaši ruku"},
"basketballWhenPaddleCollided":function(d){return "kad lopta pogodi ruku"},
...
"isWall":function(d){return "je li ovo zid"},
...
"playSoundBounce":function(d){return "Звук на одскокнување"},
"playSoundCheer":function(d){return "sviraj navijački zvuk"},
...
"playSoundKick":function(d){return "sviraj zvuk udarca"},
...
"playSoundSlapshot":function(d){return "pusti zvuk za slapshot"},
"playSoundSwish":function(d){return "pusti zvuk mrežnog fijuka"},
"playSoundTooltip":function(d){return "Pušta odrabrani zvuk."},
"playSoundWhistle":function(d){return "sviraj zvuk zviždaljke"},
...
"setBackground":function(d){return "postavi "+bounce_locale.v(d,"background")+" za pozadinu"},
...
"setBackgroundRetro":function(d){return "selektiraj staromodnu scenu"},
"setBackgroundTooltip":function(d){return "Postavlja sliku pozadine"},
"setBallHardcourt":function(d){return "setiraj loptu za tvrdi teren"},
"setBallRandom":function(d){return "setiraj nepredvidjenu loptu"},
"setBallRetro":function(d){return "selektiraj staromodnu loptu"},
"setBall":function(d){return "postavi "+bounce_locale.v(d,"ball")+" loptu"},
...
"setPaddle":function(d){return "postavi reket"},
...
"setPaddleRetro":function(d){return "setiraj staromodni reket"},
...
"setPaddleSpeedSlow":function(d){return "setiraj sporu brzinu reketa"},
...
"setPaddleSpeedVerySlow":function(d){return "setiraj veoma sporu brzinu reketa"},
"setPaddleTooltip":function(d){return "Setiraj sliku reketa"},
"setPlayer":function(d){return "postavi izgled lika"},
"setPlayerSpeedFast":function(d){return "postavi brzinu igrača na brzo"},
"setPlayerSpeedNormal":function(d){return "postavi brzinu igrača na normalno"},
"setPlayerSpeedRandom":function(d){return "postavi nasumičnu brzinu igrača"},
"setPlayerSpeedSlow":function(d){return "postavi brzinu igrača na sporo"},
"setPlayerSpeedTooltip":function(d){return "Postavite brzinu igrača"},
"setPlayerSpeedVeryFast":function(d){return "postavite brzinu igrača na veoma brzo"},
"setPlayerSpeedVerySlow":function(d){return "postavite brzinu igrača na veoma sporo"},
"setTeamTooltip":function(d){return "Postavite logo i šemu boje"},
"setTeam":function(d){return "Postavi tim "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Postavi nasumični tim"},
"shareBounceTwitter":function(d){return "Pogledaj igru Odskakanja koju sam napravio sam uz pomoć @codeorg"},
"shareBounceTwitterDonor":function(d){return "Pogledaj igru Odbijanja koju sam napravio. (Hvala "+bounce_locale.v(d,"donor")+" za podršku @code. org)"},
...
"whenPlayerCollidedTooltip":function(d){return "Izvršite akcije ispod kada se lopta sudari s igračem."},

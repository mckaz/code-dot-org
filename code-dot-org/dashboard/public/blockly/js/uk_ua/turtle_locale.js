...
"jumpNortheastTooltip":function(d){return "Переміщує художника на північний схід, не залишаючи сліду."},
"jumpNorthwestTooltip":function(d){return "Переміщує художника на північний захід, не залишаючи сліду."},
"jumpSouthTooltip":function(d){return "Переміщує художника на південь, не залишаючи сліду."},
"jumpSoutheastTooltip":function(d){return "Переміщує художника на південний схід, не залишаючи сліду."},
"jumpSouthwestTooltip":function(d){return "Переміщує художника на південний захід, не залишаючи сліду."},
...
"moveNortheastTooltip":function(d){return "Переміщує художника на північний схід."},
"moveNorthwestTooltip":function(d){return "Переміщує художника на північний захід."},
"moveSouthTooltip":function(d){return "Переміщує художника на південь."},
"moveSoutheastTooltip":function(d){return "Переміщує художника на південний схід."},
"moveSouthwestTooltip":function(d){return "Переміщує художника на південний захід."},

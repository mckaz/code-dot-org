...
"agentGenericFailureMessage":function(d){return "继续编码！记得使用代理人来帮忙。"},
"agentTooFewBlocksFailureMessage":function(d){return "尝试每次只添加一个方块，来让代理人抵达正确的地点。"},
...
"blockActionGetItemCount":function(d){return "获取条目数量"},
"blockActionGetItemCountInSlotNumber":function(d){return "获得槽号中的项目数量"},
"blockActionGetItemDetail":function(d){return "获得项目的细节"},
"blockActionGetItemDetailInSlotNumber":function(d){return "获得槽号中的项目信息"},
"blockActionGetItemSpace":function(d){return "获得项目的空间"},
"blockActionGetItemSpaceInSlotNumber":function(d){return "获得槽号中的项目空间"},
...
"blockType":function(d){return "模块类型"},
...
"blockTypeGlowstone":function(d){return "萤石"},
...
"blockTypePlanksAcacia":function(d){return "金合欢板"},
...
"blockTypeWoolMagenta":function(d){return "洋红色羊毛"},
...
"connectToCodeConnection":function(d){return "在《我的世界》中运行这个项目：教育版，请使用代码连接程序。"},
...
"items":function(d){return "项目"},
"itemsOfBlockType":function(d){return "项目的类型"},
"level10FailureMessage":function(d){return "盖住岩浆走过去，然后在对面开采两个铁方块。"},
"level11FailureMessage":function(d){return "如果前面有岩浆，一定要放置圆石。这样才能让你安全采到这排资源。"},
"level12FailureMessage":function(d){return "一定要采 3 块红石方块。这能将你从建造房屋和使用\"如果\"语句避免掉入岩浆中学到的东西组合到一起。"},
...
"miniBlockPlanksAcacia":function(d){return "金合欢板"},
...
"oldBlockHandling":function(d){return "老模块"},
...
"runAgent":function(d){return "运行代理人"},
...
"soundTypeCreeperHiss":function(d){return "爬行者嘘声"},

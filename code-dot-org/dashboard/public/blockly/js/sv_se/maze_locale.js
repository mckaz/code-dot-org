...
"collect":function(d){return "samla in"},
"collectiblePresent":function(d){return "det finns fortfarande skatter kvar"},
"collectorCollectTooltip":function(d){return "Samla in ett objekt"},
"collectorCollectedEverything":function(d){return "Grattis! Du har samlat in alla "+maze_locale.p(d,"count",0,"sv",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+" objekt!"},
"collectorCollectedNothing":function(d){return "Fortsätt koda! Du behöver samla in så många av objekten som du kan."},
"collectorCollectedSome":function(d){return "Bra jobbat! Du har samlat in "+maze_locale.p(d,"count",0,"sv",{"one":"1 item","other":maze_locale.n(d,"count")+" items"})+" objekt!"},
"collectorCollectedNotEnough":function(d){return "Fortsätt koda! Du behöver samla ihop minst "+maze_locale.p(d,"goal",0,"sv",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+" mål."},
"collectorCollectedTooMany":function(d){return "Det utrymmet har inte tillräckligt objekt för mig att samla in."},
"collectorTooManyBlocks":function(d){return "Du kan bara använda "+maze_locale.v(d,"blockLimit")+" block. Ta en titt på koden och försök igen!"},
"continue":function(d){return "Fortsätt"},
"corn":function(d){return "majs"},
"cornTooltip":function(d){return "Skörda några majskolvar"},
"didNotCollectAllCrops":function(d){return "Se till att du inte lämnar några grödor kvar!"},
"didNotCollectEverything":function(d){return "Se till att du inte lämnar några grödor kvar!"},
"didNotPlantEverywhere":function(d){return "Se till att du planterar något i varje jord!"},
...
"emptyCropError":function(d){return "Den grödan är slut."},
...
"haslettuce":function(d){return "det finns sallad"},
"hascorn":function(d){return "det finns majs"},
"haspumpkin":function(d){return "det finns pumpor"},
...
"lettuce":function(d){return "sallad"},
"lettuceTooltip":function(d){return "Skörda lite sallad"},
...
"pick":function(d){return "välj"},
"pilePresent":function(d){return "Det finns en hög"},
"plant":function(d){return "plantan"},
"plantInNonSoilError":function(d){return "Jag kan bara plantera i färsk jord."},
"plantTooltip":function(d){return "Plantera ett frö"},
"pumpkin":function(d){return "pumpa"},
"pumpkinTooltip":function(d){return "Skörda en pumpa"},
...
"wrongCropError":function(d){return "Jag kan inte skörda denna gröda härifrån."},

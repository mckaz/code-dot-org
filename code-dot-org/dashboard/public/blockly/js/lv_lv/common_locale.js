...
"actions":function(d){return "Darbības"},
...
"addStudentsMultiple":function(d){return "Pievienot vairākus skolēnus"},
...
"animationMode":function(d){return "Animācija"},
...
"applabMarketingButton":function(d){return "Uzzini vairāk"},
...
"applabTutorialButton":function(d){return "Sākt"},
...
"autoGenerated":function(d){return "Automātiski ģenerēts"},
...
"censusInvalidEmail":function(d){return "Lūdzu, ievadi derīgu e-pasta adresi"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"lv",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"choosePrefix":function(d){return "Izvēlēties..."},
...
"completed":function(d){return "Pabeigts"},
"completedWithoutRecommendedBlock":function(d){return "Apsveicu! Tu izpildīji "+common_locale.v(d,"puzzleNumber")+". mīklu. (Bet tu varēji izmantot citu bloku, lai veidotu stiprāku kodu.)"},
...
"congratsCertificatePersonalize":function(d){return "Personalizē savu sertifikātu"},
"congratsCertificateShare":function(d){return "Dalies ar saviem sasniegumiem"},
"congratsCertificateThanks":function(d){return "Paldies par iesniegumu!"},
...
"copy":function(d){return "Kopija"},
"copyright":function(d){return "Copyright"},
"correct":function(d){return "Pareizi"},
"correctAnswer":function(d){return "Tā ir pareizā atbilde."},
"country":function(d){return "Valsts"},
"course":function(d){return "Kurss"},
...
"courseBlocksToolsAppLab":function(d){return "Aplikāciju laborotorija"},
...
"courses":function(d){return "Kursi"},
...
"coursesHeadingStudent":function(d){return "Mācies Code Studio"},
...
"createSectionsInfo":function(d){return "Izveido jaunas sadaļas un pievieno tām skolēnus. Sadaļas ļauj tev sakārtot skolēnus mazākās grupās, kurās vienkāršāk sekot līdzi skolēnu progresam un to kontu pārvaldībai."},
...
"currentVersion":function(d){return "Pašreizējā versija"},
"curriculum":function(d){return "Mācību programmas"},
...
"dataTableNamePlaceholder":function(d){return "Tabulas nosaukums"},
"dataWorkspaceHeader":function(d){return "Datu pārlūks"},
...
"debugWatchHeader":function(d){return "Vērot"},
"debugWatchNotAvailable":function(d){return "<nav pieejams>"},
...
"delete":function(d){return "Izdzēst"},
"deleteConfirm":function(d){return "Izdzēst?"},
...
"disabledButtonsWhy":function(d){return "Kāpēc mani burbuļi ir pelēki?"},
...
"done":function(d){return "Gatavs"},
"dontForget":function(d){return "Neaizmirstiet"},
...
"dropletBlock_comment_description":function(d){return "Uzrakstiet koda aprakstu"},
"dropletBlock_comment_signatureOverride":function(d){return "komentārs"},
...
"dropletBlock_greaterThanOrEqualOperator_signatureOverride":function(d){return "Operators \"lielāks vai vienāds\""},
...
"dropletBlock_lessThanOrEqualOperator_signatureOverride":function(d){return "Operators \"mazāks vai vienāds\""},
...
"dropletBlock_mathRandom_description":function(d){return "Atgriež gadījuma skaitli robežās no 0 (ieskaitot) līdz 1 (neieskaitot)"},
"dropletBlock_mathRandom_signatureOverride":function(d){return "Matemātika.nejauša secība()"},
...
"dropletBlock_randomNumber_description":function(d){return "Atgriež gadījumskaitli diapazonā no min līdz max (ieskaitot)."},
"dropletBlock_randomNumber_param0":function(d){return "minimālais"},
"dropletBlock_randomNumber_param0_description":function(d){return "Mazākais atgrieztais skaitlis"},
"dropletBlock_randomNumber_param1":function(d){return "maksimālais"},
"dropletBlock_randomNumber_param1_description":function(d){return "Lielākais atgrieztais skaitlis"},
...
"edit":function(d){return "Rediģēt"},
...
"emptyBlockInFunction":function(d){return "Funkcijai "+common_locale.v(d,"name")+" ir neaizpildīta ievades vērtība."},
...
"emptyExampleBlockErrorMsg":function(d){return "Jums ir jāizveido vismaz divi funkcijas "+common_locale.v(d,"functionName")+" piemēri. Pārliecinieties, vai katram piemēram ir izsaukums un rezultāts."},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"lv",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
"exampleErrorMessage":function(d){return "Funkcijai "+common_locale.v(d,"functionName")+" ir viens vai vairāki piemēri, kurus nepieciešams pielāgot. Pārliecinieties, ka tie atbilst jūsu definīcijai un atbild uz jautājumu."},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"lv",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"forTeachersOnly":function(d){return "Tikai skolotājiem"},
"gender":function(d){return "Dzimums"},
"genderMale":function(d){return "Vīrietis"},
"genderFemale":function(d){return "Sieviete"},
...
"getHelp":function(d){return "Saņemt palīdzību"},
"goBack":function(d){return "Go Back"},
"goToUnit":function(d){return "Go to Unit"},
"grade":function(d){return "Vērtējums"},
...
"hidden":function(d){return "Slēpts"},
...
"hintReviewTitle":function(d){return "Pārskatīt savus padomus"},
"hintSelectInstructions":function(d){return "Instrukcijas un iepriekšējie padomi"},
"hintSelectNewHint":function(d){return "Izvēlēties jaunu padomu"},
...
"homepageUiTipsBeforeDialogConfirm":function(d){return "Pārādīt man"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "Pabeigt"},
"homepageUiTipsAfterDialogConfirm":function(d){return "Uzzini vairāk"},
"iconSearchPlaceholder":function(d){return "Meklēt ikonas..."},
"iDontKnow":function(d){return "I don't know"},
"ignore":function(d){return "Izlaist"},
...
"incorrectAnswer":function(d){return "Nepareiza atbilde"},
"incorrectAnswerBody":function(d){return "Ievadītā atbilde ir nekorekta. Lūdzu mēģini vēlreiz!"},
"incorrectSolution":function(d){return "Nepareizs risinājums"},
"incorrectSolutionBody":function(d){return "Ievadītais risinājums nav pareizs. Lūdzu mēģini vēl!"},
...
"joinSectionPlaceholder":function(d){return "Izvēles kods (ABCDEF)"},
"joinCommunity":function(d){return "Join community"},
"joinText":function(d){return "apvienot"},
...
"justDidHourOfCode":function(d){return "Es tikko izpildīju #Programmēšanas_stundu - pārbaudi! @codeorg"},
...
"learnMore":function(d){return "Uzzini vairāk"},
...
"lessonPlans":function(d){return "Nodarbību plāni"},
...
"loading":function(d){return "Ielādē..."},
...
"loginType":function(d){return "Autorizēšanās veids"},
...
"manageStudents":function(d){return "Pārvaldīt skolēnus"},
"manageStudentsNotificationFailure":function(d){return "Something went wrong."},
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"lv",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"lv",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"minecraftMarketingButton":function(d){return "Sākt"},
...
"missingRecommendedBlocksErrorMsg":function(d){return "Ne gluži. Pamēģini izmantot vēl neizmantotu bloku."},
"missingRequiredBlocksErrorMsg":function(d){return "Ne gluži. Tev jāizmanto vēl neizmantots bloks."},
"more":function(d){return "Vairāk"},
"moreInfo":function(d){return "More info."},
"myCourses":function(d){return "My Courses"},
"myProjects":function(d){return "My Projects"},
"name":function(d){return "Vārds"},
...
"newPassword":function(d){return "Jauna parole"},
"newSection":function(d){return "Jauna sadaļa"},
...
"noIconsFound":function(d){return "Ikonas nav atrastas"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"lv",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"ok":function(d){return "Labi"},
"okay":function(d){return "Labi"},
"online":function(d){return "Tiešsaistē"},
"openWorkspace":function(d){return "Kā tas darbojas"},
"or":function(d){return "vai"},
...
"pairProgramming":function(d){return "Pāru Programmēšana"},
"parent":function(d){return "Vecāki"},
"parents":function(d){return "Parents"},
"parentsAndStudents":function(d){return "Parents and Students"},
"password":function(d){return "Parole"},
...
"playzoneArtistDescription":function(d){return "Uzzīmēt foršus attēlus un dizainus ar Izpildītāju!"},
"playzoneArtistTitle":function(d){return "New Drawing"},
"playzoneContinueButton":function(d){return "Go on to the next Stage"},
"playzonePlaylabDescription":function(d){return "Izveidot stāstu vai spēli ar Spēles laboratoriju!"},
...
"printCertificate":function(d){return "Izdrukāt sertifikātu"},
"printCertificates":function(d){return "Print certificates"},
"printLoginCards":function(d){return "Print Login Cards"},
"privacyPolicy":function(d){return "Privātuma politika"},
...
"projectGroupMath":function(d){return "Matemātika"},
...
"projectGroupPreReader":function(d){return "Pirms lasītprasmes"},
...
"projectType":function(d){return "Tips"},
...
"projectTypeApplab":function(d){return "Aplikāciju laborotorija"},
"projectTypeArtist":function(d){return "Mākslinieks"},
...
"projectTypePlaylab":function(d){return "Spēles laboratorija"},
...
"projectTypeEvents":function(d){return "Pasākumi"},
"projectTypeFrozen":function(d){return "Ledus sirds"},
"projectTypeK1":function(d){return "Pirms lasītprasmes"},
...
"projectTypeFlappy":function(d){return "Flapijs"},
"projectTypeSports":function(d){return "Sports"},
"projectTypeBasketball":function(d){return "Basketball"},
"projectTypeBounce":function(d){return "Atlekt"},
"projectTypeInfinity":function(d){return "Bezgalība"},
...
"recommendedBlockContextualHintTitle":function(d){return "Mēģiniet izmantot līdzīgu bloku kā šis, lai atrisinātu uzdevumu."},
...
"reset":function(d){return "Atiestatīt"},
"resetProgram":function(d){return "Atiestatīt"},
"resetPassword":function(d){return "Atiestatīt paroli"},
"resources":function(d){return "Resources"},
"restoreThisVersion":function(d){return "Atjaunot šo versiju"},
...
"save":function(d){return "Saglabāt"},
"saveAll":function(d){return "Saglabāt visu"},
...
"schoolTypeOther":function(d){return "Citi"},
...
"section":function(d){return "Sadaļa"},
"sectionCode":function(d){return "Sadaļas kods"},
"sectionName":function(d){return "Sadaļas nosaukums"},
...
"secret":function(d){return "Noslēpums"},
...
"sendToPhone":function(d){return "Sūtīt uz telefonu"},
...
"shareWarningsAge":function(d){return "Lūdzu, zemāk norādiet savu vecumu un noklikšķiniet uz LABI, lai turpinātu."},
...
"showBlock":function(d){return "Iegūsti bloku"},
...
"showSecret":function(d){return "Parādīt noslēpumu"},
...
"signupFormSchoolType":function(d){return "Tips"},
...
"standardsAndFramework":function(d){return "Stundu plāni un resursi"},
"standardsAndFrameworkDescription":function(d){return "Information about standards alignment for Code.org courses."},
"startLearning":function(d){return "Sāc mācīties"},
"startOver":function(d){return "Sākt no sākuma"},
"startOverTitle":function(d){return "Vai esat pārliecināts, ka vēlaties sākt no jauna?"},
...
"student":function(d){return "Students"},
"students":function(d){return "Skolēni"},
"studentAccountsAndProgress":function(d){return "Skolēnu konti un progress"},
...
"studentName":function(d){return "Skolēna vārds"},
...
"teacher":function(d){return "Skolotāja"},
"teachers":function(d){return "Skolotāji"},
...
"teacherCourseHoc":function(d){return "Programmēšanas stunda"},
...
"tryAgain":function(d){return "Mēģini vēlreiz"},
"tryBlocksBelowFeedback":function(d){return "Mēģini izmantot kādu no zemāk dotajiem blokiem:"},
"tryHOC":function(d){return "Izmēģini Programmēšanas stundu"},
"tryIt":function(d){return "Izmēģini"},
...
"unattachedBlockTipTitle":function(d){return "Nepievienotie bloki"},
"unattachedBlockTipBody":function(d){return "Bloki, kas nav piesaistīti neko nedarīs. Ja vēlaties šos blokus savā programmā, mēģiniet tos piesaistīt citiem blokiem."},
...
"unplugged":function(d){return "Bezsaistē"},
"unpluggedActivity":function(d){return "Atvienota aktivitāte"},
...
"unsubmit":function(d){return "Atcelt iesniegšanu"},
"unsubmitAssessment":function(d){return "Unsubmit your assessment"},
"unsubmitYourProject":function(d){return "Neiesniegt savu projektu"},
"unsubmitYourProjectConfirm":function(d){return "Projekta iesniegšanas atcelšana atcels iesniegšanas datumu, tiešām atcelt?"},
...
"viewLessonPlan":function(d){return "Apskatīt nodarbību plānu"},

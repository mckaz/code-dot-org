...
"basketballLaunchBall":function(d){return "хвърля нова топка"},
"basketballLaunchBallTooltip":function(d){return "Пуска топката в играта."},
"basketballSetPaddle":function(d){return "задай ръчно"},
"basketballSetPaddleSpeedFast":function(d){return "задава бърза скорост на ръката"},
"basketballSetPaddleSpeedNormal":function(d){return "задава нормална скорост на ръката"},
"basketballSetPaddleSpeedRandom":function(d){return "задава произволна скорост на ръката"},
"basketballSetPaddleSpeedSlow":function(d){return "задава бавна скорост на ръката"},
"basketballSetPaddleSpeedTooltip":function(d){return "Задава скоростта на ръката"},
"basketballSetPaddleSpeedVeryFast":function(d){return "задава много бърза скорост на ръката"},
"basketballSetPaddleSpeedVerySlow":function(d){return "задава много бавна скорост на ръката"},
"basketballWhenBallMissesPaddle":function(d){return "когато топката пропусне ръката"},
"basketballWhenPaddleCollided":function(d){return "когато топката се удари в ръката"},
"bounceBall":function(d){return "топката отскача"},
"bounceBallTooltip":function(d){return "Отблъсни топката от обекта."},
...
"playSoundCheer":function(d){return "изпълни звук \" аплодисменти\""},
...
"playSoundKick":function(d){return "изпълни звук \"ритник\""},
...
"playSoundSlapshot":function(d){return "изпълни звук \"Размазване\""},
"playSoundSwish":function(d){return "изпълни звук \"net swish \""},
"playSoundTooltip":function(d){return "Възпроизвеждане на избраният звук."},
"playSoundWhistle":function(d){return "изпълни звук \"свирка\""},
...
"setBackground":function(d){return "задай "+bounce_locale.v(d,"background")+" сцена"},
...
"setBall":function(d){return "задава "+bounce_locale.v(d,"ball")+" топка"},
...
"setPaddle":function(d){return "задава платформа"},
...
"setPlayerSpeedFast":function(d){return "задава бърза скорост на играч"},
"setPlayerSpeedNormal":function(d){return "задава нормална скорост на играч"},
"setPlayerSpeedRandom":function(d){return "задава случайна скорост на играч"},
"setPlayerSpeedSlow":function(d){return "задава бавна скорост на играч"},
"setPlayerSpeedTooltip":function(d){return "Задава скоростта на играча"},
"setPlayerSpeedVeryFast":function(d){return "задава много бърза скорост на играч"},
"setPlayerSpeedVerySlow":function(d){return "задава много бавна скорост на играч"},
"setTeamTooltip":function(d){return "Задава лого и цветова схема"},
"setTeam":function(d){return "Задава екип "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Създава случаен екип"},
"shareBounceTwitter":function(d){return "Вижте Bounce играта, която съм създал. Написах я с @codeorg"},
"shareBounceTwitterDonor":function(d){return "Вижте Bounce играта, която направих. (Благодаря на "+bounce_locale.v(d,"donor")+" за подкрепа на @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "когато топката пропусне играча"},
...
"whenPlayerCollided":function(d){return "когато топката е ударена от играча"},
"whenPlayerCollidedTooltip":function(d){return "Изпълнява действията по-долу, когато топката се докосне до играч."},

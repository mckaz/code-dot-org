...
"jumpNortheastTooltip":function(d){return "Move o artista na direção nordeste sem deixar marcas."},
"jumpNorthwestTooltip":function(d){return "Move o artista na direção noroeste sem deixar marcas."},
"jumpSouthTooltip":function(d){return "Move o artista para o sul sem deixar marcas."},
"jumpSoutheastTooltip":function(d){return "Move o artista na direção sudeste sem deixar marcas."},
"jumpSouthwestTooltip":function(d){return "Move o artista na direção sudoeste sem deixar marcas."},
...
"moveNortheastTooltip":function(d){return "Move o artista na direção nordeste."},
"moveNorthwestTooltip":function(d){return "Move o artista na direção noroeste."},
"moveSouthTooltip":function(d){return "Move o artista para o sul."},
"moveSoutheastTooltip":function(d){return "Move o artista na direção sudeste."},
"moveSouthwestTooltip":function(d){return "Move o artista na direção sudoeste."},
...
"setCharacter":function(d){return "configurar personagem à "+turtle_locale.v(d,"character")},

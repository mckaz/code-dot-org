...
"actions":function(d){return "ایکشنز"},
"add":function(d){return "ا ضافہ کرنا"},
...
"applabMarketingButton":function(d){return "مزید سیکھے"},
...
"applabTutorialButton":function(d){return "شروع کریں"},
...
"censusInvalidEmail":function(d){return "Spna sahi Email address ka indraj kijiye"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"ur",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"congratsCertificateThanks":function(d){return "Jama kerwane ka shukarya!"},
...
"country":function(d){return "Mulk"},
...
"courses":function(d){return "کورسز"},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"ur",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"ur",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"gender":function(d){return "Jinss"},
...
"homepageUiTipsBeforeDialogConfirm":function(d){return "مجھے دکھاؤ"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "اختتام"},
"homepageUiTipsAfterDialogConfirm":function(d){return "مزید سیکھے"},
...
"instructions":function(d){return "ہدایات"},
...
"joinText":function(d){return "جوائن"},
"joinTextTooltip":function(d){return "Create a piece of text by joining together multiple items."},
"joinUs":function(d){return "ہمارے ساتھ شامل ہوں"},
"jump":function(d){return "چھلانگ لگایں"},
"justDidHourOfCode":function(d){return "میں نے کیا #HourOfCode -اسے جانچیں! @codeorg"},
...
"learnMore":function(d){return "مزید سیکھے"},
...
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"ur",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"ur",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"minecraftMarketingButton":function(d){return "شروع کریں"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"ur",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"numBlocksUsedLabel":function(d){return "بلاکس"},
...
"ok":function(d){return "ٹھيک ہے"},
"okay":function(d){return "Okay"},
"online":function(d){return "آن لائن"},
...
"projectType":function(d){return "قسم"},
...
"projectTypeEvents":function(d){return "موقعے"},
"projectTypeFrozen":function(d){return "فروزن"},
...
"projectTypeIceage":function(d){return "برفانی عہد"},
...
"reset":function(d){return "ری-سیٹ کریں"},
...
"signupFormSchoolType":function(d){return "قسم"},
...
"startLearning":function(d){return "سیکھنا شروع کریں"},
"startOver":function(d){return "آغاز(اسٹارٹ اوور)"},
"startOverTitle":function(d){return "کیا آپ یقینی طور پر دوبارہ شروع (اسٹارٹ اوور) کرنا چاہتے ہیں؟"},
...
"student":function(d){return "Talib-e-ilm"},
...
"teacherCourseHoc":function(d){return "آور-آف-کوڈ"},
...
"teacherHomePage":function(d){return "ٹیچر ہوم پیج"},

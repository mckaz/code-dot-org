...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"es",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"es",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"specialAnnouncementDescription":function(d){return "Applications are still open for middle and high school teachers to join our 2018 Professional Learning program. Start teaching the fastest growing subject in schools today! No experience needed."},

...
RDL.orig_type DashboardStudent, 'self.update_if_allowed', "({ id: Integer, name: String, age: Integer, password: String, gender: String, secrets: String }, Integer) -> #{$fetch_if_allowed_output}", typecheck: :later, wrap: false
...
RDL.orig_type StorageApps, :delete, "(String) -> %bool", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :publish, "(String, String, { name: String, birthday: DateTime }) -> { channel: Integer, name: String, thumbnailUrl: String, type: String, publishedAt: DateTime, studentName: { name: String, birthday: DateTime } or String, studentAgeRange: { name: String, birthday: DateTime } or String }", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :unpublish, "(String) -> Integer", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :get_abuse, "(String) -> Integer", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :get_sharing_disabled, "(String, Integer) -> %bool", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :increment_abuse, "(String) -> Integer", wrap: false, typecheck: :later
RDL.orig_type StorageApps, :reset_abuse, "(String) -> Integer", wrap: false, typecheck: :later
...
RDL.orig_type Object, :storage_decrypt_channel_id, "(String) -> [Integer, Integer]", wrap: false
...
RDL.orig_type Object, :user_storage_ids_table, "() -> Table<{ id: Number, user_id: Number, __selected: nil, __last_joined: :user_storage_ids, __all_joined: :user_storage_ids, __orm: false }>"

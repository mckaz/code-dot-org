...
"avoidCowAndRemove":function(d){return "inekten sakın ve 1 çıkar"},
"collect":function(d){return "topla"},
"collectiblePresent":function(d){return "biraz hazine var"},
"collectorCollectTooltip":function(d){return "Nesneleri topla"},
"collectorCollectedEverything":function(d){return "Tebrikler! "+maze_locale.p(d,"count",0,"tr",{"one":"nesne","other":maze_locale.n(d,"count")+" nesne"})+" topladın!"},
"collectorCollectedNothing":function(d){return "Kodlamaya devam et! Mümkün olduğunca çok nesne toplaman gerekir."},
"collectorCollectedSome":function(d){return "Harika iş! "+maze_locale.p(d,"count",0,"tr",{"one":"1 nesne","other":maze_locale.n(d,"count")+" nesne"})+" topladın!"},
"collectorCollectedNotEnough":function(d){return "Kodlamaya devam edin! En az bir tane "+maze_locale.p(d,"goal",0,"tr",{"one":"1 nesne","other":"ya da "+maze_locale.n(d,"goal")+" nesne"})+" bulman gerekir."},
"collectorCollectedTooMany":function(d){return "Burada toplamam için yeterli eşya yok."},
"collectorTooManyBlocks":function(d){return "Sadece "+maze_locale.v(d,"blockLimit")+" sayıda blok kullanabilirsin. Koduna bir göz at ve tekrar dene!"},
"continue":function(d){return "Devam"},
"corn":function(d){return "mısır"},
"cornTooltip":function(d){return "Biraz mısır topla"},
"didNotCollectAllCrops":function(d){return "Toplanacak başka hasat kalmadığından emin ol!"},
"didNotCollectEverything":function(d){return "Arkanızda nektar veya bal bırakmadığınıza emin olun!"},
"didNotPlantEverywhere":function(d){return "Her toprak parçasına bir şey ektiğinden emin ol!"},
...
"emptyCropError":function(d){return "Bu ürünün tamamı gitti."},
"fill":function(d){return "1 doldurun"},
"fillN":function(d){return maze_locale.v(d,"shovelfuls")+" doldurun"},
"fillSquare":function(d){return "Kareyi doldurun"},
"fillStack":function(d){return maze_locale.v(d,"shovelfuls")+" kadar deliğe yığını doldur"},
...
"haslettuce":function(d){return "marul var"},
"hascorn":function(d){return "mısır var"},
"haspumpkin":function(d){return "balkabakları var"},
...
"ifOnlyFlowerTooltip":function(d){return "Belirtilen yönde bir çiçek varsa, o zaman bazı işlemleri yap."},
...
"insufficientHoney":function(d){return "Doğru miktarda bal yapman gerek."},
"insufficientNectar":function(d){return "Doğru miktarda nektar toplaman gerek."},
"lettuce":function(d){return "marul"},
"lettuceTooltip":function(d){return "Biraz marul topla"},
...
"moveWestTooltip":function(d){return "Beni batıya bir adım ilerlet."},
...
"plant":function(d){return "ek"},
"plantInNonSoilError":function(d){return "Sadece yeni toprağa bir şeyler ekebilirim."},
"plantTooltip":function(d){return "Bir filiz ek"},
"pumpkin":function(d){return "kabak"},
"pumpkinTooltip":function(d){return "Balkabağı topla"},
"putdownTower":function(d){return "Kule koyun"},
"removeAndAvoidTheCow":function(d){return "1 çıkar ve inekten sakın"},
"removeN":function(d){return maze_locale.v(d,"shovelfuls")+" kadar çıkar"},
"removePile":function(d){return "Yığını Kaldır"},
"removeSquare":function(d){return "Kareyi Kaldır"},
"removeStack":function(d){return maze_locale.v(d,"shovelfuls")+" kadar yığını kaldır"},
...
"wrongCropError":function(d){return "Ürünü buradan toplayamam."},
"yes":function(d){return "Evet"},
"youSpelled":function(d){return "Hecelediğin kelime"}};
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"te",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"te",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"te",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"finalStageTrophies":function(d){return "Congratulations! You have completed the final puzzle and won "+common_locale.p(d,"numTrophies",0,"te",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
...
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"te",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"te",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"nextLevelTrophies":function(d){return "Congratulations! You completed Puzzle "+common_locale.v(d,"puzzleNumber")+" and won "+common_locale.p(d,"numTrophies",0,"te",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
"nextPuzzle":function(d){return "Next puzzle"},
"nextStage":function(d){return "Congratulations! You completed "+common_locale.v(d,"stageName")+"."},
"nextStageTrophies":function(d){return "Congratulations! You completed "+common_locale.v(d,"stageName")+" and won "+common_locale.p(d,"numTrophies",0,"te",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"te",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
"numBlocksNeeded":function(d){return "Congratulations! You completed Puzzle "+common_locale.v(d,"puzzleNumber")+". (However, you could have used only "+common_locale.p(d,"numBlocks",0,"te",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+".)"},
"numBlocksUsedLabel":function(d){return "Blocks"},
"numLinesOfCodeWritten":function(d){return "You just wrote "+common_locale.p(d,"numLines",0,"te",{"one":"1 line","other":common_locale.n(d,"numLines")+" lines"})+" of code!"},
...
"totalNumLinesOfCodeWritten":function(d){return "All-time total: "+common_locale.p(d,"numLines",0,"te",{"one":"1 line","other":common_locale.n(d,"numLines")+" lines"})+" of code."},

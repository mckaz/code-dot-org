...
"endGameTooltip":function(d){return "ஆட்டம் முடிகிறது."},
"finalLevel":function(d){return "வாழ்த்துக்கள்! நீங்கள் இறுதிப் புதிரை முடித்துவிட்டீர்கள்."},
"flap":function(d){return "flap"},
"flapRandom":function(d){return "ஏதாவது ஒரு தொகை flap"},
"flapVerySmall":function(d){return "ஒரு மிகவும் சிறிய அளவு flap"},
...
"setSpeed":function(d){return "வேகத்தை தீர்மானி"},

...
"drawASquare":function(d){return "нацртај квадрат"},
...
"drawSticker":function(d){return "нацртајте печат"},
"heightParameter":function(d){return "висина"},
"hideTurtle":function(d){return "сакриј уметника"},
"jump":function(d){return "скок"},
"jumpTo":function(d){return "пређи на"},
"jumpBackward":function(d){return "скочи назад за"},
"jumpForward":function(d){return "скочи напред за"},
"jumpTooltip":function(d){return "Помера уметника тако да не оставља трагове."},
"jumpEastTooltip":function(d){return "Померите уметника источно тако да не оставите никакав траг."},
"jumpNorthTooltip":function(d){return "Померите уметника северно тако да не оставите никакав траг."},
...
"lengthFeedback":function(d){return "Урадили сте све добро сем дужине померања."},
...
"notBlackColour":function(d){return "Морате поставити боју која није црна за ову слагалицу."},
"numBlocksNeeded":function(d){return "Ова слагалица се може решити са %1 блоком. Можете користити %2."},
"penDown":function(d){return "Спусти оловку"},
"penTooltip":function(d){return "листа љубитеља оловке, да почну или престану цртати."},
...
"sizeParameter":function(d){return "величина"},
...
"turnLeft":function(d){return "окрени се лево за"},
"turnRight":function(d){return "окрени се десно за"},
"turnRightTooltip":function(d){return "Окреће уметника удесно за одређени угао."},
"turnTooltip":function(d){return "Окреће уметника улево или удесно за одређени број степени."},
"turtleVisibilityTooltip":function(d){return "Чини уметника видљивим или невидљивим."},
"widthTooltip":function(d){return "Мења ширину оловке."},
"wrongColour":function(d){return "Ваша је слика погрешне боје. За слагалицу, мора бити %1."}};
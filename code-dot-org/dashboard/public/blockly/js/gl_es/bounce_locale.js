...
"basketballLaunchBall":function(d){return "lanzar unha nova bóla"},
"basketballLaunchBallTooltip":function(d){return "Lanza unha bóla para xogar."},
"basketballSetPaddle":function(d){return "establecer man"},
"basketballSetPaddleSpeedFast":function(d){return "establecer velocidade de man rápida"},
"basketballSetPaddleSpeedNormal":function(d){return "establecer velocidade de man normal"},
"basketballSetPaddleSpeedRandom":function(d){return "establecer velocidade de man ao chou"},
"basketballSetPaddleSpeedSlow":function(d){return "establecer velocidade de man lenta"},
"basketballSetPaddleSpeedTooltip":function(d){return "Establecer a velocidade de man"},
"basketballSetPaddleSpeedVeryFast":function(d){return "establecer velocidade de man moi rápida"},
"basketballSetPaddleSpeedVerySlow":function(d){return "establecer velocidade de man moi lenta"},
"basketballWhenBallMissesPaddle":function(d){return "cando a bóla non chega á man"},
"basketballWhenPaddleCollided":function(d){return "cando a bóla chega á man"},
"bounceBall":function(d){return "botar a bóla"},
"bounceBallTooltip":function(d){return "Arrebolar a bóla contra un obxecto."},
...
"incrementOpponentScore":function(d){return "anota un punto ao adversario"},
"incrementOpponentScoreTooltip":function(d){return "Engade un punto á puntuación actual do adversario."},
"incrementPlayerScore":function(d){return "marcar un punto"},
"incrementPlayerScoreTooltip":function(d){return "Engade un punto á puntuación actual do xogador."},
"isWall":function(d){return "esto é unha parede"},
...
"playSoundCheer":function(d){return "reproducir son de aplausos"},
...
"playSoundKick":function(d){return "reproducir son de patada"},
...
"playSoundSlapshot":function(d){return "reproducir son de golpe"},
"playSoundSwish":function(d){return "reproducir son de golpe na rede"},
"playSoundTooltip":function(d){return "Reproduce o son escollido."},
"playSoundWhistle":function(d){return "reproducir son de asubío"},
...
"setBackground":function(d){return "establecer "+bounce_locale.v(d,"background")+" escenario"},
...
"setBallRandom":function(d){return "por unha bola ao chou"},
"setBallRetro":function(d){return "por unha pelota retro"},
"setBall":function(d){return "establecer "+bounce_locale.v(d,"ball")+" bóla"},
...
"setPaddle":function(d){return "establecer raqueta"},
...
"setPlayerSpeedFast":function(d){return "establecer a velocidade de xogo como rápida"},
"setPlayerSpeedNormal":function(d){return "establecer a velocidade de xogo como normal"},
"setPlayerSpeedRandom":function(d){return "establecer velocidade como aleatoria"},
"setPlayerSpeedSlow":function(d){return "establecer velocidade de xogo como lenta"},
"setPlayerSpeedTooltip":function(d){return "Establece a velocidad do xogador"},
"setPlayerSpeedVeryFast":function(d){return "establece a velocidade do xogo como moi rápida"},
"setPlayerSpeedVerySlow":function(d){return "establece a velocidade do xogo como moi lenta"},
"setTeamTooltip":function(d){return "Establece o logo e a paleta de cores"},
"setTeam":function(d){return "Establecer equipo "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Establecer un equipo ao chou"},
"shareBounceTwitter":function(d){return "Bótalle un ollo o xogo Bounce que creei. Escribino eu mesmo con @codeorg"},
"shareBounceTwitterDonor":function(d){return "Bota unha ollada ao xogo de Ping-pong que fixen. (Grazas "+bounce_locale.v(d,"donor")+" por apoiar a @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "cando a bóla non bate no xogador"},
...
"whenPlayerCollided":function(d){return "cando a bóla bate no xogador"},
"whenPlayerCollidedTooltip":function(d){return "Executar as seguintes accións cando a bóla bata no xogador."},

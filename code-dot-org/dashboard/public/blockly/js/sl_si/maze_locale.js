...
"collect":function(d){return "poberi"},
"collectiblePresent":function(d){return "zaklad je na voljo"},
"collectorCollectTooltip":function(d){return "Zbiranje predmetov"},
"collectorCollectedEverything":function(d){return "Čestitamo! Zbral/a si "+maze_locale.p(d,"count",0,"sl",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNothing":function(d){return "Nadaljuj s kodiranje! Zberi čim več predmetov, kolikor le lahko."},
"collectorCollectedSome":function(d){return "Zelo dobro! Zbral/a si "+maze_locale.p(d,"count",0,"sl",{"one":"1 item","other":maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"sl",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
...
"elseCode":function(d){return "sicer"},
...
"lettuce":function(d){return "solata"},

...
"collect":function(d){return "kerätä"},
"collectiblePresent":function(d){return "on vielä aarteita jäljellä"},
"collectorCollectTooltip":function(d){return "Kerää esine"},
"collectorCollectedEverything":function(d){return "Onnittelut! Keräsit "+maze_locale.p(d,"count",0,"fi",{"one":"esineen","other":"kaikki "+maze_locale.n(d,"count")+" esinettä"})+"!"},
"collectorCollectedNothing":function(d){return "Jatka koodausta! Sinun pitää kerätä niin monta esinettä kun voit."},
"collectorCollectedSome":function(d){return "Hyvää työtä! Keräsit "+maze_locale.p(d,"count",0,"fi",{"one":"esineen","other":maze_locale.n(d,"count")+" esinettä"})+"!"},
"collectorCollectedNotEnough":function(d){return "Jatka koodausta! Sinun pitää kerätä viellä ainakin "+maze_locale.p(d,"goal",0,"fi",{"one":"yksi esine","other":maze_locale.n(d,"goal")+" esinettä"})+"."},
"collectorCollectedTooMany":function(d){return "Tuossa tilassa ei ole tarpeeksi esineitä kerättäväksi."},
"collectorTooManyBlocks":function(d){return "Voit käyttää vain "+maze_locale.v(d,"blockLimit")+" palikkaa. Tarkista koodisi ja yritä uudelleen!"},
"continue":function(d){return "Jatka"},
"corn":function(d){return "maissi"},
"cornTooltip":function(d){return "Korjaa hieman maissia"},
"didNotCollectAllCrops":function(d){return "Varmista, ettet jätä yhtäkään viljelykasvia keräämättä!"},
"didNotCollectEverything":function(d){return "Varmista, ettet jätä yhtään mettä tai hunajaa keräämättä!"},
"didNotPlantEverywhere":function(d){return "Varmista, että istutat jotain kaikkiin kohtiin!"},
...
"emptyCropError":function(d){return "Tuo sato on kokonaan mennyt."},
...
"haslettuce":function(d){return "on salaattia"},
"hascorn":function(d){return "on maissia"},
"haspumpkin":function(d){return "on kurpitsoja"},
...
"lettuce":function(d){return "salaatti"},
"lettuceTooltip":function(d){return "Korjaa hieman salaattia"},
...
"pick":function(d){return "poimi"},
"pilePresent":function(d){return "tässä on kasa"},
"plant":function(d){return "aseta"},
"plantInNonSoilError":function(d){return "Voit ainoastaan istuttaa jotain tuoreelle maaperälle."},
"plantTooltip":function(d){return "Istuta verso"},
"pumpkin":function(d){return "kurpitsa"},
"pumpkinTooltip":function(d){return "Korjata kurpitsa"},
...
"soil":function(d){return "maaperä"},
"sprout":function(d){return "siemen"},
...
"wrongCropError":function(d){return "Et voi korjata tuota satoa täältä."},

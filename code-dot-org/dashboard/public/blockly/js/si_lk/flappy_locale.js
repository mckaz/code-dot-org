...
"setPlayerSuperman":function(d){return "flappyman ල‍ෙස ක්‍රීඩකයා නිර්මාණය කරන්න"},
...
"soundBounce":function(d){return "ආපසු පනින්න"},
"soundCrunch":function(d){return "crunch"},
"soundDie":function(d){return "දුක සහිත"},
...
"speedRandom":function(d){return "අහඹු වේගයක් තෝරන්න"},
"speedVerySlow":function(d){return "ඉතා සුළු වේගයක් තෝරන්න"},
"speedSlow":function(d){return "සුළු වේගයක් තෝරන්න"},
...
"whenCollideGroundTooltip":function(d){return "Flappy භූමියේ ගැටුනු විගසම පහත ක්‍රියාවන් ක්‍රියාත්මක කරන්න."},
...
"whenRunButtonClickTooltip":function(d){return "ක්‍රීඩාව ආරම්භ වූ විගසම පහත ක්‍රියාවන් ක්‍රියාත්මක කරන්න."},

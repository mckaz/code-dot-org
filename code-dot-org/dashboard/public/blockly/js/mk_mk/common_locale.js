...
"actions":function(d){return "Акции"},
"add":function(d){return "Додади"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"mk",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"choosePrefix":function(d){return "Одбери..."},
"clearPuzzle":function(d){return "Започни"},
"clearPuzzleConfirm":function(d){return "Со ова ќе ја вратите сложувалката на почеток и ќе ги избришете сите коцки кои сте ги додале или сте ги промениле."},
...
"currentVersion":function(d){return "Тековна верзија"},
...
"dataTableNamePlaceholder":function(d){return "Име на табела"},
...
"debugWatchHeader":function(d){return "Види"},
"debugWatchNotAvailable":function(d){return "не е достапно"},
...
"dontForget":function(d){return "Не заборавај"},
...
"dropletBlock_comment_description":function(d){return "Напиши објаснување на некој код"},
...
"emptyBlockInVariable":function(d){return "Променливата "+common_locale.v(d,"name")+" нема пополнето влез."},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"mk",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"mk",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"hidden":function(d){return "Скриено"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "Крај"},
...
"joinText":function(d){return "спои"},
...
"less":function(d){return "Помалку"},
...
"locked":function(d){return "Заклучено"},
...
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"mk",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"mk",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"mk",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"projectTypeInfinity":function(d){return "Бесконечно"},
...
"reset":function(d){return "Од почеток ,Ресетирање"},
...
"startOver":function(d){return "Започни"},
"startOverTitle":function(d){return "Дали сте сигурни дека сакате да започнете?"},
...
"submit":function(d){return "Поднеси"},
...
"tryIt":function(d){return "Обидете се"},

...
"basketballLaunchBall":function(d){return "πέτα νέα μπάλα"},
"basketballLaunchBallTooltip":function(d){return "Ρίξε μια μπάλα στο παιχνίδι."},
"basketballSetPaddle":function(d){return "θέσε χέρι"},
"basketballSetPaddleSpeedFast":function(d){return "θέσε γρήγορη ταχύτητα χειρός"},
"basketballSetPaddleSpeedNormal":function(d){return "θέσε κανονική ταχύτητα χειρός"},
"basketballSetPaddleSpeedRandom":function(d){return "θέσε τυχαία ταχύτητα χειρός"},
"basketballSetPaddleSpeedSlow":function(d){return "θέσε αργή ταχύτητα χειρός"},
"basketballSetPaddleSpeedTooltip":function(d){return "Θέτει την ταχύτητα χειρός"},
"basketballSetPaddleSpeedVeryFast":function(d){return "θέσε πολύ γρήγορη ταχύτητα χειρός"},
"basketballSetPaddleSpeedVerySlow":function(d){return "θέσε πολύ αργή ταχύτητα χειρός"},
"basketballWhenBallMissesPaddle":function(d){return "όταν η μπάλα χάνει το χέρι"},
"basketballWhenPaddleCollided":function(d){return "όταν η μπάλα χτυπάει το χέρι"},
...
"playSoundCheer":function(d){return "παίξε ήχο επευφημισμού"},
...
"playSoundKick":function(d){return "αναπαραγωγή ήχου κλωτσιάς"},
...
"playSoundSlapshot":function(d){return "αναπαραγωγή ήχου slapshot"},
"playSoundSwish":function(d){return "παίξε ήχο θροΐσματος διχτυού"},
"playSoundTooltip":function(d){return "Παίξε τον επιλεγμένο ήχο."},
"playSoundWhistle":function(d){return "παίξε ήχο σφυρίγματος"},
...
"setBackground":function(d){return "θέσε "+bounce_locale.v(d,"background")+" σκηνή"},
...
"setBall":function(d){return "θέσε "+bounce_locale.v(d,"ball")+" μπάλα"},
...
"setPaddle":function(d){return "θέσε κουπί"},
...
"setPlayerSpeedFast":function(d){return "θέσει γρήγορη ταχύτητα παίκτη"},
"setPlayerSpeedNormal":function(d){return "θέσε κανονική ταχύτητα παίκτη"},
"setPlayerSpeedRandom":function(d){return "θέσε τυχαία ταχύτητα παίκτη"},
"setPlayerSpeedSlow":function(d){return "θέσε αργή ταχύτητα παίκτη"},
"setPlayerSpeedTooltip":function(d){return "Θέτει την ταχύτητα παίκτη"},
"setPlayerSpeedVeryFast":function(d){return "θέσε πολύ γρήγορη ταχύτητα παίκτη"},
"setPlayerSpeedVerySlow":function(d){return "θέσε τον παίκτη σε πολύ αργή ταχύτητα"},
"setTeamTooltip":function(d){return "Θέτει το λογότυπο και την χρωματική παλέτα"},
"setTeam":function(d){return "Θέσε ομάδα "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Θέσε τυχαία ομάδα"},
"shareBounceTwitter":function(d){return "Κοιτάξτε το παιχνίδι Αναπήδησης που έφτιαξα. Το έγραψα εγώ με το @codeorg"},
"shareBounceTwitterDonor":function(d){return "Δοκιμάστε το παιχνίδι Αναπήδησης που έκανα. (Ευχαριστώ "+bounce_locale.v(d,"donor")+" για την υποστήριξη της @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "όταν η μπάλα χάνει τον παίκτη"},
...
"whenPlayerCollided":function(d){return "όταν η μπάλα χτυπάει τον παίκτη"},
"whenPlayerCollidedTooltip":function(d){return "Εκτέλεσε τις ακόλουθες ενέργειες όταν η μπάλα συγκρούεται με τον παίκτη."},

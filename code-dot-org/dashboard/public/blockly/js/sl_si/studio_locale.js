...
"alien":function(d){return "marsovec"},
"alienInvasion":function(d){return "Nezemljani napadajo!"},
"allowActorsOutsidePlayspaceTooltip":function(d){return "Dovolite igralcem, da se premikajo izven igralne površine, kjer se jih ne vidi"},
...
"calloutSetDroidAndSpeed":function(d){return "Določi lastnosti robota in njegovo hitrost"},
"calloutFinishButton":function(d){return "Klikni tukaj, ko želiš deliti svojo igro z ostalimi"},
...
"caveboy":function(d){return "jamski deček"},
"cavegirl":function(d){return "jamska deklica"},
...
"dinosaur":function(d){return "dinozaver"},
...
"dropletBlock_goDown_description":function(d){return "Premakne droida dol."},
"dropletBlock_goLeft_description":function(d){return "Premakne droida na levo."},
"dropletBlock_moveRight_description":function(d){return "Premakne droida na desno."},
"dropletBlock_moveUp_description":function(d){return "Premakne droida gor."},
"dropletBlock_moveDown_description":function(d){return "Premakne droida dol."},
"dropletBlock_moveLeft_description":function(d){return "Premakne droida na levo."},
...
"dropletBlock_playSound_param0_description":function(d){return "Ime zvoka za predvajanje."},
...
"ifSprite":function(d){return "igralec"},
...
"moveDistancePixels":function(d){return "pikslov"},
...
"remove":function(d){return "odstrani"},
...
"setScore":function(d){return "nastavi rezultat na"},
...
"setSpriteDinosaur":function(d){return "k sliki dinozavra"},
...
"wait":function(d){return "počakaj"},
...
"whenSpriteN":function(d){return "ko igralec "+studio_locale.v(d,"spriteIndex")},
...
"wizard":function(d){return "čarovnik"},

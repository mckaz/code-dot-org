...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"mt",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"completed":function(d){return "Lesta"},
...
"copyright":function(d){return "Drittijiet tal-Awtur"},
"correct":function(d){return "Korrett"},
"correctAnswer":function(d){return "Dik hi t-tweġiba t-tajba."},
"country":function(d){return "Country"},
"course":function(d){return "Kors"},
...
"courses":function(d){return "Korsijiet"},
...
"coursesHeadingStudent":function(d){return "Tgħallem fil-Code Studio"},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"mt",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"mt",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"gender":function(d){return "Sess"},
"genderMale":function(d){return "Maskili"},
"genderFemale":function(d){return "Femminili"},
...
"getHelp":function(d){return "Ikseb l-Għajnuna"},
"goBack":function(d){return "Go Back"},
"goToUnit":function(d){return "Go to Unit"},
"grade":function(d){return "Grad"},
...
"incorrectAnswer":function(d){return "It-tweġiba żbaljata"},
"incorrectAnswerBody":function(d){return "The answer you've entered is not correct.  Please try again!"},
"incorrectSolution":function(d){return "Soluzzjoni mhux korretta"},
...
"joinSectionPlaceholder":function(d){return "Sezzjoni kodiċi (ABCDEF)"},
"joinCommunity":function(d){return "Join community"},
"joinText":function(d){return "għaqqad"},
...
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"mt",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"mt",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"myProjects":function(d){return "Il-Proġetti Tiegħi"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"mt",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"printCertificate":function(d){return "Stampa ic-certifikat"},
"printCertificates":function(d){return "Print certificates"},
"printLoginCards":function(d){return "Print Login Cards"},
"privacyPolicy":function(d){return "Poliza dwar il-Privatezza"},
...
"projects":function(d){return "Il-Proġetti"},
...
"rename":function(d){return "Ibdel l-isem"},
"repeat":function(d){return "Irrepeti"},
"replayButton":function(d){return "Replay"},
"reportAbuse":function(d){return "Irrapporta l-Abbuż"},
...
"section":function(d){return "It-Taqsima"},
"sectionCode":function(d){return "Kodici tas-Sezzjoni"},
...
"unpluggedActivity":function(d){return "Attivita bla kompjuter"},
...
"viewLessonPlan":function(d){return "Ara l-Pjan tal-Lezzjoni"},

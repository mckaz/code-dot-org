...
"collect":function(d){return "begyűjtés"},
"collectiblePresent":function(d){return "van itt némi kincs"},
"collectorCollectTooltip":function(d){return "Egy elem begyűjtése"},
"collectorCollectedEverything":function(d){return "Gratulálunk! Begyűjtötted mind a(z) "+maze_locale.v(d,"count")+" elemet!"},
"collectorCollectedNothing":function(d){return "Kódolj tovább! Gyűjts össze annyi elemet, amennyit csak tudsz, szükség lesz rá."},
"collectorCollectedSome":function(d){return "Szép munka! "+maze_locale.v(d,"count")+" elemet sikerült összegyűjtened!"},
"collectorCollectedNotEnough":function(d){return "Folytasd a programot! Be kell gyűjtened legalább "+maze_locale.p(d,"goal",0,"hu",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
"collectorCollectedTooMany":function(d){return "Itt nem tudok eleget gyűjteni."},
"collectorTooManyBlocks":function(d){return "Csak "+maze_locale.v(d,"blockLimit")+" blokkot használhatsz. Vess egy pillantást a kódodra és próbáld meg újra!"},
"continue":function(d){return "Tovább"},
"corn":function(d){return "kukorica"},
"cornTooltip":function(d){return "Arasd le a kukoricát"},
"didNotCollectAllCrops":function(d){return "Győződj meg róla hogy sem nektár, sem méz nem maradt hátra!"},
"didNotCollectEverything":function(d){return "Győződj meg róla hogy sem nektár, sem méz nem maradt hátra!"},
"didNotPlantEverywhere":function(d){return "Ültess minden lehetséges helyre egy palántát!"},
...
"emptyCropError":function(d){return "Minden begyűjtve."},
...
"has":function(d){return "tartalmaz"},
"haslettuce":function(d){return "van saláta"},
"hascorn":function(d){return "van kukorica"},
"haspumpkin":function(d){return "vannak tökök"},
...
"lettuce":function(d){return "saláta"},
"lettuceTooltip":function(d){return "Takarítsd be a salátát"},
...
"pick":function(d){return "felszed"},
"pilePresent":function(d){return "van egy halom"},
"plant":function(d){return "elvet"},
"plantInNonSoilError":function(d){return "Csak friss földbe tudok ültetni."},
"plantTooltip":function(d){return "Ültess egy palántát"},
"pumpkin":function(d){return "tök"},
"pumpkinTooltip":function(d){return "Gyűjtsd be a sütőtököt"},
...
"soil":function(d){return "föld"},
"sprout":function(d){return "palánta"},
...
"wrongCropError":function(d){return "Nem tudom innen a termést betakarítani."},

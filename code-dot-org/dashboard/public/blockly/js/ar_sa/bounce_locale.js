...
"basketballLaunchBall":function(d){return "ارمِ كرة جديدة"},
"basketballLaunchBallTooltip":function(d){return "ارمِ الكرة لبدء اللعب."},
"basketballSetPaddle":function(d){return "استعد"},
"basketballSetPaddleSpeedFast":function(d){return "تعيين سرعة رمي عالية"},
"basketballSetPaddleSpeedNormal":function(d){return "تعيين سرعة رمي عادية"},
"basketballSetPaddleSpeedRandom":function(d){return "تعيين سرعة رمي عشوائية"},
"basketballSetPaddleSpeedSlow":function(d){return "تعيين سرعة رمي بطيئة"},
"basketballSetPaddleSpeedTooltip":function(d){return "يقوم بتعيين سرعة الرمية"},
"basketballSetPaddleSpeedVeryFast":function(d){return "تعيين سرعة رمي عالية جداً"},
"basketballSetPaddleSpeedVerySlow":function(d){return "تعيين سرعة رمي بطيئة جداً"},
"basketballWhenBallMissesPaddle":function(d){return "عندما لاتضرب الكرة اليد"},
"basketballWhenPaddleCollided":function(d){return "عندما تضرب الكرة اليد"},
...
"playSoundCheer":function(d){return "شغل صوت الهتاف"},
...
"playSoundKick":function(d){return "شغل صوت الركل"},
...
"playSoundSlapshot":function(d){return "شغل صوت طلق النار"},
"playSoundSwish":function(d){return "شغل صوت الحفيف"},
"playSoundTooltip":function(d){return "تشغيل الصوت المختار."},
"playSoundWhistle":function(d){return "شغل صوت الصفارة"},
...
"setBackground":function(d){return "اضبط المشهد "+bounce_locale.v(d,"background")},
...
"setBall":function(d){return "اضبط "+bounce_locale.v(d,"ball")+" الكرة"},
...
"setPaddle":function(d){return "اضبط المجداف"},
...
"setPlayerSpeedFast":function(d){return "اضبط سرعة اللاعب"},
"setPlayerSpeedNormal":function(d){return "لضبط سرعة اللاعب على سرعة عادية"},
"setPlayerSpeedRandom":function(d){return "لضبط سرعة اللاعب بشكل عشوائي"},
"setPlayerSpeedSlow":function(d){return "لضبط سرعة اللاعب على سرعة بطيئة"},
"setPlayerSpeedTooltip":function(d){return "لضبط سرعة اللاعب"},
"setPlayerSpeedVeryFast":function(d){return "لضبط سرعة اللاعب على السرعة القصوى"},
"setPlayerSpeedVerySlow":function(d){return "لضبط سرعة اللاعب على سرعة ضعيفة جدا"},
"setTeamTooltip":function(d){return "لتغيير الالوان والشعار"},
"setTeam":function(d){return "لتحديد فريق"+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "لاختيار فريق عشوائي"},
"shareBounceTwitter":function(d){return "هل تريد تجربة لعبة الارتداد التي قمت بتصميمها؟ لقد كتبتها بنفسي باستخدام @codeorg"},
"shareBounceTwitterDonor":function(d){return "تحقق من لعبة الكرة المرتدة التي صنعتها. (شكراً "+bounce_locale.v(d,"donor")+" لدعم @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "عندما لا تُصب الكرة أيَّ لاعب"},
...
"whenPlayerCollided":function(d){return "عندما تضرب الكرة اللاعب"},
"whenPlayerCollidedTooltip":function(d){return "قم بالامر اسفله عندما تصطدم الكرة باللاعب."},

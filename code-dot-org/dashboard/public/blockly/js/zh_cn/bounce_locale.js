...
"basketballLaunchBall":function(d){return "扔出新的球"},
"basketballLaunchBallTooltip":function(d){return "扔个球来开始"},
"basketballSetPaddle":function(d){return "设置手"},
"basketballSetPaddleSpeedFast":function(d){return "设置手速度为快速"},
"basketballSetPaddleSpeedNormal":function(d){return "设置手的速度为正常"},
"basketballSetPaddleSpeedRandom":function(d){return "设置手的速度为随机"},
"basketballSetPaddleSpeedSlow":function(d){return "设置瘦的速度为慢速"},
"basketballSetPaddleSpeedTooltip":function(d){return "设置手的速度"},
"basketballSetPaddleSpeedVeryFast":function(d){return "设置手的速度为非常快"},
"basketballSetPaddleSpeedVerySlow":function(d){return "设置手的速度为非常慢"},
"basketballWhenBallMissesPaddle":function(d){return "当球错过了手时"},
"basketballWhenPaddleCollided":function(d){return "当球击中手时"},
...
"playSoundCheer":function(d){return "播放欢呼音效"},
...
"playSoundSlapshot":function(d){return "播放曲棍球音效"},
"playSoundSwish":function(d){return "播放嗖嗖音效"},
"playSoundTooltip":function(d){return "播放所选声音"},
"playSoundWhistle":function(d){return "播放口哨音效"},
...
"setBackground":function(d){return "设置 "+bounce_locale.v(d,"background")+" 场景"},
...
"setBall":function(d){return "设置 "+bounce_locale.v(d,"ball")+" 球"},
...
"setPaddle":function(d){return "设置桨"},
...
"setPlayerSpeedFast":function(d){return "设置快速玩家速度"},
"setPlayerSpeedNormal":function(d){return "设置一般玩家速度"},
"setPlayerSpeedRandom":function(d){return "设置随机玩家的速度"},
"setPlayerSpeedSlow":function(d){return "设置慢速玩家速度"},
"setPlayerSpeedTooltip":function(d){return "设置玩家速度"},
"setPlayerSpeedVeryFast":function(d){return "设置极快玩家速度"},
"setPlayerSpeedVerySlow":function(d){return "设置极慢玩家速度"},
"setTeamTooltip":function(d){return "设置图标及配色方案"},
"setTeam":function(d){return "设置团队"+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "设置随机团队"},
"shareBounceTwitter":function(d){return "看看我自己写的弹球游戏。我用 @codeorg 做的。"},
"shareBounceTwitterDonor":function(d){return "试试我做的弹珠游戏。(感谢 "+bounce_locale.v(d,"donor")+" 支持@codeorg)"},
...
"whenBallMissesPlayer":function(d){return "当球错过玩家时"},
...
"whenPlayerCollided":function(d){return "当球击中玩家时"},
"whenPlayerCollidedTooltip":function(d){return "当球击中球员时，执行下列操作"},

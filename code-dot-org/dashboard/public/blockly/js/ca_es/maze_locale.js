...
"collect":function(d){return "agafa"},
"collectiblePresent":function(d){return "hi ha algun tresor"},
...
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"ca",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
...
"didNotCollectEverything":function(d){return "Assegura't de no deixar cap nèctar o mel enrere!"},
...
"pick":function(d){return "agafa"},
"pilePresent":function(d){return "hi ha un munt"},
"plant":function(d){return "plant"},
"plantInNonSoilError":function(d){return "Només puc plantar alguna cosa en sòl ric."},
"plantTooltip":function(d){return "Plantar un brot"},
"pumpkin":function(d){return "carbassa"},

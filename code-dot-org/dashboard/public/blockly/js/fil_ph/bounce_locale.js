...
"basketballLaunchBall":function(d){return "Bumato ng bagong bola"},
"basketballLaunchBallTooltip":function(d){return "Bumato ng bola sa laro."},
"basketballSetPaddle":function(d){return "ilagay ang kamay"},
"basketballSetPaddleSpeedFast":function(d){return "pabilisin ang bilis ng kamay"},
"basketballSetPaddleSpeedNormal":function(d){return "ilagay sa normal ang bilis ng kamay"},
"basketballSetPaddleSpeedRandom":function(d){return "ilagay sa anumang bilis ang kamay"},
"basketballSetPaddleSpeedSlow":function(d){return "ilagay sa mababa ang bilis ng kamay"},
"basketballSetPaddleSpeedTooltip":function(d){return "Ilagay ang bilis ng kamay"},
"basketballSetPaddleSpeedVeryFast":function(d){return "ilagay sa pinaka mabilis ang bilis ng kamay"},
"basketballSetPaddleSpeedVerySlow":function(d){return "ilagay sa pinakamababa ang bilis ng kamay"},
"basketballWhenBallMissesPaddle":function(d){return "kapag ang bola ay hindi tumama sa kamay"},
"basketballWhenPaddleCollided":function(d){return "kapag ang bola ay tumama sa kamay"},
...
"playSoundCheer":function(d){return "magpatugtog ng masayang tunog"},
...
"playSoundKick":function(d){return "magpatugtog ng pagsipa na tunog"},
...
"playSoundSlapshot":function(d){return "magpatugtog ng slapshot na tunog"},
"playSoundSwish":function(d){return "magpatugtog ng net swish na tunog"},
"playSoundTooltip":function(d){return "Magpatugtog ng napiling tunog."},
"playSoundWhistle":function(d){return "magpatugtog ng pito na tunog"},
...
"setBackground":function(d){return "itakda ang "+bounce_locale.v(d,"background")+" na tagpo"},
...
"setBall":function(d){return "itakda ang "+bounce_locale.v(d,"ball")+" na bola"},
...
"setPaddle":function(d){return "itakda ang sagwan"},
...
"setPlayerSpeedFast":function(d){return "itakda ang bilis ng mabilis na manlalaro"},
"setPlayerSpeedNormal":function(d){return "itakda ang normal na bilis ng manlalaro"},
"setPlayerSpeedRandom":function(d){return "itakda ang ng paiba-ibang bilis ng manlalaro"},
"setPlayerSpeedSlow":function(d){return "itakda ang mabagal na bilis ng manlalaro"},
"setPlayerSpeedTooltip":function(d){return "Nagtakda sa bilis ng manlalaro"},
"setPlayerSpeedVeryFast":function(d){return "itakda ang bilas ng manlalaro sa pinakamabilis"},
"setPlayerSpeedVerySlow":function(d){return "itakda ang bilis ng manlalaro sa pinakamabagal"},
"setTeamTooltip":function(d){return "Nagtatakda ng logo at kombinasyon ng kulay"},
"setTeam":function(d){return "Itakda ang koponan "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Itakda ang koponan na random"},
"shareBounceTwitter":function(d){return "Tingnan ang larong Bounce na ginawa ko. Ako mismo ang nagsulat nito sa @codeorg"},
"shareBounceTwitterDonor":function(d){return "Suriin ang Bounce na laro na nagawa ko. (Salamat sa "+bounce_locale.v(d,"donor")+" sa pagsuporta sa @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "kapag ang bula ay hindi tumama sa manlalaro"},
...
"whenPlayerCollided":function(d){return "kapag ang bola ay tumama sa manlalaro"},
"whenPlayerCollidedTooltip":function(d){return "Patakbuhin ang mga aksyon sa baba kapag ang bola ay tumama sa manlalaro."},

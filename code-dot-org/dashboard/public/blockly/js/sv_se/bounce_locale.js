...
"basketballLaunchBall":function(d){return "kasta en ny boll"},
"basketballLaunchBallTooltip":function(d){return "Kasta in en ny boll i spel."},
"basketballSetPaddle":function(d){return "välj hand"},
"basketballSetPaddleSpeedFast":function(d){return "ange snabb hastighet på paddeln"},
"basketballSetPaddleSpeedNormal":function(d){return "ange normal hastighet på paddeln"},
"basketballSetPaddleSpeedRandom":function(d){return "ange slumpmässig hastighet på paddeln"},
"basketballSetPaddleSpeedSlow":function(d){return "ange långsam hastighet på paddeln"},
"basketballSetPaddleSpeedTooltip":function(d){return "Anger hastigheten på paddeln"},
"basketballSetPaddleSpeedVeryFast":function(d){return "ange väldigt snabb hastighet på paddeln"},
"basketballSetPaddleSpeedVerySlow":function(d){return "ange väldigt långsam hastighet på paddeln"},
"basketballWhenBallMissesPaddle":function(d){return "när bollen missar paddel"},
"basketballWhenPaddleCollided":function(d){return "när bollen träffar paddel"},
...
"playSoundCheer":function(d){return "spela upp jubel"},
...
"playSoundKick":function(d){return "spela träffljud"},
...
"playSoundSlapshot":function(d){return "spela slapshot ljud"},
"playSoundSwish":function(d){return "spela upp swoosh"},
"playSoundTooltip":function(d){return "Spela upp det valda ljudet."},
"playSoundWhistle":function(d){return "spela upp visselljud"},
...
"setBackground":function(d){return "välj "+bounce_locale.v(d,"background")+"-scen"},
...
"setBall":function(d){return "välj "+bounce_locale.v(d,"ball")+"-boll"},
...
"setPaddle":function(d){return "bestäm paddel"},
...
"setPlayerSpeedFast":function(d){return "ange hög hastighet på spelaren"},
"setPlayerSpeedNormal":function(d){return "ange normal hastighet på spelaren"},
"setPlayerSpeedRandom":function(d){return "ange slumpad hastighet på spelaren"},
"setPlayerSpeedSlow":function(d){return "ange låg hastighet på spelaren"},
"setPlayerSpeedTooltip":function(d){return "Anger hastighet på spelaren"},
"setPlayerSpeedVeryFast":function(d){return "ange väldigt hög hastighet på spelaren"},
"setPlayerSpeedVerySlow":function(d){return "ange väldigt låg hastighet på spelaren"},
"setTeamTooltip":function(d){return "Bestämmer logo och färgschema"},
"setTeam":function(d){return "Välj lag "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Bestäm team slumpmässigt"},
...
"whenBallMissesPlayer":function(d){return "när bollen missar spelare"},
...
"whenPlayerCollided":function(d){return "när boll träffar spelare"},
"whenPlayerCollidedTooltip":function(d){return "Utför åtgärderna nedan när en boll träffar spelaren."},

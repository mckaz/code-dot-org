...
"basketballLaunchBall":function(d){return "жаңа допты лақтыру"},
"basketballLaunchBallTooltip":function(d){return "Допты ойынға қосу."},
"basketballSetPaddle":function(d){return "қолды орнату"},
"basketballSetPaddleSpeedFast":function(d){return "қолдың шапшаң жылдамдығын орнату"},
"basketballSetPaddleSpeedNormal":function(d){return "қолдың қалыпты жылдамдығын орнату"},
"basketballSetPaddleSpeedRandom":function(d){return "қолдың қездейсоқ жылдамдығын орнату"},
"basketballSetPaddleSpeedSlow":function(d){return "қолдың аз жылдамдығын орнату"},
"basketballSetPaddleSpeedTooltip":function(d){return "Қолдың жылдамдығын орнатады"},
"basketballSetPaddleSpeedVeryFast":function(d){return "қолдың өте шапшаң жылдамдығын орнату"},
"basketballSetPaddleSpeedVerySlow":function(d){return "қолдың өте аз жылдамдығын орнату"},
"basketballWhenBallMissesPaddle":function(d){return "доп қолды тигізбеген кезде"},
"basketballWhenPaddleCollided":function(d){return "доп қолды соқса"},
...
"playSoundCheer":function(d){return "қанат қағу әуенін ойнау"},
...
"playSoundKick":function(d){return "қанат қағу әуенін ойнау"},
...
"setBackground":function(d){return "сахнаны "+bounce_locale.v(d,"background")+" орнату"},
...
"setBall":function(d){return "допты "+bounce_locale.v(d,"ball")+" орнату"},
...
"setPaddle":function(d){return "Ескекті орнату"},
...
"setPlayerSpeedFast":function(d){return "ойыншының шапшаң жылдамдығын орнату"},
"setPlayerSpeedNormal":function(d){return "ойыншының қалыпты жылдамдығын орнату"},
"setPlayerSpeedRandom":function(d){return "ойыншының кездейсоқ жылдамдығын орнату"},
"setPlayerSpeedSlow":function(d){return "ойыншының аз жылдамдығын орнату"},
"setPlayerSpeedTooltip":function(d){return "Ойыншының жылдамдығын орнатады"},
"setPlayerSpeedVeryFast":function(d){return "ойыншының өте шапшаң жылдамдығын орнату"},
"setPlayerSpeedVerySlow":function(d){return "ойыншының өте аз жылдамдығын орнату"},
"setTeamTooltip":function(d){return "Лого мен түс схемасын орнатады"},
"setTeam":function(d){return "Топты "+bounce_locale.v(d,"team")+" орнатады"},
"setTeamRandom":function(d){return "Кездейсоқ топты орнату"},
...
"whenBallMissesPlayer":function(d){return "доп ойыншыны тигізбеген кезде"},
...
"whenPlayerCollided":function(d){return "доп ойыншыны соқса"},
"whenPlayerCollidedTooltip":function(d){return "Доп ойыншыға соқтыққан кезде келесі іс-әрекеттерді орындау."},

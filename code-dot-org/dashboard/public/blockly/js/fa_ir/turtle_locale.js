...
"jumpNortheastTooltip":function(d){return "هنرمند را به شمال شرقی انتقال می دهد بدون اینکه علامتی باقی بگذارد."},
"jumpNorthwestTooltip":function(d){return "هنرمند را به شمال غربی انتقال می دهد بدون اینکه علامتی باقی بگذارد."},
"jumpSouthTooltip":function(d){return "هنرمند را به جنوب ببر بدون این که اثری باقی بگذاری."},
"jumpSoutheastTooltip":function(d){return "هنرمند را به جنوب شرقی انتقال می دهد بدون اینکه علامتی باقی بگذارد."},
"jumpSouthwestTooltip":function(d){return "هنرمند را به جوب غربی انتقال می دهد بدون اینکه علامتی باقی بگذارد."},
...
"moveNortheastTooltip":function(d){return "هنرمند را به شمال شرقی انتقال می دهد."},
"moveNorthwestTooltip":function(d){return "هنرمند را به شمال غربی انتقال می دهد."},
"moveSouthTooltip":function(d){return "هنرمند را به جنوب ببر."},
"moveSoutheastTooltip":function(d){return "هنرمند را به جنوب شرقی انتقال می دهد."},
"moveSouthwestTooltip":function(d){return "هنرمند را به جنوب غربی انتقال می دهد."},

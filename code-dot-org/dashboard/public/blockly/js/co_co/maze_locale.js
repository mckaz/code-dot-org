...
"atFlower":function(d){return "à a fiore"},
"atHoneycomb":function(d){return "à u bugnu"},
"avoidCowAndRemove":function(d){return "avoid the cow and remove 1"},
"collect":function(d){return "culletà"},
"collectiblePresent":function(d){return "ci sò i tesori"},
"collectorCollectTooltip":function(d){return "Culletà un oghjettu"},
"collectorCollectedEverything":function(d){return "Felicitazioni! Hai raccolta "+maze_locale.p(d,"count",0,"en",{"one":"un oghjettu","other":"tutti i "+maze_locale.n(d,"count")+" oghetti"})+"!"},
...
"elseCode":function(d){return "osinnò"},
...
"fillSquare":function(d){return "empie u quadratu"},
...
"honey":function(d){return "fà u mele"},
"honeyAvailable":function(d){return "mele"},
"honeyTooltip":function(d){return "Fà u melle incù u nettaru"},
...
"moveBackward":function(d){return "rinculà"},
"moveEastTooltip":function(d){return "Move me east one space."},
"moveForward":function(d){return "avanzà"},
...
"nectar":function(d){return "ottene nettaru"},
"nectarRemaining":function(d){return "nettaru"},
"nectarTooltip":function(d){return "Ottene nettaru di un fiore"},
...
"turnLeft":function(d){return "girà à manca"},
"turnRight":function(d){return "girà à diritta"},

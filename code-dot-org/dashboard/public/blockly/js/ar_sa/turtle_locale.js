...
"jumpNortheastTooltip":function(d){return "نقل الفنان شمال شرق دون ترك أي علامات."},
"jumpNorthwestTooltip":function(d){return "نقل الفنان شمال غرب دون ترك أي علامات."},
"jumpSouthTooltip":function(d){return "تحريك الفنان تجاه الجنوب دون ترك أي علامات."},
"jumpSoutheastTooltip":function(d){return "تتحرك جنوب شرق الفنان دون ترك أي علامات."},
"jumpSouthwestTooltip":function(d){return "تتحرك جنوب غرب الفنان دون ترك أي علامات."},
...
"moveNortheastTooltip":function(d){return "نقل الفنان شمال شرق."},
"moveNorthwestTooltip":function(d){return "نقل الفنان شمال غرب."},
"moveSouthTooltip":function(d){return "تحريك الفنان تجاه الجنوب."},
"moveSoutheastTooltip":function(d){return "نقل الفنان جنوب شرق."},
"moveSouthwestTooltip":function(d){return "نقل الفنان جنوب غرب."},

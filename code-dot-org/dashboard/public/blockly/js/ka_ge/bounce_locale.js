...
"basketballLaunchBall":function(d){return "ახალი ბურთის სროლა"},
"basketballLaunchBallTooltip":function(d){return "თამაშში ბურთის ჩაგდება."},
"basketballSetPaddle":function(d){return "ხელის არჩევა"},
"basketballSetPaddleSpeedFast":function(d){return "ხელისთვის მაღალი სიჩქარის მინიჭება"},
"basketballSetPaddleSpeedNormal":function(d){return "ხელისთვის ნორმალური სიჩქარის მინიჭება"},
"basketballSetPaddleSpeedRandom":function(d){return "ხელისთვის შემთხვევითი სიჩქარის მინიჭება"},
"basketballSetPaddleSpeedSlow":function(d){return "ხელისთვის დაბალი სიჩქარის მინიჭება"},
"basketballSetPaddleSpeedTooltip":function(d){return "განსაზღვრავს ხელის სიჩქარეს"},
"basketballSetPaddleSpeedVeryFast":function(d){return "ხელისთვის ძალიან მაღალი სიჩქარის მინიჭება"},
"basketballSetPaddleSpeedVerySlow":function(d){return "ხელისთვის ძალიან დაბალი სიჩქარის მინიჭება"},
"basketballWhenBallMissesPaddle":function(d){return "როცა ბურთი ცდება ხელს"},
"basketballWhenPaddleCollided":function(d){return "როცა ბურთი ხვდება ხელს"},
...
"playSoundCheer":function(d){return "ტაშის ხმის ჩართვა"},
...
"playSoundKick":function(d){return "დარტყმის ხმის დაკვრა"},
...
"playSoundSlapshot":function(d){return "შემოტყაპუნების ხმის დაკვრა"},
"playSoundSwish":function(d){return "ბადის გაბმის ხმის ჩართვა"},
"playSoundTooltip":function(d){return "შერჩეული ხმის დაკვრა."},
"playSoundWhistle":function(d){return "სტვენის ხმის ჩართვა"},
...
"setBackground":function(d){return bounce_locale.v(d,"background")+" დაყენება"},
...
"setBall":function(d){return bounce_locale.v(d,"ball")+" ბურთის არჩევა"},
...
"setPaddle":function(d){return "პლატფორმის გაშვება"},
...
"setPlayerSpeedFast":function(d){return "მოთამაშისთვის მაღალი სიჩქარის მინიჭება"},
"setPlayerSpeedNormal":function(d){return "მოთამაშისთვის ნორმალური სიჩქარის მინიჭება"},
"setPlayerSpeedRandom":function(d){return "მოთამაშისთვის შემთხვევითი სიჩქარის მინიჭება"},
"setPlayerSpeedSlow":function(d){return "მოთამაშისთვის დაბალი სიჩქარის მინიჭება"},
"setPlayerSpeedTooltip":function(d){return "განსაზღვრავს მოთამაშის სიჩქარეს"},
"setPlayerSpeedVeryFast":function(d){return "მოთამაშისთვის ძალიან მაღალი სიჩქარის მინიჭება"},
"setPlayerSpeedVerySlow":function(d){return "მოთამაშისთვის ძალიან დაბალი სიჩქარის მინიჭება"},
"setTeamTooltip":function(d){return "აყენებს ლოგოსა და ფერების სქემას"},
"setTeam":function(d){return bounce_locale.v(d,"team")+" გუნდის არჩევა"},
"setTeamRandom":function(d){return "შემთხვევითი გუნდის არჩევა"},
"shareBounceTwitter":function(d){return "ნახეთ ჩემი გაკეთებული Bounce თამაში. მე თვითონ დავწერე @codeorg-ზე"},
"shareBounceTwitterDonor":function(d){return "ითამაშეთ ჩემ მიერ შექმნილი Bounce თამაში. (მადლობა "+bounce_locale.v(d,"donor")+"-ს @codeorg-ის მხარდაჭერისთვის)"},
...
"whenBallMissesPlayer":function(d){return "როცა ბურთი ცდება მოთამაშეს"},
...
"whenPlayerCollided":function(d){return "როცა ბურთი ხვდება მოთამაშეს"},
"whenPlayerCollidedTooltip":function(d){return "შესრულდეს ქვემოთ მოცემული მოქმედებები, როცა ბურთი ეჯახება მოთამაშეს."},

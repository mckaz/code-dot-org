...
"catMath":function(d){return "Mathematics"},
...
"createACircle":function(d){return "crea un circulo"},
...
"drawACircle":function(d){return "dibujar un circulo"},
"drawAFlower":function(d){return "dibujar una flor"},
"drawAHexagon":function(d){return "dibuja un hexágono"},
"drawAHouse":function(d){return "dibuja una casa"},
"drawAPlanet":function(d){return "dibuja un planeta"},
"drawARhombus":function(d){return "dibuja un rombo"},
"drawARobot":function(d){return "dibuja un robot"},
"drawARocket":function(d){return "draw a rocket"},
"drawASnowflake":function(d){return "draw a snowflake"},
"drawASnowman":function(d){return "dibuja un mono de nieve"},
"drawASquare":function(d){return "dibuja un cuadrado"},
"drawAStar":function(d){return "dibuja una estrella"},
"drawATree":function(d){return "dibuja un árbol"},
"drawATriangle":function(d){return "dibuja un triangulo"},
"drawUpperWave":function(d){return "draw upper wave"},
"drawLowerWave":function(d){return "draw lower wave"},
"drawSticker":function(d){return "dibuja una estampa"},
...
"jumpTooltip":function(d){return "Mueve al artista sin dejar ninguna marca."},

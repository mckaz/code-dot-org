...
"collect":function(d){return "sbírat"},
"collectiblePresent":function(d){return "je tu poklad"},
"collectorCollectTooltip":function(d){return "Sebrat položku"},
"collectorCollectedEverything":function(d){return "Blahopřejeme! Sesbíral jsi všech "+maze_locale.v(d,"count")+" předmětů!"},
"collectorCollectedNothing":function(d){return "Pokračuj! Musíš sesbírat tolik předmětů, kolik dokážeš."},
"collectorCollectedSome":function(d){return "Skvělá práce! Sesbíral jsi "+maze_locale.v(d,"count")+" předmětů!"},
"collectorCollectedNotEnough":function(d){return "Pokračuj v kódování! Potřebuješ posbírat alespoň "+maze_locale.p(d,"goal",0,"cs",{"one":"1 položku","other":maze_locale.n(d,"goal")+" položek"})+"."},
"collectorCollectedTooMany":function(d){return "Tento prostor nemá pro mě dostatek položek ke sbírání."},
"collectorTooManyBlocks":function(d){return "Můžeš použít pouze "+maze_locale.v(d,"blockLimit")+" bloků. Tak se podívej na tvůj kód a zkus to znovu!"},
"continue":function(d){return "Pokračovat"},
"corn":function(d){return "zrno"},
"cornTooltip":function(d){return "Sklízet zrno"},
"didNotCollectAllCrops":function(d){return "Ujistěte se, že jste nezanechali žádné plodiny!"},
"didNotCollectEverything":function(d){return "Ujistěte se, zda že jste za sebou nenechali nektar nebo med!"},
"didNotPlantEverywhere":function(d){return "Ujistěte se, že pěstujete něco na každém políčku s půdou!"},
...
"emptyCropError":function(d){return "Tato plodina došla."},
...
"haslettuce":function(d){return "tam je salát"},
"hascorn":function(d){return "tam je zrno"},
"haspumpkin":function(d){return "tam jsou dýně"},
...
"lettuce":function(d){return "salát"},
"lettuceTooltip":function(d){return "Sklízet salát"},
...
"pick":function(d){return "vyber"},
"pilePresent":function(d){return "tady je hromádka"},
"plant":function(d){return "rostlina"},
"plantInNonSoilError":function(d){return "Můžu něco zasadit jen do čersté půdy."},
"plantTooltip":function(d){return "Zasadit klíček"},
"pumpkin":function(d){return "dýně"},
"pumpkinTooltip":function(d){return "Sklízet dýně"},
...
"wrongCropError":function(d){return "Nemůžu zde sklidit tuto plodinu."},

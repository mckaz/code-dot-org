...
"collectiblePresent":function(d){return "มีสมบัติเหลืออยู่"},
...
"collectorCollectedSome":function(d){return "เยี่ยมมาก! คุณได้เก็บสิ่งของ "+maze_locale.v(d,"count")+" ชิ้นแล้ว!"},
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"th",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
"collectorCollectedTooMany":function(d){return "That space doesn't have enough items for me to collect."},
"collectorTooManyBlocks":function(d){return "คุณสามารถใช้ได้แค่ "+maze_locale.v(d,"blockLimit")+" บล็อกเท่านั้น ตรวจเช็คโค้ดของคุณแล้วลองอีกครั้ง!"},
...
"didNotCollectEverything":function(d){return "แน่ใจว่าคุณไม่ทิ้งให้น้ำหวานหรือน้ำผึ้งหลังใด ๆ หลงเหลืออยู่ภายหลัง"},
...
"pumpkin":function(d){return "ฟักทอง"},

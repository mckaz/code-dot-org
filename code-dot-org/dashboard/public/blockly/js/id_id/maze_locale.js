...
"collect":function(d){return "kumpulkan"},
"collectiblePresent":function(d){return "ada beberapa harta karun"},
"collectorCollectTooltip":function(d){return "Kumpulkan satu item"},
"collectorCollectedEverything":function(d){return "Selamat! Anda mengumpulkan "+maze_locale.p(d,"count",0,"id",{"other":"semua "+maze_locale.n(d,"count")+" item"})+"!"},
"collectorCollectedNothing":function(d){return "Teruslah meng-coding! Anda harus mengumpulkan banyak item sebisa anda."},
"collectorCollectedSome":function(d){return "Kerja bagus! Anda mengumpulkan "+maze_locale.p(d,"count",0,"id",{"one":"1 item","other":maze_locale.n(d,"count")+" item"})+"!"},
"collectorCollectedNotEnough":function(d){return "Teruslah meng-coding! Anda harus mengumpulkan setidaknya "+maze_locale.p(d,"goal",0,"id",{"other":maze_locale.n(d,"goal")+" item"})+"."},
"collectorCollectedTooMany":function(d){return "Ruang itu tidak memiliki cukup item untuk saya kumpulkan."},
"collectorTooManyBlocks":function(d){return "Anda hanya dapat menggunakan "+maze_locale.v(d,"blockLimit")+" blok. Lihatlah kode anda dan coba lagi!"},
"continue":function(d){return "lanjutkan"},
"corn":function(d){return "jagung"},
"cornTooltip":function(d){return "Panen beberapa jagung"},
"didNotCollectAllCrops":function(d){return "Pastikan Anda tidak meninggalkan hasil panen apapun!"},
"didNotCollectEverything":function(d){return "Pastikan Anda tidak meninggalkan nektar atau madu di belakang!"},
"didNotPlantEverywhere":function(d){return "Pastikan Anda menanam sesuatu di setiap patch!"},
...
"emptyCropError":function(d){return "Semua tanaman mati."},
...
"goal":function(d){return "target"},
"has":function(d){return "telah"},
"haslettuce":function(d){return "ada selada"},
"hascorn":function(d){return "ada jagung"},
"haspumpkin":function(d){return "ada labu"},
...
"ifOnlyFlowerTooltip":function(d){return "Jika ada bunga pada arah yang ditentukan, lakukan sesuatu."},
...
"insufficientHoney":function(d){return "Anda perlu membuat jumlah madu yang tepat."},
"insufficientNectar":function(d){return "Anda perlu mengumpulkan jumlah nektar yang tepat."},
"lettuce":function(d){return "selada"},
"lettuceTooltip":function(d){return "Panen beberapa selada"},
...
"pick":function(d){return "ambil"},
"pilePresent":function(d){return "ada tumpukan"},
"plant":function(d){return "tanam"},
"plantInNonSoilError":function(d){return "Saya hanya dapat menanam sesuatu di tanah."},
"plantTooltip":function(d){return "Tanamlah sebuah tunas"},
"pumpkin":function(d){return "labu"},
"pumpkinTooltip":function(d){return "Panenlah sebuah labu"},
...
"soil":function(d){return "tanah"},
"sprout":function(d){return "tunas"},
...
"wrongCropError":function(d){return "Saya tidak dapat memanen tanaman itu dari sini."},

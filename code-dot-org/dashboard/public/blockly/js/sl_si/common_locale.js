...
"actions":function(d){return "Dejanja"},
...
"addStudentsMultiple":function(d){return "Dodaj več učencev"},
...
"all":function(d){return "Vse"},
"allHandouts":function(d){return "All handouts"},
"allStudents":function(d){return "Vse"},
"allowEditing":function(d){return "Dovoli urejanje"},
"allowEditingInstructions":function(d){return "\"Dovoli urejanje\" medtem, ko bi morali študentje biti ocenjeni."},
"and":function(d){return "in"},
"animationMode":function(d){return "Animacija"},
"announcements":function(d){return "Obvestila"},
...
"answersVisible":function(d){return "Vidni odgovori (le za branje)"},
"archiveSection":function(d){return "Archive Section"},
"applabMarketingButton":function(d){return "Več o tem"},
...
"applabTutorialButton":function(d){return "Začni"},
...
"assessmentSteps":function(d){return "Koraki za ocenjevanje"},
"assessmentSettings":function(d){return "Nastavitve ocenjevanja"},
...
"autoGenerated":function(d){return "Samodejno ustvarjeno"},
"autolock":function(d){return "Opomba: Stopnja se po 24 urah samodejno zaklene."},
...
"censusInvalidEmail":function(d){return "Vnesite veljaven e-poštni naslov"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"sl",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"choosePrefix":function(d){return "Izberite..."},
...
"completed":function(d){return "Zaključeno"},
...
"congratsCertificatePersonalize":function(d){return "Prilagodite vaš certifikat"},
"congratsCertificateShare":function(d){return "Deli svoj dosežek"},
"congratsCertificateThanks":function(d){return "Hvala!"},
...
"contractMatchBadName":function(d){return "Vaša pogodba ima napačno ime."},
"contractMatchBadNameCase":function(d){return "Imena funkcij so občutljiva na velike začetnice. Poskusite spremeniti začetnico imena vaše pogodbe."},
"contractMatchBadRange":function(d){return "Vaša pogodba ima napačno ime."},
"controlProjectSharing":function(d){return "Control project sharing"},
"copy":function(d){return "Kopiraj"},
"copyright":function(d){return "Avtorska pravice"},
"correct":function(d){return "Pravilno"},
"correctAnswer":function(d){return "To je pravilen odgovor."},
...
"courseBlocksGradeBandsContainerDescription":function(d){return "Prebrskaj naš katalog tečajev iz Code.org in drugih partnerjev."},
"courseBlocksGradeBandsContainerHeading":function(d){return "Celoten katalog tečajev"},
"courseBlocksGradeBandsElementary":function(d){return "Od 1. do 5. razreda"},
...
"courseBlocksGradeBandsHigh":function(d){return "Srednja šola"},
...
"courseBlocksGradeBandsMiddle":function(d){return "Od 6. do 9. razreda"},
...
"courseBlocksToolsAppLabDescription":function(d){return "App Lab je okolje za programiranje, kjer lahko narediš enostavne aplikacije. Oblikuješ izgled aplikacije, kodiraš z bloki ali JavaScriptom. Ko aplikacijo dokončaš jo lahko deliš z ostalimi v nekaj sekundah."},
...
"courseCatalogButton":function(d){return "Poglej katalog tečajev"},
"courseCatalogDescription":function(d){return "Code.org ponuja tečaje za osnovne in srednje šole brez stroškov za šolo. In, če potrebujete pomoč, kako začeti, vam ponujamo tudi online strokovno učenje brez stroškov."},
"courseCatalogTitle":function(d){return "Katalog tečajev"},
...
"courses":function(d){return "Predavanja"},
...
"coursesHeadingTeacher":function(d){return "Poučuj s studio Code"},
...
"createAccount":function(d){return "Ustvari račun"},
...
"createSectionsInfo":function(d){return "Ustvarite nove razdelke in jim dodajte učence. Razdelki razdelijo učence v manjše skupine, tako da lahko sledite njihovemu napredku in upravljate z njihovimi računi."},
...
"currentVersion":function(d){return "Trenutna različica"},
"curriculum":function(d){return "kurikulum"},
"dataLimitAlert":function(d){return "Aplikacija je brala ali pisala v zbirko podatkov preveč pogosto, kar lahko povzroči nepričakovane napake. Prosimo, obvestite lastnika aplikacije, če se napake ponavljajo."},
...
"dataTableNamePlaceholder":function(d){return "Ime tabele"},
"dataWorkspaceHeader":function(d){return "Brskalnik podatkov"},
...
"debugWatchHeader":function(d){return "Ogled"},
"debugWatchNotAvailable":function(d){return "Ni na voljo"},
...
"deleteConfirm":function(d){return "Izbriši?"},
...
"disabledButtonsInfo":function(d){return "Napredek in koda se ne bodo shranjevali od 3. do 11. decembra, zaradi povečanega prometa med Uro za kodo."},
"disabledButtonsWarning":function(d){return "Opozorilo:"},
"disabledButtonsWhy":function(d){return "Zakaj so moji mehurčki sivi?"},
"disabledProgress1":function(d){return "Vsakršen napredek, ki bo narejen v tečaju ne bo shranjen med 3. in 11. decembrom, zaradi veliko prometa, ki ga naša spletna stran prejme med časom Ure za kodo."},
"disabledProgress2":function(d){return "Zato so tvoji oblački prikazani sivo(ne skrbi, tvoj napredek izpred tega tedna je varen)."},
"disabledProgress3":function(d){return "Priporočamo, da ta teden raje poskusite Uro za kodo."},
...
"done":function(d){return "Končano"},
"dontForget":function(d){return "Ne pozabite"},
...
"dropletBlock_comment_description":function(d){return "Napišite opis kode"},
...
"dropletBlock_greaterThanOrEqualOperator_description":function(d){return "Preizkusi, če je vrednost večja ali enaka drugi vrednosti. Potrdi s \"true\", če je vrednost na levi strani izraza večja ali enaka vrednosti na desni strani izraza."},
"dropletBlock_greaterThanOrEqualOperator_signatureOverride":function(d){return "Večje ali je enako"},
...
"dropletBlock_lessThanOrEqualOperator_description":function(d){return "Preizkusi, če je vrednost manjša ali je enaka drugi vrednosti. Potrdi s \"true\", če je vrednost na levi strani izraza manjša ali enaka vrednosti na desni strani izraza."},
"dropletBlock_lessThanOrEqualOperator_signatureOverride":function(d){return "Manjše ali je enako"},
...
"dropletBlock_randomNumber_description":function(d){return "Vrne naključno številko, izbrano med najmanjšo in največjo vrednostjo."},
...
"editable":function(d){return "Mogoče urejanje"},
...
"errorGenericLintError":function(d){return "Vaš program vsebuje opozorilo urejevalnika, ki mora biti odpravljeno. Z miško pojdite čez ikone v bližini številčno označenih vrstic, če želite izvedeti več."},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"sl",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"sl",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"genderMale":function(d){return "Moški"},
"genderFemale":function(d){return "Ženska"},
...
"getHelp":function(d){return "Pomoč"},
...
"hidden":function(d){return "skrito"},
...
"hintPromptInline":function(d){return "Želite namig?"},
"hintRequest":function(d){return "Poglej namig"},
"hintReviewTitle":function(d){return "Preglejte vaše namige"},
"hintSelectInstructions":function(d){return "Navodila in stari namigi"},
"hintSelectNewHint":function(d){return "Pridobi nov namig"},
"hintTitle":function(d){return "Namig:"},
"homepageHeading":function(d){return "Moja nadzorna plošča"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "Končaj"},
"homepageUiTipsAfterDialogConfirm":function(d){return "Več o tem"},
"iconSearchPlaceholder":function(d){return "Poiščite ikono..."},
...
"incorrectAnswer":function(d){return "Nepravilen odgovor"},
"incorrectAnswerBody":function(d){return "Odgovor, ki ste ga vnesli, ni pravilen.  Prosimo, poskusite znova!"},
"incorrectSolution":function(d){return "Nepravilna rešitev"},
"incorrectSolutionBody":function(d){return "Rešitev, ki si jo vnesel, ni pravilna.  Prosim, poskusi znova!"},
...
"instructions":function(d){return "Navodila"},
...
"joinSectionPlaceholder":function(d){return "Koda razdelka (ABCDEF)"},
"joinCommunity":function(d){return "Join community"},
"joinText":function(d){return "združi"},
"joinTextTooltip":function(d){return "Ustvari del besedila z združevanjem nekega več elementov."},
"joinUs":function(d){return "Pridruži se nam"},
"jump":function(d){return "skoči"},
"justDidHourOfCode":function(d){return "Pravkar sem končal #UraZaKodo! @codeorg"},
...
"keyValuePairLink":function(d){return "Ključ/vrednost parov"},
"lastEdited":function(d){return "Last Edited"},
"learnMore":function(d){return "Več o tem"},
"leaveSection":function(d){return "Leave section"},
"less":function(d){return "Pokaži manj"},
...
"lessonPlans":function(d){return "Učni načrti"},
...
"loading":function(d){return "Nalaganje..."},
"locked":function(d){return "Zaklenjeno"},
"lockFollowing":function(d){return "Zakleni naslednje stopnje, ki so trenutno odklenjena:"},
"lockAssessment":function(d){return "Zakleni nalogo"},
...
"lockStage":function(d){return "Zakleni stopnje"},
"lockStageInstructions":function(d){return "Ko se čas izteče, \"zakleni stopnje\", da skrijete vprašanja."},
"lockWhenDone":function(d){return "Zakleni takoj, ko so študentje končali"},
"loginInfo":function(d){return "Login Info"},
"loginType":function(d){return "Vrsta prijave"},
...
"manageStudents":function(d){return "Upravljaj z učenci"},
"manageStudentsNotificationFailure":function(d){return "Something went wrong."},
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"sl",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"sl",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"minecraftMarketingButton":function(d){return "Začni"},
...
"newPassword":function(d){return "Novo geslo"},
"newSection":function(d){return "Novo poglavje"},
...
"noIconsFound":function(d){return "Ni najdenih ikon"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"sl",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"ok":function(d){return "Vredu"},
"okay":function(d){return "V redu"},
"online":function(d){return "Online"},
"openWorkspace":function(d){return "Kako deluje"},
"or":function(d){return "ali"},
...
"other":function(d){return "Drugi"},
"pairingNavigatorWarning":function(d){return "Ta uganka je bila končana med seznanjanjem z "+common_locale.v(d,"driver")+". Za rešitev te uganke, ki ste jo ustvarili kot skupina, poglejte na njihovih računih."},
"pairingNavigatorLink":function(d){return "Click here to view the solution you created as a team."},
"pairProgramming":function(d){return "Programiranje parov"},
"parent":function(d){return "Starš"},
"parents":function(d){return "Parents"},
"parentsAndStudents":function(d){return "Parents and Students"},
"password":function(d){return "Geslo"},
...
"playzoneArtistDescription":function(d){return "Nariši kul slike in oblike z Umetnikom!"},
...
"predictionInstructions":function(d){return "Napovej rezultat preden zaženeš program."},
"printCertificate":function(d){return "Natisni certifikat"},
"printCertificates":function(d){return "Print certificates"},
"printLoginCards":function(d){return "Print Login Cards"},
"privacyPolicy":function(d){return "Izjava o zasebnosti"},
...
"progress":function(d){return "Napredek"},
...
"projectGroupPreReader":function(d){return "Pred-bralci"},
...
"projectTypeArtist":function(d){return "Umetnik"},
...
"projectTypeEvents":function(d){return "Dogodki"},
"projectTypeFrozen":function(d){return "Zmrznjenka (Frozen)"},
"projectTypeK1":function(d){return "Pred-bralci"},
"projectTypeMinecraft":function(d){return "Minecraft"},
"projectTypeMinecraftAdventurer":function(d){return "Minecraft Pustolovec"},
"projectTypeMinecraftDesigner":function(d){return "Minecraft Oblikovalec"},
...
"projectTypeBounce":function(d){return "Skokica"},
"projectTypeInfinity":function(d){return "Neskončnost"},
"projectTypeIceage":function(d){return "Ledena doba"},
"projectTypeGumball":function(d){return "Gumballov fantastični svet"},
...
"projectWarning":function(d){return "Opomba: Ste na stopnji, ki je del daljšega projekta. Spremembe narejene na tej ravni bodo prikazane tudi na drugih stopnjah tega projekta."},
...
"question":function(d){return "Vprašanje"},
...
"recommendedBlockContextualHintTitle":function(d){return "Poskusite uporabiti kocko, kot je ta, da rešite uganko."},
"reloadPage":function(d){return "Reload Page"},
"relockStage":function(d){return "Ponovno zakleni stopnjo"},
"relockStageInstructions":function(d){return "\"Ponovno zakleni stopnjo\", da preprečite deljenje odgovorov med drugimi razredi/šolami."},
...
"reportAbuse":function(d){return "Prijavi zlorabo"},
"reset":function(d){return "resetiraj"},
"resetProgram":function(d){return "resetiraj"},
"resetPassword":function(d){return "Ponastavi geslo"},
"resources":function(d){return "Resources"},
"restoreThisVersion":function(d){return "Obnovi to različico"},
...
"reviewResponses":function(d){return "Pojdite na zavihek ocenjevanje/raziskava za vaš oddelek, da si ogledate odgovore študentov."},
"rotateText":function(d){return "Zasukaj tvojo napravo."},
"runProgram":function(d){return "Zaženi"},
...
"save":function(d){return "Shrani"},
"saveAll":function(d){return "Shrani vse"},
"saveAndPublish":function(d){return "Save & Publish"},
"savedToGallery":function(d){return "Shranjeno v galerijo!"},
"saving":function(d){return "Shranjevanje..."},
...
"schoolTypeOrganization":function(d){return "Organizacija"},
"schoolTypeOther":function(d){return "Drugi"},
...
"section":function(d){return "Razdelek"},
"sectionCode":function(d){return "Koda razdelka"},
"sectionName":function(d){return "Ime razdelka"},
...
"secret":function(d){return "Skrivni ključ"},
...
"selectSection":function(d){return "Izberi odsek"},
"selectSectionInstructions":function(d){return "Izbrati moraš vprašalnike ali ocenjevalne naloge, ki jih želiš zakleniti ali odkleniti. Klikni zakleni nastavitve gumb na levi strani."},
...
"show":function(d){return "Pokaži"},
"showAnswers":function(d){return "Prikaži odgovore"},
"showAnswersInstructions":function(d){return "\"Prikaži odgovore\", da onemogočiš spreminjanje vaj, ki so namenjenje ocenjevanju."},
"showBlock":function(d){return "Vzami blok"},
...
"showSecret":function(d){return "Prikaži skrivnost"},
...
"stageLocked":function(d){return "Stopnja je zaklenjena."},
"stageNotFullyLocked":function(d){return "Stopnja ni zaklenjena za vse."},
...
"standardsAndFramework":function(d){return "Učni načrti in viri"},
"standardsAndFrameworkDescription":function(d){return "Information about standards alignment for Code.org courses."},
"startLearning":function(d){return "Začni z učenjem"},
"startOver":function(d){return "Začni znova"},
"startOverTitle":function(d){return "Si prepričan, da želiš začeti znova?"},
...
"student":function(d){return "Učenec"},
"students":function(d){return "Učenci"},
"studentAccountsAndProgress":function(d){return "Študentski računi in napredek"},
"studentControl":function(d){return "Nadzor posameznega učenca"},
"studentLockStateInstructions":function(d){return "Uporabi spodnjo tabelo, če želiš upravljati s stanjem vsakega učenca posebaj."},
"studentName":function(d){return "Ime učenca"},
...
"teacher":function(d){return "Učitelj/ica"},
...
"teacherCourseHoc":function(d){return "Ura kode"},
...
"teacherHomePage":function(d){return "Učiteljeva domača stran"},
"teacherPanel":function(d){return "Učiteljeva plošča"},
"teacherResources":function(d){return "Teacher resources"},
"text":function(d){return "Besedilo"},
"textVariable":function(d){return "besedilo"},
"thanksForYourResponse":function(d){return "Hvala za vaš odgovor!"},
"thankyou":function(d){return "Hvala"},
...
"tryIt":function(d){return "Preizkusite"},
...
"unattachedBlockTipTitle":function(d){return "Prosti bloki"},
"unattachedBlockTipBody":function(d){return "Prosti bloki ne počnejo nič. Če jih želiš v svojem programu, jih poveži z drugimi bloki."},
...
"unplugged":function(d){return "Brez prijave"},
"unpluggedActivity":function(d){return "Dejavnost brez prijave"},
...
"viewCourse":function(d){return "Ogled predmeta"},
...
"viewLessonPlan":function(d){return "Oglej si učni načrt"},
"viewMyProjects":function(d){return "View my projects"},
"viewMore":function(d){return "View more"},
"viewPageAs":function(d){return "Poglej stran kot:"},
"viewSection":function(d){return "Ogled odseka"},
"viewUnitOverview":function(d){return "View Unit Overview"},
"visible":function(d){return "Vidno"},

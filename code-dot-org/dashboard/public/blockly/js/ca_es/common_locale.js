...
"actions":function(d){return "Accions"},
"add":function(d){return "Afegeix"},
...
"addStudentsMultiple":function(d){return "Afegeix diversos alumnes"},
...
"age":function(d){return "Edat"},
"all":function(d){return "All"},
"allHandouts":function(d){return "All handouts"},
"allStudents":function(d){return "All"},
"allowEditing":function(d){return "Permetre l'edició"},
"allowEditingInstructions":function(d){return "\"Permetre l'edició\", mentre que els estudiants estan fent l'avaluació."},
"and":function(d){return "i"},
"animationMode":function(d){return "Animació"},
...
"answersVisible":function(d){return "Respostes visibles (només-lectura)"},
"archiveSection":function(d){return "Archive Section"},
"applabMarketingButton":function(d){return "Aprèn més"},
...
"applabTutorialButton":function(d){return "Inici"},
...
"assessmentSteps":function(d){return "Passos a donar per a l'avaluació"},
"assessmentSettings":function(d){return "Configuració de la avaluació"},
...
"autoGenerated":function(d){return "Auto-generada"},
"autolock":function(d){return "Nota: Etapa bloquejada automàticament després de 24 hores."},
...
"censusInvalidEmail":function(d){return "Per favor, introdueïx una adreça de correu electrònic vàlida"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"ca",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"choosePrefix":function(d){return "Triar..."},
...
"completed":function(d){return "Completat"},
...
"congratsCertificatePersonalize":function(d){return "Personalitza el teu certificat"},
"congratsCertificateShare":function(d){return "Compartiu el vostre assoliment"},
"congratsCertificateThanks":function(d){return "Gràcies per enviar!"},
...
"contractMatchBadDomainName":function(d){return "Un o més dels teus elements del domini té el nom errat."},
"contractMatchBadDomainSize":function(d){return "El teu contracte no té el nombre correcte d'elements del domini."},
"contractMatchBadDomainType":function(d){return "Un o més dels teus elements de domini té un tipus erroni, o està en ordre equivocat."},
"contractMatchBadName":function(d){return "El teu contracte té el nom malament."},
"contractMatchBadNameCase":function(d){return "Els noms de les funcions distingeixen entre majúscules i minúscules. Proveu de canviar al nom del teu contracte."},
"contractMatchBadRange":function(d){return "El teu contracte té el rang malament."},
...
"correctAnswer":function(d){return "Aquesta és la resposta correcta."},
...
"courseBlocksToolsAppLab":function(d){return "Laboratori d'aplicacions"},
...
"coursesHeadingStudent":function(d){return "Aprendre sobre Code Studio"},
...
"createSectionsInfo":function(d){return "Crea noves seccions i afegeix-hi alumnes. Les seccions t'ajuden a organitzar els estudiants en grups més petits de manera que puguis fer un seguiment del seu progrés i administrar els seus comptes."},
...
"currentVersion":function(d){return "Versió actual"},
"curriculum":function(d){return "Pla d'estudis"},
...
"dataTableNamePlaceholder":function(d){return "Nom de la taula"},
"dataWorkspaceHeader":function(d){return "Cercador de dades"},
...
"debugWatchHeader":function(d){return "Notificacions"},
...
"deleteConfirm":function(d){return "Vols suprimir?"},
...
"disabledButtonsInfo":function(d){return "El teu progrés i codi no és grabarà durant l'hora de codi."},
...
"done":function(d){return "Fet"},
"dontForget":function(d){return "No t'oblidis"},
...
"dropletBlock_greaterThanOrEqualOperator_description":function(d){return "Prova si un valor és superior o igual a un altre valor. Retorna cert si el valor a la part esquerra de l'expressió és superior o igual al valor a la dreta de l'expressió."},
"dropletBlock_greaterThanOrEqualOperator_signatureOverride":function(d){return "Operador igual o superior"},
...
"dropletBlock_lessThanOrEqualOperator_description":function(d){return "Prova si un valor és inferior o igual a un altre valor. Retorna cert si el valor a la part esquerra de l'expressió és inferior o igual al valor a la dreta de l'expressió."},
"dropletBlock_lessThanOrEqualOperator_signatureOverride":function(d){return "Operador Menys que o igual"},
...
"dropletBlock_randomNumber_description":function(d){return "Retorna un nombre aleatori de l'interval tancat de min a max."},
...
"errorGenericLintError":function(d){return "El programa conté una advertència d'edició que ha de ser corregida. Situa el cursor sobre les icones a prop de la línia de números a l'editor per saber-ne més."},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"ca",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"ca",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"findGuestSpeaker":function(d){return "Trobar un orador convidat"},
...
"forTeachersOnly":function(d){return "Només per a professors"},
"gender":function(d){return "Sexe"},
"genderMale":function(d){return "Home"},
"genderFemale":function(d){return "Dona"},
...
"getHelp":function(d){return "Obtenir ajuda"},
...
"hidden":function(d){return "Ocult"},
...
"hintPromptInline":function(d){return "Vols una pista?"},
"hintRequest":function(d){return "Veure pista"},
"hintReviewTitle":function(d){return "Revisar els seus consells"},
"hintSelectInstructions":function(d){return "Instruccions i consells vells"},
...
"homepageUiTipsBeforeDialogConfirm":function(d){return "Mostra'm"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "Finalitza"},
"homepageUiTipsAfterDialogConfirm":function(d){return "Aprèn més"},
"iconSearchPlaceholder":function(d){return "Buscar una icona..."},
...
"incorrectAnswerBody":function(d){return "La resposta que he introduït no és correcta.  Si us plau, intenta-ho de nou!"},
"incorrectSolution":function(d){return "Solució incorrecta"},
"incorrectSolutionBody":function(d){return "La solució que has introduït no és correcta.  Si us plau, intenta-ho de nou!"},
...
"joinSectionPlaceholder":function(d){return "Secció Codi (ABCDEF)"},
"joinCommunity":function(d){return "Join community"},
"joinText":function(d){return "combina"},
"joinTextTooltip":function(d){return "Create a piece of text by joining together multiple items."},
"joinUs":function(d){return "Uneix-te"},
"jump":function(d){return "salt"},
"justDidHourOfCode":function(d){return "Acabo de fer la #HourOfCode - Fes-ho! @codeorg"},
...
"learnMore":function(d){return "Aprèn més"},
"leaveSection":function(d){return "Leave section"},
"less":function(d){return "Menys"},
...
"lessonPlans":function(d){return "Plans d'estudi"},
...
"loading":function(d){return "Carregant..."},
"locked":function(d){return "Bloquejat"},
"lockFollowing":function(d){return "Lock the following stages that are currently unlocked:"},
"lockAssessment":function(d){return "Avaluació bloquejada"},
...
"lockStage":function(d){return "Etapa bloquejada"},
"lockStageInstructions":function(d){return "Una vegada que s'acabi el temps, \"bloqueja l'etapa\" per ocultar les preguntes."},
"lockWhenDone":function(d){return "Bloquegeu quan els estudiants acabin"},
"loginInfo":function(d){return "Login Info"},
"loginType":function(d){return "Tipus d'inici de sessió"},
...
"manageStudents":function(d){return "Gestiona els alumnes"},
"manageStudentsNotificationFailure":function(d){return "Something went wrong."},
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"ca",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"ca",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"minecraftMarketingButton":function(d){return "Inici"},
...
"newPassword":function(d){return "Nova contrasenya"},
"newSection":function(d){return "Nova secció"},
...
"noIconsFound":function(d){return "Cap icona trobada"},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"ca",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"okay":function(d){return "D'acord"},
"online":function(d){return "En línia"},
...
"other":function(d){return "Altres"},
...
"pairProgramming":function(d){return "Programació per parelles"},
"parent":function(d){return "Pares"},
"parents":function(d){return "Parents"},
"parentsAndStudents":function(d){return "Parents and Students"},
"password":function(d){return "contrasenya"},
...
"playzoneArtistDescription":function(d){return "Dibuixar imatges estupendes i dissenys amb l'artista!"},
"playzoneArtistTitle":function(d){return "New Drawing"},
"playzoneContinueButton":function(d){return "Go on to the next Stage"},
"playzonePlaylabDescription":function(d){return "Crea una història o fes una partida amb Play Lab!"},
...
"printCertificate":function(d){return "Imprimeix el certificat"},
"printCertificates":function(d){return "Print certificates"},
"printLoginCards":function(d){return "Print Login Cards"},
"privacyPolicy":function(d){return "Política de Privacitat"},
...
"progress":function(d){return "Progrés"},
...
"projectGroupMath":function(d){return "Mates"},
...
"projectType":function(d){return "Tipus"},
...
"projectTypeApplab":function(d){return "Laboratori d'aplicacions"},
...
"projectTypeEvents":function(d){return "Esdeveniments"},
...
"projectTypeBounce":function(d){return "Rebota"},
...
"projects":function(d){return "Projectes"},
"projectsSubHeading":function(d){return "Over 20 million projects created"},
"print":function(d){return "Imprimeix"},
"projectWarning":function(d){return "Nota: Vostè està en un nivell que és part d'un projecte més gran. Els canvis realitzats en aquest nivell també apareixeran en altres nivells del projecte."},
...
"remix":function(d){return "Remescla"},
...
"rename":function(d){return "Canviar el nom"},
...
"resetPassword":function(d){return "Reinicialitza la contrasenya"},
"resources":function(d){return "Resources"},
"restoreThisVersion":function(d){return "Restaura aquesta versió"},
...
"save":function(d){return "Desa"},
"saveAll":function(d){return "Desa-ho tot"},
...
"schoolTypeOther":function(d){return "Altres"},
...
"section":function(d){return "Secció"},
"sectionCode":function(d){return "Secció Codi"},
"sectionName":function(d){return "Nom de la secció"},
...
"secret":function(d){return "Contrasenya"},
...
"showSecret":function(d){return "Mostra la contrasenya"},
...
"signupFormSchoolType":function(d){return "Tipus"},
...
"standardsAndFramework":function(d){return "Plans docents i recursos"},
"standardsAndFrameworkDescription":function(d){return "Information about standards alignment for Code.org courses."},
"startLearning":function(d){return "Comença a aprendre"},
"startOver":function(d){return "Torna a començar"},
"startOverTitle":function(d){return "Estàs segur que vols tornar a començar?"},
"startOverBody":function(d){return "Això tornarà el puzzle al seu estat inicial i eliminarà totes les dades que hagis afegit o modificat."},
...
"student":function(d){return "estudiant"},
"students":function(d){return "Alumnes"},
"studentAccountsAndProgress":function(d){return "Comptes i progrés dels alumnes"},
...
"studentName":function(d){return "Nom de l'alumne"},
...
"teacher":function(d){return "Mestre"},
...
"teacherCourseHoc":function(d){return "Hora del codi"},
...
"teacherHomePage":function(d){return "Pàgina d'inici de mestre"},
...
"thanksForYourResponse":function(d){return "Gràcies per la resposta!"},
"thankyou":function(d){return "Gràcies"},
...
"tryIt":function(d){return "Proveu-ho"},
...
"unplugged":function(d){return "Sense connexió"},
"unpluggedActivity":function(d){return "Activitat sense connexió"},
...
"viewCourse":function(d){return "Veure el curs"},
...
"viewLessonPlan":function(d){return "Veure unitat didàctica"},

...
"collect":function(d){return "safna"},
"collectiblePresent":function(d){return "það er fjársjóð að finna"},
"collectorCollectTooltip":function(d){return "Safna hlut"},
"collectorCollectedEverything":function(d){return "Til hamingju! Þú safnaðir "+maze_locale.p(d,"count",0,"is",{"one":"hlutnum","other":"öllum "+maze_locale.n(d,"count")+" hlutunum"})+"!"},
"collectorCollectedNothing":function(d){return "Haltu áfram að kóða! Þú þarft að safna sem flestum af hlutunum."},
"collectorCollectedSome":function(d){return "Vel gert! Þú safnaðir  "+maze_locale.p(d,"count",0,"is",{"one":"1 hlut","other":maze_locale.n(d,"count")+" hlutum"})+"!\n"},
"collectorCollectedNotEnough":function(d){return "Haltu áfram að kóða! Þú þarft að safna minnst  "+maze_locale.p(d,"count",0,"is",{"one":"1 hlut","other":maze_locale.n(d,"count")+" hlutum"})+"."},
"collectorCollectedTooMany":function(d){return "Þetta svæði inniheldur ekki nógu margt sem ég get safnað."},
"collectorTooManyBlocks":function(d){return "Þú mátt aðeins nota "+maze_locale.v(d,"blockLimit")+" kubba. Athugaðu kóðann þinn og reyndu aftur!"},
"continue":function(d){return "Halda áfram"},
"corn":function(d){return "maís"},
"cornTooltip":function(d){return "Uppskera maís"},
"didNotCollectAllCrops":function(d){return "Gættu þess að skilja ekki neinar afurðir eftir!"},
"didNotCollectEverything":function(d){return "Gættu þess að skilja ekki eftir neinn blómasafa eða hunang!"},
"didNotPlantEverywhere":function(d){return "Gættu þess að planta einhverju í hvern moldarreit!"},
...
"emptyCropError":function(d){return "Þessi planta er öll búin."},
...
"goal":function(d){return "mark"},
"has":function(d){return "hefur"},
"haslettuce":function(d){return "það er kál"},
"hascorn":function(d){return "það er maís"},
"haspumpkin":function(d){return "það eru grasker"},
...
"lettuce":function(d){return "kál"},
"lettuceTooltip":function(d){return "Uppskera kál"},
...
"pick":function(d){return "tína"},
"pilePresent":function(d){return "það er haugur"},
"plant":function(d){return "planta"},
"plantInNonSoilError":function(d){return "Ég get aðeins plantað í ferska mold."},
"plantTooltip":function(d){return "Planta sprota"},
"pumpkin":function(d){return "grasker"},
"pumpkinTooltip":function(d){return "Uppskera grasker"},
...
"soil":function(d){return "mold"},
"sprout":function(d){return "sproti"},
...
"wrongCropError":function(d){return "Ég get ekki uppskorið þessa plöntu héðan."},

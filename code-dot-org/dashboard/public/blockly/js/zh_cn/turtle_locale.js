...
"drawAHexagon":function(d){return "画一个六边形"},
...
"drawASquare":function(d){return "画一个正方形"},
"drawAStar":function(d){return "画一个星星"},
"drawATree":function(d){return "画一棵树"},
"drawATriangle":function(d){return "画一个三角形"},
"drawUpperWave":function(d){return "绘制上波浪"},
"drawLowerWave":function(d){return "绘制下波浪"},
"drawSticker":function(d){return "画贴纸"},
"heightParameter":function(d){return "高度"},
"hideTurtle":function(d){return "隐藏小艺术家"},
"jump":function(d){return "跳跃"},
"jumpTo":function(d){return "跳转到"},
"jumpBackward":function(d){return "向后跳"},
"jumpForward":function(d){return "向前跳"},
"jumpTooltip":function(d){return "不着痕迹地移动小艺术家。"},
"jumpEastTooltip":function(d){return "将小艺术家向东移动，不留下任何痕迹。"},
"jumpNorthTooltip":function(d){return "将小艺术家向北移动，不留下任何痕迹。"},
"jumpNortheastTooltip":function(d){return "将小艺术家向东北移动，不留下任何痕迹。"},
"jumpNorthwestTooltip":function(d){return "将小艺术家向西北移动，不留下任何痕迹。"},
"jumpSouthTooltip":function(d){return "将小艺术家向男移动，不留下任何痕迹。"},
"jumpSoutheastTooltip":function(d){return "将小艺术家向东南移动，不留下任何痕迹。"},
"jumpSouthwestTooltip":function(d){return "将小艺术家向西南移动，不留下任何痕迹。"},
"jumpWestTooltip":function(d){return "将小艺术家向西移动，不留下任何痕迹。"},
...
"moveEastTooltip":function(d){return "把小艺术家向东移动"},
"moveForward":function(d){return "向前移动"},
"moveForwardTooltip":function(d){return "向前移动小艺术家。"},
"moveNorthTooltip":function(d){return "把小艺术家向北移动"},
"moveNortheastTooltip":function(d){return "将艺术家往东北方向移动"},
"moveNorthwestTooltip":function(d){return "将艺术家往西北方向移动"},
"moveSouthTooltip":function(d){return "把小艺术家向南移动"},
"moveSoutheastTooltip":function(d){return "将艺术家往东南方向移动"},
"moveSouthwestTooltip":function(d){return "将艺术家往西南方向移动"},
"moveWestTooltip":function(d){return "把小艺术家向西移动"},
"moveTooltip":function(d){return "将小艺术家向前或向后移动指定的量。"},
...
"setCharacter":function(d){return "设置角色到 "+turtle_locale.v(d,"character")},
"setColour":function(d){return "设置颜色"},
"setPattern":function(d){return "设置图案"},
"setWidth":function(d){return "设置宽度"},
"shareDrawing":function(d){return "分享您的图画："},
"showMe":function(d){return "显示"},
"showTurtle":function(d){return "显示小艺术家"},
...
"turnRightTooltip":function(d){return "把小艺术家向右转指定的角度。"},
"turnTooltip":function(d){return "把小艺术家向左或向右转指定的角度。"},
"turtleVisibilityTooltip":function(d){return "使小艺术家可见或不可见。"},

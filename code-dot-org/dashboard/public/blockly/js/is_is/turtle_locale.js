...
"jumpNortheastTooltip":function(d){return "Færir listamanninn norðaustur án þess að skilja eftir slóð."},
"jumpNorthwestTooltip":function(d){return "Færir listamanninn norðvestur án þess að skilja eftir slóð."},
"jumpSouthTooltip":function(d){return "Færir listamanninn suður án þess að skilja eftir slóð."},
"jumpSoutheastTooltip":function(d){return "Færir listamanninn suðaustur án þess að skilja eftir slóð."},
"jumpSouthwestTooltip":function(d){return "Færir listamanninn suðvestur án þess að skilja eftir slóð."},
...
"moveNortheastTooltip":function(d){return "Færir listamanninn í norðaustur."},
"moveNorthwestTooltip":function(d){return "Færir listamanninn í norðvestur."},
"moveSouthTooltip":function(d){return "Færir listamanninn í suðurátt."},
"moveSoutheastTooltip":function(d){return "Færir listamanninn í suðaustur."},
"moveSouthwestTooltip":function(d){return "Færir listamanninn í suðvestur."},
...
"setAlpha":function(d){return "stilla alfa"},
"setCharacter":function(d){return "stilla persónu á "+turtle_locale.v(d,"character")},

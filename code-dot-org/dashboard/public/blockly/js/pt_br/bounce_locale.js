...
"basketballLaunchBall":function(d){return "jogar outra bola"},
"basketballLaunchBallTooltip":function(d){return "Lança uma bola em jogo."},
"basketballSetPaddle":function(d){return "definir mão"},
"basketballSetPaddleSpeedFast":function(d){return "definir velocidade da mão como rápida"},
"basketballSetPaddleSpeedNormal":function(d){return "definir velocidade da mão como normal"},
"basketballSetPaddleSpeedRandom":function(d){return "definir velocidade da mão como aleatória"},
"basketballSetPaddleSpeedSlow":function(d){return "definir velocidade da mão como lenta"},
"basketballSetPaddleSpeedTooltip":function(d){return "Define a velocidade da mão"},
"basketballSetPaddleSpeedVeryFast":function(d){return "definir velocidade da mão como muito rápida"},
"basketballSetPaddleSpeedVerySlow":function(d){return "definir velocidade da mão como muito lenta"},
"basketballWhenBallMissesPaddle":function(d){return "quando a bola não acerta a mão"},
"basketballWhenPaddleCollided":function(d){return "quando a bola acerta a mão"},
...
"playSoundCheer":function(d){return "reproduzir aplausos"},
...
"playSoundKick":function(d){return "reproduza som de chute"},
...
"playSoundSlapshot":function(d){return "reproduzir som de palmas"},
"playSoundSwish":function(d){return "reproduza barulho da rede balançando"},
"playSoundTooltip":function(d){return "Reproduza o som escolhido."},
"playSoundWhistle":function(d){return "reproduza som de apito"},
...
"setBackground":function(d){return "definir "+bounce_locale.v(d,"background")+" cenário"},
...
"setBall":function(d){return "definir "+bounce_locale.v(d,"ball")+" bola"},
...
"setPaddle":function(d){return "definir raquete"},
...
"setPlayerSpeedFast":function(d){return "definir velocidade do jogador como rápida"},
"setPlayerSpeedNormal":function(d){return "definir velocidade do jogador como normal"},
"setPlayerSpeedRandom":function(d){return "definir velocidade do jogador como aleatória"},
"setPlayerSpeedSlow":function(d){return "definir velocidade do jogador como lenta"},
"setPlayerSpeedTooltip":function(d){return "Define a velocidade do jogador"},
"setPlayerSpeedVeryFast":function(d){return "definir velocidade do jogador como muito rápida"},
"setPlayerSpeedVerySlow":function(d){return "definir velocidade do jogador como muito lenta"},
"setTeamTooltip":function(d){return "Define o esquema de cores e o logotipo"},
"setTeam":function(d){return "Definir equipe "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Definir equipe aleatória"},
"shareBounceTwitter":function(d){return "Veja o jogo de Pingue-pongue que eu fiz. Eu mesmo programei com a @codeorg"},
"shareBounceTwitterDonor":function(d){return "Confira o jogo Bounce que fiz. (Obrigado "+bounce_locale.v(d,"donor")+" por apoiar @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "quando a bola não atinge o jogador"},
...
"whenPlayerCollided":function(d){return "quando a bola atinge o jogador"},
"whenPlayerCollidedTooltip":function(d){return "Execute as ações abaixo quando uma bola atingir o jogador."},

...
"startButton":function(d){return "Početak"},
...
"filterGradesAll":function(d){return "Svi uzrasti"},
...
"filterStudentExperienceBeginner":function(d){return "Početnik"},
"filterStudentExperienceComfortable":function(d){return "Ugodno"},
"filterStudentExperienceExperienced":function(d){return "Experienced"},
"filterPlatform":function(d){return "Classroom technology"},
"filterPlatformComputers":function(d){return "Računala"},
...
"filterTopicsHistory":function(d){return "Društveni Studiji"},
"filterTopicsLa":function(d){return "Language Arts"},
"filterTopicsArt":function(d){return "Art, Media, Music"},
"filterTopicsCsOnly":function(d){return "Samo Računalna Znanost"},
"filterActivityType":function(d){return "Tip aktivnosti"},
"filterActivityTypeOnlineTutorial":function(d){return "Self-led tutorial"},
"filterActivityTypeLessonPlan":function(d){return "Nastavni plan"},
"filterLength":function(d){return "Trajanje"},
"filterLength1Hour":function(d){return "Jedan sat"},
"filterLength1HourFollow":function(d){return "One hour with follow-on"},
"filterLengthFewHours":function(d){return "Nekoliko sati"},
"filterProgrammingLanguage":function(d){return "Jezik"},
"filterProgrammingLanguageBlocks":function(d){return "Blokovi"},
"filterProgrammingLanguageTyping":function(d){return "Typing"},
"filterProgrammingLanguageOther":function(d){return "Ostalo"},
"filterActivityTypeRobotics":function(d){return "Robotika"},
"backButtonBack":function(d){return "Povratak na sve aktivnosti"},
"filterHeaderShowFilters":function(d){return "Filteri"},
"filterHeaderHideFilters":function(d){return "Primijeni"},
...
"tutorialDetailsTeacherNotes":function(d){return "Bilješke predavača"},
"tutorialDetailsShortLink":function(d){return "Kratka poveznica"},
"tutorialDetailInternationalLanguages":function(d){return "Jezici"},
...
"headingTutorialsYourLanguage":function(d){return "Aktivnosti na Vašem jeziku"},

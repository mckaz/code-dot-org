...
"basketballLaunchBall":function(d){return "rzuć nową piłkę"},
"basketballLaunchBallTooltip":function(d){return "Rzuć piłkę do gry."},
"basketballSetPaddle":function(d){return "ustaw paletkę"},
"basketballSetPaddleSpeedFast":function(d){return "ustaw szybką prędkość paletki"},
"basketballSetPaddleSpeedNormal":function(d){return "ustaw normalną prędkość paletki"},
"basketballSetPaddleSpeedRandom":function(d){return "ustaw losową prędkość paletki"},
"basketballSetPaddleSpeedSlow":function(d){return "ustaw powolną prędkość paletki"},
"basketballSetPaddleSpeedTooltip":function(d){return "Ustawia prędkość paletki"},
"basketballSetPaddleSpeedVeryFast":function(d){return "ustaw bardzo szybką prędkość paletki"},
"basketballSetPaddleSpeedVerySlow":function(d){return "ustaw bardzo powolną prędkość paletki"},
"basketballWhenBallMissesPaddle":function(d){return "kiedy piłka omija paletkę"},
"basketballWhenPaddleCollided":function(d){return "kiedy piłka trafia w paletkę"},
...
"launchBall":function(d){return "wypuść nową piłkę"},
"launchBallTooltip":function(d){return "Wypuść piłkę do gry."},
...
"playSoundCheer":function(d){return "zagraj dźwięk owacji"},
...
"playSoundKick":function(d){return "zagraj dźwięk strzału"},
...
"playSoundSlapshot":function(d){return "zagraj dźwięk uderzenia"},
"playSoundSwish":function(d){return "zagraj dźwięk szelestu"},
"playSoundTooltip":function(d){return "Zagraj wybrany dźwięk."},
"playSoundWhistle":function(d){return "zagraj dźwięk gwizdka"},
...
"setBackground":function(d){return "ustaw scenę "+bounce_locale.v(d,"background")},
...
"setBall":function(d){return "ustaw piłkę "+bounce_locale.v(d,"ball")},
...
"setPaddle":function(d){return "ustaw paletkę"},
"setPaddleHardcourt":function(d){return "ustaw paletkę/rakietę do tenisa"},
...
"setPlayerSpeedFast":function(d){return "ustaw szybką prędkość gracza"},
"setPlayerSpeedNormal":function(d){return "ustaw normalną prędkość gracza"},
"setPlayerSpeedRandom":function(d){return "ustaw losową prędkość gracza"},
"setPlayerSpeedSlow":function(d){return "ustaw powolną prędkość gracza"},
"setPlayerSpeedTooltip":function(d){return "Ustawia prędkość gracza"},
"setPlayerSpeedVeryFast":function(d){return "ustaw bardzo szybką prędkość gracza"},
"setPlayerSpeedVerySlow":function(d){return "ustaw bardzo powolną prędkość gracza"},
"setTeamTooltip":function(d){return "Ustawia schemat logo i kolorów"},
"setTeam":function(d){return "Ustaw zespół "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Ustaw zespół losowo"},
...
"shareBounceTwitterDonor":function(d){return "Sprawdź nową grę Bounce, którą zrobiłem. (Dzięki "+bounce_locale.v(d,"donor")+" za wspomaganie @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "kiedy piłka omija gracza"},
...
"whenPaddleCollidedTooltip":function(d){return "Wykonaj poniższe czynności, kiedy piłka zderza się z paletką."},
"whenPlayerCollided":function(d){return "kiedy piłka uderza gracza"},
"whenPlayerCollidedTooltip":function(d){return "Wykonaj poniższe czynności, kiedy piłka zderza się z graczem."},
...
"whenWallCollidedTooltip":function(d){return "Wykonaj poniższe czynności, kiedy piłka uderza w ścianę."},

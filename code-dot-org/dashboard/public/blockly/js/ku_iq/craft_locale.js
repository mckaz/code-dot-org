...
"blockActionAdd":function(d){return "lê zêde bike"},
"blockActionAttack":function(d){return "Hêrişkirin"},
"blockActionClone":function(d){return "clone blocks"},
"blockActionCloneFiltered":function(d){return "clone only"},
"blockActionCollect":function(d){return "كۆبكەوە/خركەوە"},
...
"blockActionExplodeEntity":function(d){return "تەقیەوە"},
...
"blockActionRepeat":function(d){return "دووبارەکردنەوە"},
...
"blockPlace":function(d){return "شوێن/دانان/جێگا"},
"blockPlaceTorch":function(d){return "place torch"},
"blockPlaceXAheadAhead":function(d){return "بەرەو پێشەوە"},
"blockPlaceXAheadPlace":function(d){return "شوێن/دانان/جێگا"},
"blockPlaceXPlace":function(d){return "شوێن/دانان/جێگا"},
...
"blockTypeBricks":function(d){return "خشتی قوڕ/بلۆك"},
"blockTypeClay":function(d){return "قوڕی خاوێن"},
"blockTypeClayHardened":function(d){return "hardened clay"},
"blockTypeCobblestone":function(d){return "cobblestone"},
"blockTypeDirt":function(d){return "خۆڵ/چڵك/پیسی"},
"blockTypeDirtCoarse":function(d){return "coarse dirt"},
"blockTypeDoorIron":function(d){return "iron door"},
"blockTypeEmpty":function(d){return "بەتاڵ/بۆش/چۆڵ/بەتاڵ كردن"},
"blockTypeFarmlandWet":function(d){return "خاكی كێلگە"},
"blockTypeGlass":function(d){return "شوشە/دەفری شوشە/پەرداخ"},
"blockTypeGlowstone":function(d){return "glowstone"},
"blockTypeGrass":function(d){return "چیمەن/فریز/گیا/گژوگیا"},
"blockTypeGravel":function(d){return "چەو/بەردی ورد"},
"blockTypeLava":function(d){return "دەردراوی گركان"},
...
"blockTypeOreCoal":function(d){return "كانزای خاوی خەلووز"},
"blockTypeOreDiamond":function(d){return "كانزای خاوی ئەڵماس"},
"blockTypeOreEmerald":function(d){return "كانزای خاوی سەوزی درەوشاوە"},
"blockTypeOreGold":function(d){return "كانزای خاوی زێر"},
"blockTypeOreIron":function(d){return "كانزای خاوی ئاسن"},
...
"blockTypeRail":function(d){return "هیڵی شەمەندەفەر/بەربەست/عەلاقەری جل هاڵواسین"},
"blockTypeRailsRedstoneTorch":function(d){return "redstone torch"},
"blockTypeRedstoneWire":function(d){return "redstone wire"},
"blockTypeSand":function(d){return "لم/وردە بەرد"},
"blockTypeSandstone":function(d){return "sandstone"},
"blockTypeStone":function(d){return "بەرد"},
"blockTypeTnt":function(d){return "tnt"},
"blockTypeTree":function(d){return "دار/درەخت"},
"blockTypeWater":function(d){return "ئاو"},
"blockTypeWool":function(d){return "خوری"},
...
"blockWhileXAheadAhead":function(d){return "بەرەو پێشەوە"},
"blockWhileXAheadDo":function(d){return "بكە"},
...
"houseSelectEasy":function(d){return "ئاسان"},
"houseSelectHard":function(d){return "زەحمەت"},
...
"miniBlockBricks":function(d){return "خشتی قوڕ/بلۆك"},
...
"miniBlockDirt":function(d){return "خۆڵ/چڵك/پیسی"},
...
"miniBlockGravel":function(d){return "چەو/بەردی ورد"},
...
"miniBlockSand":function(d){return "لم/وردە بەرد"},
...
"miniBlockWool":function(d){return "خوری"},
...
"soundTypeExplode":function(d){return "تەقیەوە"},
...
"timeNight":function(d){return "شەو"},
"timeRandom":function(d){return "هەڕەمەکی"},

...
"endGame":function(d){return "einde spel"},
...
"flapRandom":function(d){return "flapper een paar keer"},
...
"setBackgroundSciFi":function(d){return "achtergrond Science Fiction"},
...
"setGravityVeryLow":function(d){return "zwaartekracht heel laag"},
"setGravityLow":function(d){return "zwaartekracht laag"},
"setGravityNormal":function(d){return "zwaartekracht normaal"},
"setGravityHigh":function(d){return "zwaartekracht hoog"},
"setGravityVeryHigh":function(d){return "zwaartekracht heel hoog"},
"setGravityTooltip":function(d){return "Stelt zwaartekracht in"},
"setGround":function(d){return "kies ondergrond"},
"setGroundRandom":function(d){return "kies ondergrond willekeurig"},
"setGroundFlappy":function(d){return "ondergrond kiezen"},
"setGroundSciFi":function(d){return "planeet als ondergrond kiezen"},
"setGroundUnderwater":function(d){return "kies ondergrond onderwater"},
"setGroundCave":function(d){return "kies ondergrond grot"},
"setGroundSanta":function(d){return "ondergrond kerstmis"},
"setGroundLava":function(d){return "ondergrond lava"},
"setGroundTooltip":function(d){return "Stelt ondergrond in"},
"setObstacle":function(d){return "kies obstakel"},
"setObstacleRandom":function(d){return "obstakel  willekeurig"},
"setObstacleFlappy":function(d){return "obstakel pijp"},
"setObstacleSciFi":function(d){return "obstakel Science fiction"},
"setObstacleUnderwater":function(d){return "Planten als obstakels instellen"},
"setObstacleCave":function(d){return "obstakel grot"},
"setObstacleSanta":function(d){return "obstakel schoorsteen"},
...
"setPlayerRandom":function(d){return "kies speler willekeurig"},
"setPlayerFlappy":function(d){return "kies speler Gele Vogel"},
"setPlayerRedBird":function(d){return "kies speler Rode Vogel"},
"setPlayerSciFi":function(d){return "kies speler Ruimteschip"},
"setPlayerUnderwater":function(d){return "kies speler Vis"},
"setPlayerCave":function(d){return "kies speler Vleermuis"},
"setPlayerSanta":function(d){return "kies speler kerstman"},
"setPlayerShark":function(d){return "kies speler Haai"},
"setPlayerEaster":function(d){return "kies speler Paashaas"},
"setPlayerBatman":function(d){return "kies speler Batman"},
"setPlayerSubmarine":function(d){return "kies speler Onderzeeër"},
"setPlayerUnicorn":function(d){return "Stel eenhoorn als speler in"},
"setPlayerFairy":function(d){return "kies speler Elfje"},
"setPlayerSuperman":function(d){return "kies speler Flappyman"},
"setPlayerTurkey":function(d){return "kies speler Kalkoen"},
...
"setSpeedTooltip":function(d){return "Kiest niveau en snelheid"},
"shareFlappyTwitter":function(d){return "Bekijk het Flappy spel dat ik zelf heb gemaakt met @codeorg"},
"shareFlappyTwitterDonor":function(d){return "Bekijk het Flappy spel dat ik heb gemaakt. (Bedankt "+flappy_locale.v(d,"donor")+" voor de ondersteuning van @codeorg)"},
...
"soundHit":function(d){return "klap"},
...
"whenEnterObstacle":function(d){return "bij het passeren van een obstakel"},

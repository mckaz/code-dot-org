...
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"he",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
...
"corn":function(d){return "תירס"},
"cornTooltip":function(d){return "קצור תירס"},
"didNotCollectAllCrops":function(d){return "ודא כי לא השארת יבול מאחור!"},
...
"pumpkin":function(d){return "דלעת"},

...
"collect":function(d){return "جمع آوری"},
"collectiblePresent":function(d){return "است برخی از گنج وجود دارد"},
"collectorCollectTooltip":function(d){return "جمع آوری یک آیتم"},
"collectorCollectedEverything":function(d){return "Congratulations! You collected all "+maze_locale.v(d,"count")+" items!"},
"collectorCollectedNothing":function(d){return "حفظ برنامه نویسی! شما نیاز به جمع آوری به عنوان بسیاری از موارد به عنوان شما می توانید."},
"collectorCollectedSome":function(d){return "Great work! You collected "+maze_locale.v(d,"count")+" items!"},
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"fa",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
...
"didNotCollectEverything":function(d){return "شما را ترک نکنید هر شهد یا عسل پشت را!"},
...
"lettuce":function(d){return "کاهو"},
...
"pumpkin":function(d){return "کدو تنبل"},
"pumpkinTooltip":function(d){return "برداشت کدو تنبل"},
...
"soil":function(d){return "خاک"},
"sprout":function(d){return "جوانه"},

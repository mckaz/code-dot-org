...
"absolute":function(d){return "ដាច់​ខាត"},
...
"blockActionDestroyEntity":function(d){return "បាត់"},
...
"blockActionMove":function(d){return "ផ្លាស់​​​ទី"},
"blockActionMoveAway":function(d){return "move away from"},
"blockActionMoveForward":function(d){return "រំកិល​ទៅមុខ"},
...
"blockActionRepeat":function(d){return "ធ្វើ​ឡើង​វិញ"},
...
"blockMove":function(d){return "ផ្លាស់​​​ទី"},
"blockMoveBackward":function(d){return "ថយ​ក្រោយ"},
...
"cloneModeMove":function(d){return "ផ្លាស់​​​ទី"},
...
"directionDown":function(d){return "ចុះ"},
"directionForward":function(d){return "forward"},
"directionLeft":function(d){return "ឆ្វេង"},
"directionMiddle":function(d){return "middle"},
"directionRight":function(d){return "ស្តាំ"},
"directionUp":function(d){return "ឡើង"},
...
"timeNight":function(d){return "យប់"},
"timeRandom":function(d){return "ព្រាវ"},

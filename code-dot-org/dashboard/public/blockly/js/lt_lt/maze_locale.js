...
"collect":function(d){return "surink"},
"collectiblePresent":function(d){return "dar yra šiek tiek lobių"},
"collectorCollectTooltip":function(d){return "Paimk daiktą"},
"collectorCollectedEverything":function(d){return "Sveikiname! Tu surinkai "+maze_locale.p(d,"count",0,"lt",{"one":"daiktą","other":"visus "+maze_locale.n(d,"count")+" daiktus(-ų)"})+"!"},
"collectorCollectedNothing":function(d){return "Nenustok programuoti! Tau reikia surinkti kiek galima daugiau daiktų."},
"collectorCollectedSome":function(d){return "Gerai padirbėta! Tu surinkai "+maze_locale.p(d,"count",0,"lt",{"one":"1 daiktą","other":maze_locale.n(d,"count")+" daiktus(-ų)"})+"!"},
"collectorCollectedNotEnough":function(d){return "Nenustok programuoti! Tau reikia surinkti nors "+maze_locale.p(d,"goal",0,"lt",{"one":"1 daiktą","other":maze_locale.n(d,"goal")+" daiktus(-ų)"})+"."},
"collectorCollectedTooMany":function(d){return "Toji vieta neturi pakankamai daiktų, kuriuos galėčiau surinkti."},
"collectorTooManyBlocks":function(d){return "Tu gali naudoti tik "+maze_locale.v(d,"blockLimit")+" blokus. Pažvelk į savo kodą ir pabandyk dar kartą!"},
"continue":function(d){return "Tęsti"},
"corn":function(d){return "kukurūzas"},
"cornTooltip":function(d){return "Nuskink šiek tiek kukurūzų"},
"didNotCollectAllCrops":function(d){return "Įsitikink, kad nepalieki jokio derliaus!"},
"didNotCollectEverything":function(d){return "Įsitikink, kad nepraleidai nė vieno nektaro ar medaus!"},
"didNotPlantEverywhere":function(d){return "Įsitikink, kad ką nors pasodini kiekviename dirvožemio sklypelyje!"},
...
"emptyCropError":function(d){return "Tie pasėliai sunyko."},
...
"has":function(d){return "turi"},
"haslettuce":function(d){return "čia yra salotos"},
"hascorn":function(d){return "čia yra kukurūzas"},
"haspumpkin":function(d){return "čia yra moliūgai"},
...
"lettuce":function(d){return "salotos"},
"lettuceTooltip":function(d){return "Nuskink šiek tiek salotų"},
...
"pick":function(d){return "pasirink"},
"pilePresent":function(d){return "čia yra žemių krūva"},
"plant":function(d){return "pasodink"},
"plantInNonSoilError":function(d){return "Aš galiu ką nors sodinti tik paruoštame dirvožemyje."},
"plantTooltip":function(d){return "Pasodink daigą"},
"pumpkin":function(d){return "moliūgas"},
"pumpkinTooltip":function(d){return "Nuskink moliūgą"},
...
"soil":function(d){return "dirvožemis"},
"sprout":function(d){return "daigas"},
...
"wrongCropError":function(d){return "Aš negaliu šioje vietoje nuimti derliaus."},

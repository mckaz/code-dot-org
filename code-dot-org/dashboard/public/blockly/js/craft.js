...
module.exports = __webpack_require__(3033);
...
var _loadCraft = __webpack_require__(3034);

var _loadCraft2 = _interopRequireDefault(_loadCraft);
...
(0, _loadApp2.default)().then(_loadCraft2.default);
...
exports.default = loadCraft;

var _appMain = __webpack_require__(853);

var _appMain2 = _interopRequireDefault(_appMain);

var _craft = __webpack_require__(3035);

var _craft2 = _interopRequireDefault(_craft);

var _blocks = __webpack_require__(2886);

var _blocks2 = _interopRequireDefault(_blocks);

var _levels = __webpack_require__(3041);

var _levels2 = _interopRequireDefault(_levels);

var _skins = __webpack_require__(2737);

var _skins2 = _interopRequireDefault(_skins);

var _craft3 = __webpack_require__(3042);

var _craft4 = _interopRequireDefault(_craft3);

var _blocks3 = __webpack_require__(2738);

var designerBlocks = _interopRequireWildcard(_blocks3);

var _levels3 = __webpack_require__(3046);

var _levels4 = _interopRequireDefault(_levels3);

var _skins3 = __webpack_require__(2739);

var _skins4 = _interopRequireDefault(_skins3);

var _craft5 = __webpack_require__(2131);

var _craft6 = _interopRequireDefault(_craft5);

var _blocks4 = __webpack_require__(2887);

var agentBlocks = _interopRequireWildcard(_blocks4);

var _levels5 = __webpack_require__(3047);

var _levels6 = _interopRequireDefault(_levels5);

var _skins5 = __webpack_require__(2742);

var _skins6 = _interopRequireDefault(_skins5);

var _craft7 = __webpack_require__(3048);

var _craft8 = _interopRequireDefault(_craft7);

var _blocks5 = __webpack_require__(2889);

var ccBlocks = _interopRequireWildcard(_blocks5);

var _levels7 = __webpack_require__(3054);

var _levels8 = _interopRequireDefault(_levels7);

var _skins7 = __webpack_require__(2744);

var _skins8 = _interopRequireDefault(_skins7);
...
function loadCraft(options) {
  ...
  if (options.level.isConnectionLevel) {
    window.Craft = _craft8.default;
    options.skinsModule = _skins8.default;
    options.blocksModule = ccBlocks;
    (0, _appMain2.default)(window.Craft, _levels8.default, options);
  } else if (options.level.isAgentLevel) {
    window.Craft = _craft6.default;
    options.skinsModule = _skins6.default;
    options.blocksModule = agentBlocks;
    (0, _appMain2.default)(window.Craft, _levels6.default, options);
  } else if (options.level.isEventLevel) {
    window.Craft = _craft4.default;
    options.skinsModule = _skins4.default;
    options.blocksModule = designerBlocks;
    (0, _appMain2.default)(window.Craft, _levels4.default, options);
  } else {
    window.Craft = _craft2.default;
    options.skinsModule = _skins2.default;
    options.blocksModule = _blocks2.default;
    (0, _appMain2.default)(window.Craft, _levels2.default, options);
  }
}
module.exports = exports["default"];
...
var craftMsg = __webpack_require__(1953);

var dom = __webpack_require__(594);
var houseLevels = __webpack_require__(3036);
var levelbuilderOverrides = __webpack_require__(3037);
var MusicController = __webpack_require__(1954);
var Provider = __webpack_require__(53).Provider;
var AppView = __webpack_require__(944);
var CraftVisualizationColumn = __webpack_require__(3038);
...
Craft.init = function (config) {
    ...
    if (config.level.showPopupOnLoad) {
      if (config.level.showPopupOnLoad === 'playerSelection') {
        ...
        Craft.showHouseSelectionPopup(function (selectedHouse) {
          (0, _trackEvent2.default)('Minecraft', 'ChoseHouse', selectedHouse);
  ...
  Craft.musicController = new MusicController(_Sounds2.default.getSingleton(), function (filename) {
    return config.skin.assetUrl('music/' + filename);
  }, levelTracks, levelTracks.length > 1 ? 7500 : null);
  ...
  _reactDom2.default.render(_react2.default.createElement(
    Provider,
    { store: (0, _redux.getStore)() },
    _react2.default.createElement(AppView, {
      visualizationColumn: _react2.default.createElement(CraftVisualizationColumn, {
        showFinishButton: !config.level.isProjectLevel
      }),
      onMount: onMount
    })
...
Craft.updateUIForCharacter = function (character) {
  ...
  (0, _jquery2.default)('#prompt-icon').attr('src', characters[character].smallStaticAvatar);
};

Craft.showPlayerSelectionPopup = function (onSelectedCallback) {
  var selectedPlayer = DEFAULT_CHARACTER;
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3039)({
  ...
  dom.addClickTouchEvent((0, _jquery2.default)('#close-character-select')[0], function () {
    popupDialog.hide();
  }.bind(this));
  dom.addClickTouchEvent((0, _jquery2.default)('#choose-steve')[0], function () {
    selectedPlayer = CHARACTER_STEVE;
    (0, _trackEvent2.default)('Minecraft', 'ClickedCharacter', selectedPlayer);
    popupDialog.hide();
  }.bind(this));
  dom.addClickTouchEvent((0, _jquery2.default)('#choose-alex')[0], function () {
    selectedPlayer = CHARACTER_ALEX;
    (0, _trackEvent2.default)('Minecraft', 'ClickedCharacter', selectedPlayer);
    popupDialog.hide();
  }.bind(this));
...
Craft.showHouseSelectionPopup = function (onSelectedCallback) {
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3040)({
    image: studioApp().assetUrl()
  });
  ...
  dom.addClickTouchEvent((0, _jquery2.default)('#close-house-select')[0], function () {
    popupDialog.hide();
  }.bind(this));
  dom.addClickTouchEvent((0, _jquery2.default)('#choose-house-a')[0], function () {
    selectedHouse = "houseA";
    (0, _trackEvent2.default)('Minecraft', 'ClickedHouse', selectedHouse);
    popupDialog.hide();
  }.bind(this));
  dom.addClickTouchEvent((0, _jquery2.default)('#choose-house-b')[0], function () {
    selectedHouse = "houseB";
    (0, _trackEvent2.default)('Minecraft', 'ClickedHouse', selectedHouse);
    popupDialog.hide();
  }.bind(this));
  dom.addClickTouchEvent((0, _jquery2.default)('#choose-house-c')[0], function () {
...
Craft.executeUserCode = function () {
  ...
  _CustomMarshalingInterpreter2.default.evalWith(code, {
    ...
    whilePathAhead: function whilePathAhead(blockID, callback) {
      // if resurrected, move blockID be last parameter to fix "Show Code"
      appCodeOrgAPI.whilePathAhead(studioApp().highlight.bind(studioApp(), blockID), '', 'Player', callback);
    },
    whileBlockAhead: function whileBlockAhead(blockID, blockType, callback) {
      // if resurrected, move blockID be last parameter to fix "Show Code"
      appCodeOrgAPI.whilePathAhead(studioApp().highlight.bind(studioApp(), blockID), blockType, 'Player', callback);
    },
    ifLavaAhead: function ifLavaAhead(callback, blockID) {
      // if resurrected, move blockID be last parameter to fix "Show Code"
      appCodeOrgAPI.ifBlockAhead(studioApp().highlight.bind(studioApp(), blockID), "lava", 'Player', callback);
    },
    ifBlockAhead: function ifBlockAhead(blockType, callback, blockID) {
      appCodeOrgAPI.ifBlockAhead(studioApp().highlight.bind(studioApp(), blockID), blockType, 'Player', callback);
    },
    placeBlock: function placeBlock(blockType, blockID) {
      appCodeOrgAPI.placeBlock(studioApp().highlight.bind(studioApp(), blockID), blockType, 'Player');
    },
    plantCrop: function plantCrop(blockID) {
      appCodeOrgAPI.placeBlock(studioApp().highlight.bind(studioApp(), blockID), "cropWheat", 'Player');
    },
    placeTorch: function placeTorch(blockID) {
      appCodeOrgAPI.placeBlock(studioApp().highlight.bind(studioApp(), blockID), "torch", 'Player');
    },
    placeBlockAhead: function placeBlockAhead(blockType, blockID) {
      appCodeOrgAPI.placeInFront(studioApp().highlight.bind(studioApp(), blockID), blockType, 'Player');
    }
  }, { legacy: true });
...
var i18n = __webpack_require__(1953);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      props.showFinishButton && _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { id: 'rightButton', className: 'share mc-share-button' },
          _react2.default.createElement(
            'div',
            null,
            msg.finish()
...
module.exports = function anonymous(locals, escape, include, rethrow) {
    ...
    var __line = 1, __lines = '<% var i18n = require(\'../locale\'); %>\n<h1 class="minecraft-big-yellow-header" id="getting-started-header"><%= i18n.playerSelectLetsGetStarted() %></h1>\n\n<h2 id="select-character-text"><%= i18n.playerSelectChooseCharacter() %></h2>\n\n<div id="choose-character-container">\n  <div class="minecraft-character" id="choose-steve">\n    <h1 class="minecraft-big-yellow-header">Steve</h1>\n    <div class="character-portrait" id="steve-portrait"></div>\n    <div class="choose-character-button" id="choose-steve-select"><%= i18n.selectChooseButton() %></div>\n  </div>\n  <div class="minecraft-character" id="choose-alex">\n    <h1 class="minecraft-big-yellow-header">Alex</h1>\n    <div class="character-portrait" id="alex-portrait"></div>\n    <div class="choose-character-button" id="choose-alex-select"><%= i18n.selectChooseButton() %></div>\n  </div>\n</div>\n\n<div id="close-character-select"></div>\n', __filename = "src/craft/simple/dialogs/playerSelection.html.ejs";
    try {
        var __output = [], __append = __output.push.bind(__output);
        with (locals || {}) {
            var i18n = __webpack_require__(1953);
...
module.exports = function anonymous(locals, escape, include, rethrow) {
    ...
    try {
        ...
        with (locals || {}) {
            ...
            __append('\n<h1 class="minecraft-big-yellow-header" id="getting-started-header">');
            __line = 2;
            __append(escape(i18n.houseSelectLetsBuild()));
            __append('</h1>\n\n<h2 id="select-house-text">');
            __line = 4;
            __append(escape(i18n.houseSelectChooseFloorPlan()));
            __append('</h2>\n\n<div id="choose-house-container">\n  <div class="minecraft-house" id="choose-house-a">\n    <h1 class="minecraft-big-yellow-header">');
            __line = 8;
            __append(escape(i18n.houseSelectEasy()));
            __append('</h1>\n    <div class="house-outline-container">\n      <div class="house-photo" id="house-a-picture"></div>\n    </div>\n    <div class="choose-house-button">');
            __line = 12;
            __append(escape(i18n.selectChooseButton()));
            __append('</div>\n  </div>\n  <div class="minecraft-house" id="choose-house-b">\n    <h1 class="minecraft-big-yellow-header">');
            __line = 15;
            __append(escape(i18n.houseSelectMedium()));
            __append('</h1>\n    <div class="house-outline-container">\n      <div class="house-photo" id="house-b-picture"></div>\n    </div>\n    <div class="choose-house-button">');
            __line = 19;
            __append(escape(i18n.selectChooseButton()));
            __append('</div>\n  </div>\n  <div class="minecraft-house" id="choose-house-c">\n    <h1 class="minecraft-big-yellow-header">');
            __line = 22;
            __append(escape(i18n.houseSelectHard()));
            __append('</h1>\n    <div class="house-outline-container">\n      <div class="house-photo" id="house-c-picture"></div>\n    </div>\n    <div class="choose-house-button">');
            __line = 26;
            __append(escape(i18n.selectChooseButton()));
            __append('</div>\n  </div>\n</div>\n\n<div id="close-house-select"></div>\n');
...
module.exports = {
  custom: {
    requiredBlocks: [],
    freePlay: false,
    toolbox: (0, _block_utils.createToolbox)(moveForwardBlock + turnLeftBlock + turnRightBlock)
  }
};
...
var _locale = __webpack_require__(2130);
...
var _eventsLevelbuilderOverrides = __webpack_require__(3043);

var _eventsLevelbuilderOverrides2 = _interopRequireDefault(_eventsLevelbuilderOverrides);
...
var _CraftVisualizationColumn = __webpack_require__(3044);

var _CraftVisualizationColumn2 = _interopRequireDefault(_CraftVisualizationColumn);

var _blocks = __webpack_require__(2738);
...
var CHICKEN_ASSETS = [eventsCharacters.Chicken.staticAvatar, eventsCharacters.Chicken.smallStaticAvatar, eventsCharacters.Chicken.winAvatar, eventsCharacters.Chicken.failureAvatar];
var CHARACTER_ASSETS = [MEDIA_URL + "Events/Steve_Character_Select.png", MEDIA_URL + "Events/Alex_Character_Select.png", eventsCharacters.Steve.staticAvatar, eventsCharacters.Steve.smallStaticAvatar, eventsCharacters.Alex.staticAvatar, eventsCharacters.Alex.smallStaticAvatar];
var COMMON_UI_ASSETS = [MEDIA_URL + "Sliced_Parts/MC_Loading_Spinner.gif", MEDIA_URL + "Sliced_Parts/Frame_Large_Plus_Logo.png", MEDIA_URL + "Sliced_Parts/Pop_Up_Slice.png", MEDIA_URL + "Sliced_Parts/X_Button.png", MEDIA_URL + "Sliced_Parts/Button_Grey_Slice.png", MEDIA_URL + "Sliced_Parts/MC_Button_Pressed.png", MEDIA_URL + "Sliced_Parts/Run_Button_Up_Slice.png", MEDIA_URL + "Sliced_Parts/Run_Button_Down_Slice.png", MEDIA_URL + "Sliced_Parts/MC_Run_Arrow_Icon_Smaller.png", MEDIA_URL + "Sliced_Parts/MC_Up_Arrow_Icon.png", MEDIA_URL + "Sliced_Parts/MC_Down_Arrow_Icon.png", MEDIA_URL + "Sliced_Parts/Reset_Button_Up_Slice.png", MEDIA_URL + "Sliced_Parts/MC_Reset_Arrow_Icon.png", MEDIA_URL + "Sliced_Parts/Reset_Button_Down_Slice.png", MEDIA_URL + "Sliced_Parts/Callout_Tail.png"];
var interfaceImages = {
...
var MUSIC_METADATA = [{ volume: 1, hasOgg: true, name: "vignette1", group: 'day' }, { volume: 1, hasOgg: true, name: "vignette2-quiet", group: 'night' }, { volume: 1, hasOgg: true, name: "vignette3", group: 'night' }, { volume: 1, hasOgg: true, name: "vignette4-intro", group: 'day' }, { volume: 1, hasOgg: true, name: "vignette5-shortpiano", group: 'day' }, { volume: 1, hasOgg: true, name: "vignette7-funky-chirps-short", group: 'day' }, { volume: 1, hasOgg: true, name: "vignette8-free-play", group: 'day' }];

var CHARACTER_STEVE = 'Steve';
var CHARACTER_ALEX = 'Alex';
var DEFAULT_CHARACTER = CHARACTER_ALEX;
...
Craft.init = function (config) {
  ...
  if (config.level.useScore) {
    (0, _jquery2.default)('body').addClass("minecraft-scoring");
  }

  if (config.level.isEventLevel) {
    (0, _jquery2.default)('body').addClass("minecraft-events");
  }
  ...
  config.level.afterVideoBeforeInstructionsFn = function (showInstructions) {
    ...
    if (config.level.showPopupOnLoad) {
      if (config.level.showPopupOnLoad === 'playerSelection') {
        Craft.showPlayerSelectionPopup(function (selectedPlayer) {
          (0, _trackEvent2.default)('MinecraftDesigner', 'ChoseCharacter', selectedPlayer);
          Craft.clearPlayerState();
          trySetLocalStorageItem('craftSelectedPlayer', selectedPlayer);
          Craft.updateUIForCharacter(selectedPlayer);
          Craft.initializeAppLevel(config.level);
  ...
  if (config.level.puzzle_number && _eventsLevelbuilderOverrides2.default[config.level.puzzle_number]) {
    Object.assign(config.level, _eventsLevelbuilderOverrides2.default[config.level.puzzle_number]);
  }
  Craft.initialConfig = config;
  ...
  Craft.musicController = new _MusicController2.default(_Sounds2.default.getSingleton(), function (filename) {
    return config.skin.assetUrl('music/' + filename);
  }, levelTracks, config.level.dayNightCycleTime ? 100 : levelTracks.length > 1 ? 7500 : null);
  ...
  var character = config.level.usePlayer ? eventsCharacters[Craft.getCurrentCharacter()] : eventsCharacters['Chicken'];
  ...
  var onMount = function onMount() {
    (0, _StudioApp.singleton)().init(_extends({}, config, {
      ...
      afterInject: function afterInject() {
        ...
        Craft.gameController = new _GameController2.default({
          Phaser: window.Phaser,
          containerId: 'phaser-game',
          onScoreUpdate: config.level.useScore ? function (s) {
            return (0, _jquery2.default)('#score-number').text(s);
          } : null,
          assetRoot: Craft.skin.assetUrl(''),
          audioPlayer: {
            register: (0, _StudioApp.singleton)().registerAudio.bind((0, _StudioApp.singleton)()),
...
Craft.updateUIForCharacter = function (character) {
  var characters = eventsCharacters;
  Craft.initialConfig.skin.staticAvatar = characters[character].staticAvatar;
  Craft.initialConfig.skin.smallStaticAvatar = characters[character].smallStaticAvatar;
  Craft.initialConfig.skin.failureAvatar = characters[character].failureAvatar;
  Craft.initialConfig.skin.winAvatar = characters[character].winAvatar;
  (0, _StudioApp.singleton)().setIconsFromSkin(Craft.initialConfig.skin);
  (0, _jquery2.default)('#prompt-icon').attr('src', characters[character].smallStaticAvatar);
};
...
Craft.showPlayerSelectionPopup = function (onSelectedCallback) {
  var selectedPlayer = DEFAULT_CHARACTER;
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3045)({
    image: (0, _StudioApp.singleton)().assetUrl()
  });
  var popupDialog = (0, _StudioApp.singleton)().createModalDialog({
    contentDiv: popupDiv,
  ...
  _dom2.default.addClickTouchEvent((0, _jquery2.default)('#choose-steve')[0], function () {
    selectedPlayer = CHARACTER_STEVE;
    (0, _trackEvent2.default)('MinecraftDesigner', 'ClickedCharacter', selectedPlayer);
    popupDialog.hide();
  }.bind(this));
  _dom2.default.addClickTouchEvent((0, _jquery2.default)('#choose-alex')[0], function () {
    selectedPlayer = CHARACTER_ALEX;
...
Craft.initializeAppLevel = function (levelConfig) {
  ...
  var doNotShowPlayer = levelConfig.usePlayer === false;

  Craft.gameController.loadLevel({
    onDayCallback: function onDayCallback() {
      Craft.musicController.setGroup('day');
      Craft.musicController.fadeOut();
    },
    onNightCallback: function onNightCallback() {
...
Craft.minAssetsForLevelWithCharacter = function (levelNumber) {
  var extraAssets = levelNumber >= FIRST_CHARACTER_LEVEL ? [Craft.characterAssetPackName(Craft.getCurrentCharacter())] : [];
...
Craft.hideSoftButtons = function () {
  (0, _jquery2.default)('#soft-buttons').hide();
  (0, _StudioApp.singleton)().resizePinnedBelowVisualizationArea();
};

Craft.showSoftButtons = function () {
  (0, _jquery2.default)('#soft-buttons').show();
  (0, _StudioApp.singleton)().resizePinnedBelowVisualizationArea();
};
...
Craft.executeUserCode = function () {
  ...
  var code = Blockly.Generator.blocksToCode('JavaScript', codeBlocks);

  var evalApiMethods = {
    moveForward: function moveForward(blockID) {
      appCodeOrgAPI.moveForward((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID));
    },
    onEventTriggered: function onEventTriggered(type, eventType, callback, blockID) {
      appCodeOrgAPI.registerEventCallback((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), function (event) {
    ...
    onGlobalEventTriggered: function onGlobalEventTriggered(eventType, callback, blockID) {
      appCodeOrgAPI.registerEventCallback((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), function (event) {
        if (event.eventType !== eventType) {
          return;
        }
    ...
    drop: function drop(blockType, targetEntity, blockID) {
      appCodeOrgAPI.drop((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), blockType, targetEntity);
    },
    turnLeft: function turnLeft(blockID) {
      appCodeOrgAPI.turn((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), "left");
    },
    turnRight: function turnRight(blockID) {
      appCodeOrgAPI.turn((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), "right");
    },
    destroyBlock: function destroyBlock(blockID) {
      appCodeOrgAPI.destroyBlock((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID));
    },
    repeat: function repeat(blockID, callback, iterations, targetEntity) {
      // if resurrected, move blockID be last parameter to fix "Show Code"
      appCodeOrgAPI.repeat((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), callback, iterations, targetEntity);
    },
    repeatRandom: function repeatRandom(blockID, callback, targetEntity) {
      // if resurrected, move blockID be last parameter to fix "Show Code"
      appCodeOrgAPI.repeatRandom((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), callback, targetEntity);
    },
    playSound: function playSound(soundID, targetEntity, blockID) {
      appCodeOrgAPI.playSound((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), soundID, targetEntity);
    },
    addScore: function addScore(scoreAmount, blockID) {
      appCodeOrgAPI.addScore((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), parseInt(scoreAmount));
    },
    moveDirection: function moveDirection(direction, targetEntity, blockID) {
      var dirStringToDirection = {
        up: _FacingDirection2.default.North,
    ...
    spawnEntity: function spawnEntity(type, direction, blockID) {
      appCodeOrgAPI.spawnEntity((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), type, direction);
    },
    wait: function wait(time, targetEntity, blockID) {
      var randomMin = .1;
      var randomMax = 3;
      appCodeOrgAPI.wait((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), time === 'random' ? _lodash2.default.random(randomMin, randomMax, true) : time, targetEntity);
    },
    spawnEntityRandom: function spawnEntityRandom(type, blockID) {
      var locationOptions = ['up', 'middle', 'right', 'down', 'left'];
      var randomDirection = _lodash2.default.sample(locationOptions);

      appCodeOrgAPI.spawnEntity((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), type, randomDirection);
    }
  };

  _blocks.ENTITY_ACTION_BLOCKS.concat(['turnLeft', 'turnRight', 'turnRandom']).forEach(function (methodName) {
    evalApiMethods[methodName] = function (targetEntity, blockID) {
      appCodeOrgAPI[methodName]((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), targetEntity);
    };
  });

  _blocks.ENTITY_TARGET_ACTION_BLOCKS.forEach(function (methodName) {
    evalApiMethods[methodName] = function (targetEntity, moveTo, blockID) {
      appCodeOrgAPI[methodName]((0, _StudioApp.singleton)().highlight.bind((0, _StudioApp.singleton)(), blockID), targetEntity, moveTo);
    };
  });

  _CustomMarshalingInterpreter2.default.evalWith(code, evalApiMethods, { legacy: true });
  ...
  if (Craft.initialConfig.level.dayNightCycleTime) {
    appCodeOrgAPI.setDayNightCycle(Craft.initialConfig.level.dayNightCycleStart, Craft.initialConfig.level.dayNightCycleTime || 0, Craft.initialConfig.level.isDaytime ? 'night' : 'day');
  }
};
...
module.exports = {
  ...
  8: {
    songs: ['vignette5-shortpiano', 'vignette1', 'vignette4-intro', 'vignette2-quiet', 'vignette3']
  },
  9: {
    songs: ['vignette5-shortpiano', 'vignette7-funky-chirps-short', 'vignette4-intro', 'vignette1']

  },
  10: {
    songs: ['vignette4-intro', 'vignette5-shortpiano', 'vignette7-funky-chirps-short', 'vignette2-quiet', 'vignette3']
  }
};
...
var _locale3 = __webpack_require__(2130);
...
var CraftVisualizationColumn = function (_React$Component) {
  _inherits(CraftVisualizationColumn, _React$Component);

  function CraftVisualizationColumn() {
    _classCallCheck(this, CraftVisualizationColumn);

    return _possibleConstructorReturn(this, _React$Component.apply(this, arguments));
  }

  CraftVisualizationColumn.prototype.render = function render() {
    return _react2.default.createElement(
      'span',
      null,
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { id: 'minecraft-frame' },
          _react2.default.createElement('div', { id: 'phaser-game' }),
          this.props.showScore && _react2.default.createElement(
            'div',
            { id: 'score-container' },
            _react2.default.createElement(
              'div',
      ...
      _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_ArrowButtons2.default, null),
        this.props.showFinishButton && _react2.default.createElement(
          'div',
          { id: 'right-button-cell' },
          _react2.default.createElement(
            'button',
  ...
  return CraftVisualizationColumn;
}(_react2.default.Component);

CraftVisualizationColumn.propTypes = {
  showFinishButton: _react.PropTypes.bool.isRequired,
  showScore: _react.PropTypes.bool.isRequired
};
exports.default = CraftVisualizationColumn;
module.exports = exports['default'];
...
module.exports = function anonymous(locals, escape, include, rethrow) {
    ...
    var __line = 1, __lines = '<% var i18n = require(\'../locale\'); %>\n<h1 style="color: #e7e8ea; margin-bottom: 23px;" class="minecraft-big-yellow-header" id="getting-started-header"><%= i18n.playerSelectChooseCharacter() %></h1>\n\n<!--<h2 id="select-character-text"><%= i18n.playerSelectChooseCharacter() %></h2>-->\n\n<div id="choose-character-container">\n  <div class="minecraft-character" id="choose-alex">\n    <h1 class="minecraft-big-yellow-header">Alex</h1>\n    <div class="character-portrait" id="alex-portrait"></div>\n    <div class="choose-character-button" id="choose-alex-select"><%= i18n.selectChooseButton() %></div>\n  </div>\n  <div class="minecraft-character" id="choose-steve">\n    <h1 class="minecraft-big-yellow-header">Steve</h1>\n    <div class="character-portrait" id="steve-portrait"></div>\n    <div class="choose-character-button" id="choose-steve-select"><%= i18n.selectChooseButton() %></div>\n  </div>\n</div>\n\n<div id="close-character-select"></div>\n', __filename = "src/craft/designer/dialogs/playerSelection.html.ejs";
    try {
        var __output = [], __append = __output.push.bind(__output);
        with (locals || {}) {
            var i18n = __webpack_require__(2130);
            __append('\n<h1 style="color: #e7e8ea; margin-bottom: 23px;" class="minecraft-big-yellow-header" id="getting-started-header">');
            __line = 2;
            __append(escape(i18n.playerSelectChooseCharacter()));
            __append('</h1>\n\n<!--<h2 id="select-character-text">');
            __line = 4;
...
exports.executeUserCode = undefined;
...
var _CraftVisualizationColumn = __webpack_require__(3049);

var _CraftVisualizationColumn2 = _interopRequireDefault(_CraftVisualizationColumn);

var _ccClient = __webpack_require__(3050);

var _ccClient2 = _interopRequireDefault(_ccClient);

var _dom = __webpack_require__(594);

var _dom2 = _interopRequireDefault(_dom);

var _items = __webpack_require__(2888);
...
var client = new _ccClient2.default(8080);
...
var executeUserCode = exports.executeUserCode = function executeUserCode(client, code) {
  ...
  function createAsyncRequestBlock(blockID, commandName, resultKey, inputPairs, callback) {
    ...
    (0, _StudioApp.singleton)().highlight(blockID);
    var keys = Object.keys(inputPairs);
    var keyValuePairs = [];
    // Create array of key=value
    keys.forEach(function (key) {
      var value = inputPairs[key];
      if (value !== null) {
    ...
    client.async_command(command, function (result) {
      ...
      callback(result);
      if ((0, _StudioApp.singleton)().isRunning() === true) {
        interpreter.run();
      }
    }, resultKey);
  }
  ...
  var asyncMethods = {
    ...
    executeasother: function executeasother(blockID, origin, position, command, callback) {
      createAsyncRequestBlock(blockID, 'executeasother', 'success', { 'origin': origin, 'position': position, 'command': command }, callback);
    },
    executedetect: function executedetect(blockID, origin, position, detectBlock, detectData, detectPos, command, callback) {
    ...
    clonefiltered: function clonefiltered(blockID, begin, end, destination, cloneMode, item, callback) {
  ...
  var methods = {
    item: function item(blockID, name, data) {
      (0, _StudioApp.singleton)().highlight(blockID);
      return { 'name': name, 'data': data };
    },
    createBlockPos: function createBlockPos(x, y, z, prefix) {
      return encodeURIComponent('' + prefix + x + ' ' + prefix + y + ' ' + prefix + z);
    },
    createBlockPosFromVec3: function createBlockPosFromVec3(vec3, prefix) {
      return encodeURIComponent('' + prefix + vec3.x + ' ' + prefix + vec3.y + ' ' + prefix + vec3.z);
    },
    getVec3: function getVec3(x, y, z) {
      return { 'x': '' + x, 'y': '' + y, 'z': '' + z };
    }
  };

  // Register async methods
  interpreter = _CustomMarshalingInterpreter2.default.evalWith(code, _extends({}, asyncMethods, methods), { asyncFunctionList: Object.values(asyncMethods) });
};
...
var Craft = function () {
  ...
  Craft.init = function init(config) {
    ...
    // Replace studioApp methods with our own.
    (0, _StudioApp.singleton)().reset = Craft.reset;
    (0, _StudioApp.singleton)().runButtonClick = Craft.runButtonClick;
  ...
  Craft.render = function render(config) {
    var onMount = function onMount() {
      (0, _StudioApp.singleton)().init(_extends({
        enableShowCode: false
      }, config));

      var itemTypeKeys = Object.keys(_items2.default);
      itemTypeKeys.forEach(function (itemType) {
        _items2.default[itemType].forEach(function (item) {
          preloadImage(item[0]);
        });
      });
    ...
    _reactDom2.default.render(_react2.default.createElement(
      ...
      { store: (0, _redux.getStore)() },
      _react2.default.createElement(_AppView2.default, {
        visualizationColumn: _react2.default.createElement(_CraftVisualizationColumn2.default, { showScore: !!config.level.useScore }),
        onMount: onMount
      })
    ), document.getElementById(config.containerId));
  };
...
Craft.showConnectToCodeConnectionPopup = function () {
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3051)({
    image: (0, _StudioApp.singleton)().assetUrl()
  });
  var popupDialog = (0, _StudioApp.singleton)().createModalDialog({
    contentDiv: popupDiv,
  ...
  _dom2.default.addClickTouchEvent(document.getElementById('download-button'), function () {
    var win = window.open('https://education.minecraft.net/get-started/download', '_blank');
    win.focus();
    popupDialog.hide();
  }.bind(this));
  _dom2.default.addClickTouchEvent(document.getElementById('close-popup'), function () {
    popupDialog.hide();
  }.bind(this));
  popupDialog.show();
};

Craft.showImportFromShareLinkPopup = function (callback) {
  var shareLink = void 0;
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3052)();
  var popupDialog = (0, _StudioApp.singleton)().createModalDialog({
    contentDiv: popupDiv,
    onHidden: function onHidden() {
      callback(shareLink);
  ...
  _dom2.default.addClickTouchEvent(document.getElementById('import-button'), function () {
  ...
  _dom2.default.addClickTouchEvent(document.getElementById('cancel-button'), function () {
    popupDialog.hide();
  });
  popupDialog.show();
};

Craft.showErrorMessagePopup = function (title, message) {
  var popupDiv = document.createElement('div');
  popupDiv.innerHTML = __webpack_require__(3053)({
    title: title,
    message: message
  });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'minecraft-frame' },
          _react2.default.createElement('div', { id: 'code-connection-log' })
        )
      ),
      _react2.default.createElement(_GameButtons2.default, null),
      _react2.default.createElement(_BelowVisualization2.default, null)
    );
  };
...
var cc_client = function () {
  function cc_client(port) {
    ...
    if (window.ipcRenderer !== undefined) {
      window.ipcRenderer.on('responseFromApp', function (event, jsonResponse) {
        var response = JSON.parse(jsonResponse);
        if (response.api === 'basic') {
          if (_this.keyRef !== null) {
            _this.callbackRef(response[_this.keyRef]);
          } else {
            _this.callbackRef();
          }
        }
  ...
  cc_client.prototype.connectionStatusUpdate = function connectionStatusUpdate(asyncCallback) {
  ...
  cc_client.prototype.async_command = function async_command(command, callback, key) {
    //before ajax
    if (window.ipcRenderer !== undefined) {
...
module.exports = function anonymous(locals, escape, include, rethrow) {
    ...
    try {
        ...
        with (locals || {}) {
            ...
            __line = 2;
            __append(escape(i18n.importShareLinkHeader()));
            __append("</h1>\n\n<h2>");
            __line = 4;
            __append(escape(i18n.importShareLinkBody()));
            __append('</h2>\n\n<input type="text" id="share-link" placeholder="Example: https://studio.code.org/c/999999999" />\n<div class="button" id="import-button">');
            __line = 7;
            __append(escape(i18n.import()));
            __append('</div>\n\n<br />\n\n<div class="button" id="cancel-button">');
            __line = 11;
            __append(escape(i18n.cancel()));
            __append('</div>\n\n<div id="close-popup"></div>\n');
            __line = 14;
        }
        return __output.join("");
...
module.exports = function anonymous(locals, escape, include, rethrow) {
    ...
    var __line = 1, __lines = '<h1 class="minecraft-big-yellow-header" id="error-message"><%= title %></h1>\n\n<h2><%= message %></h2>\n\n<div id="close-popup"></div>\n', __filename = "src/craft/code-connection/dialogs/errorMessage.html.ejs";
    try {
        var __output = [], __append = __output.push.bind(__output);
        with (locals || {}) {
            __append('<h1 class="minecraft-big-yellow-header" id="error-message">');
...
module.exports = {
  custom: {
    ...
    toolbox: (0, _block_utils.createToolbox)(category('Agent', craftBlock('move') + craftBlock('turn') + craftBlock('tptoplayer') + craftBlock('place', "<value name='SLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>") + craftBlock('destroy') + craftBlock('till') + craftBlock('attack') + craftBlock('collect', "<value name='ITEM'>" + craftBlock('block') + "</value>") + craftBlock('collectall') + craftBlock('drop', "<value name='SLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>\n                            <value name='QUANTITY'><block type=\"math_number\"><title name='NUM'>1</title></block></value>") + craftBlock('dropall') + craftBlock('detect') + craftBlock('inspect') + craftBlock('inspectdata') + craftBlock('getitemdetail', "<value name='SLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>") + craftBlock('getitemspace', "<value name='SLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>") + craftBlock('getitemcount', "<value name='SLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>") + craftBlock('transfer', "<value name='SRCSLOTNUM'><block type=\"math_number\"><title name='NUM'>0</title></block></value>\n                                <value name='DSTSLOTNUM'><block type=\"math_number\"><title name='NUM'>1</title></block></value>\n                                <value name='QUANTITY'><block type=\"math_number\"><title name='NUM'>1</title></block></value>") + craftBlock('detectredstone')) + category('Item', craftBlock('block') + craftBlock('miscellaneous') + craftBlock('tool') + craftBlock('decoration') + craftBlock('getnameof', "<value name='ITEM'>" + craftBlock('block') + "</value>") + craftBlock('getdataof', "<value name='ITEM'>" + craftBlock('block') + "</value>") + craftBlock('createblock', "<value name='BLOCKTYPE'>" + craftBlock('block') + "</value>\n                                     <value name='BLOCKDATA'>" + craftBlock('block') + "</value>")) + category('Blocks', craftBlock('tptotarget') + craftBlock('tptopos', "<value name='VEC3'>" + vecThree(1, 1, 1) + "</value>") + craftBlock('fill', "<value name='ITEM'>" + craftBlock('block') + "</value>\n                            <value name='FROM_VEC3'>" + vecThree(1, 1, 1) + "</value>\n                            <value name='TO_VEC3'>" + vecThree(5, 5, 5) + "</value>") + craftBlock('give', "<value name='ITEM'>" + craftBlock('block') + "</value>\n                            <value name='AMOUNT'><block type=\"math_number\"><title name='NUM'>10</title></block></value>") + craftBlock('kill') + craftBlock('setblock', "<value name='ITEM'>" + craftBlock('block') + "</value>\n                               <value name='VEC3'>" + vecThree(1, 1, 1) + "</value>") + craftBlock('summon', "<value name='VEC3'>" + vecThree(1, 1, 1) + "</value>") + craftBlock('testforblock', "<value name='ITEM'>" + craftBlock('block') + "</value>\n                                    <value name='VEC3'>" + vecThree(1, 1, 1) + "</value>") + craftBlock('testforblocks', "<value name='FROM_VEC3'>" + vecThree(1, 1, 1) + "</value>\n                                     <value name='TO_VEC3'>" + vecThree(5, 5, 5) + "</value>\n                                     <value name='VEC3'>" + vecThree(10, 10, 10) + "</value>") + craftBlock('clone', "<value name='FROM_VEC3'>" + vecThree(1, 1, 1) + "</value>\n                             <value name='TO_VEC3'>" + vecThree(5, 5, 5) + "</value>\n                             <value name='VEC3'>" + vecThree(10, 10, 10) + "</value>") + craftBlock('clonefiltered', "<value name='ITEM'>" + craftBlock('block') + "</value>\n                                     <value name='FROM_VEC3'>" + vecThree(1, 1, 1) + "</value>\n                                     <value name='TO_VEC3'>" + vecThree(5, 5, 5) + "</value>\n                                     <value name='VEC3'>" + vecThree(10, 10, 10) + "</value>") + craftBlock('executeasother', "<value name='VEC3'>" + vecThree(1, 1, 1) + "</value>") + craftBlock('timesetbyname') + craftBlock('timesetbynumber', "<value name='TIME'><block type=\"math_number\"><title name='NUM'>1200</title></block></value>") + craftBlock('weather')) + category('Logic', block('logic_compare') + block('logic_operation') + block('logic_negate') + block('logic_boolean') + block('text')) + category('Control', block('controls_if') + block('controls_if', "<mutation else='1'></mutation>") + block('controls_for') + block('controls_whileUntil') + block('controls_repeat_ext', "<value name='TIMES'>" + block('math_number', '<field name="NUM">10</field>') + "</value>") + craftBlock('wait')) + category('Variables', "", 'custom="VARIABLE"') + category('Functions', "", 'custom="PROCEDURE"') + category('Math', block('math_number') + block('math_arithmetic') + craftBlock('vecThree', "<value name='X'><block type=\"math_number\"><title name='NUM'>0</title></block></value>\n                                <value name='Y'><block type=\"math_number\"><title name='NUM'>0</title></block></value>\n                                <value name='Z'><block type=\"math_number\"><title name='NUM'>0</title></block></value>") + block('math_random_int', "<value name='FROM'>" + block('math_number', '<field name="FROM">1</field>') + "</value>" + ("<value name='TO'>" + block('math_number', '<field name="TO">10</field>') + "</value>"))))
  }
};

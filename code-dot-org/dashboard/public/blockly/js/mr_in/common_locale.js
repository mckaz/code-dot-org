...
"booleanTrue":function(d){return "बरोबर"},
...
"challengeLevelPassText":function(d){return "However, you could've done it with only "+common_locale.p(d,"idealBlocks",0,"mr",{"one":"1 block","other":common_locale.n(d,"idealBlocks")+" blocks"})+". Can you make your program even better?"},
...
"dropletBlock_return_signatureOverride":function(d){return "परत करा"},
...
"exactNumberOfBlocks":function(d){return "Only "+common_locale.p(d,"numBlocks",0,"mr",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"fewerNumberOfBlocks":function(d){return "Fewer than "+common_locale.p(d,"numBlocks",0,"mr",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+" used!"},
...
"joinText":function(d){return "जोडा"},
...
"manageStudentsNotificationCannotAdd":function(d){return "You could not add "+common_locale.p(d,"numStudents",0,"mr",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section. Please try again or refresh the page."},
"manageStudentsNotificationAddSuccess":function(d){return "You added "+common_locale.p(d,"numStudents",0,"mr",{"one":"1 student","other":common_locale.n(d,"numStudents")+" students"})+" to your section."},
...
"nPoints":function(d){return common_locale.p(d,"numPoints",0,"mr",{"one":"1 point","other":common_locale.n(d,"numPoints")+" points"})},
...
"repeat":function(d){return "पुन्हा करा"},
...
"student":function(d){return "विध्यार्थी"},

...
"collect":function(d){return "apañar"},
"collectiblePresent":function(d){return "hai algún tesouro"},
"collectorCollectTooltip":function(d){return "Apaña un obxecto"},
"collectorCollectedEverything":function(d){return "Parabéns, apañaches "+maze_locale.p(d,"count",0,"gl",{"one":"the item","other":"os "+maze_locale.n(d,"count")+" obxectos"})+"!"},
"collectorCollectedNothing":function(d){return "Continúa facendo código! Cómpre apañar tantos obxectos como poidas."},
"collectorCollectedSome":function(d){return "Ben feito! Apañaches "+maze_locale.p(d,"count",0,"gl",{"one":"1 item","other":maze_locale.n(d,"count")+" obxectos"})+"."},
"collectorCollectedNotEnough":function(d){return "Continúa facendo código! Cómpreche apañar cando menos "+maze_locale.p(d,"goal",0,"gl",{"one":"1 item","other":maze_locale.n(d,"goal")+" obxectos"})+"."},
"collectorCollectedTooMany":function(d){return "O espazo non ten pezas suficientes para que as apañe."},
"collectorTooManyBlocks":function(d){return "Só podes usar "+maze_locale.v(d,"blockLimit")+" pezas. Repasa o teu código e volve intentalo!"},
"continue":function(d){return "Continuar"},
"corn":function(d){return "millo"},
"cornTooltip":function(d){return "Apaña o millo"},
"didNotCollectAllCrops":function(d){return "Asegúrate de non deixares algo sen apañar!"},
"didNotCollectEverything":function(d){return "Asegúrate de non deixares néctar ou mel sen apañar!"},
"didNotPlantEverywhere":function(d){return "Asegúrate de plantares algo en cada área de cultivo!"},
...
"emptyCropError":function(d){return "Esa colleita derramouse."},
...
"goal":function(d){return "obxectivo"},
"has":function(d){return "ten"},
"haslettuce":function(d){return "hai leituga"},
"hascorn":function(d){return "hai millo"},
"haspumpkin":function(d){return "hai cabazas"},
...
"lettuce":function(d){return "leituga"},
"lettuceTooltip":function(d){return "Apaña un pouco de leituga"},
...
"pick":function(d){return "apaña"},
"pilePresent":function(d){return "hai un monte"},
"plant":function(d){return "planta"},
"plantInNonSoilError":function(d){return "Só podo plantar algo en terra fresca."},
"plantTooltip":function(d){return "Planta un brote"},
"pumpkin":function(d){return "cabaza"},
"pumpkinTooltip":function(d){return "Apaña unha cabaza"},
...
"wrongCropError":function(d){return "Non podo colleitar dende aquí."},

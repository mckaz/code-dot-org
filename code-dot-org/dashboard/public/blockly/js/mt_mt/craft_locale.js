...
"absolute":function(d){return "assolut"},
...
"agentDiamondPathCongrats":function(d){return "Congratulations, you found the diamond path! You have collected "+craft_locale.p(d,"count",0,"mt",{"one":"1 diamond","other":craft_locale.n(d,"count")+" diamonds"})+" so far!"},
...
"blockActionRepeat":function(d){return "Irrepeti"},

...
"jumpNortheastTooltip":function(d){return "Mută artistul la nord-est fără a lăsa urme."},
"jumpNorthwestTooltip":function(d){return "Mută artistul la nord-vest fără a lăsa urme."},
"jumpSouthTooltip":function(d){return "Mută artistul la sud fără a lăsa urme."},
"jumpSoutheastTooltip":function(d){return "Mută artistul la sud-est fără a lăsa urme."},
"jumpSouthwestTooltip":function(d){return "Mută artistul la sud-vest fără a lăsa urme."},
...
"moveNortheastTooltip":function(d){return "Mută artistul la nord-est."},
"moveNorthwestTooltip":function(d){return "Mută artistul la nord-vest."},
"moveSouthTooltip":function(d){return "Mută artistul la sud."},
"moveSoutheastTooltip":function(d){return "Mută artistul la sud-est."},
"moveSouthwestTooltip":function(d){return "Mută artistul la sud-vest."},
...
"setCharacter":function(d){return "setează caracterul pentru a "+turtle_locale.v(d,"character")},

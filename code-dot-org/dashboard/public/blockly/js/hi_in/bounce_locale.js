...
"basketballLaunchBall":function(d){return "नई गेंद फेंकें"},
"basketballLaunchBallTooltip":function(d){return "खेल में एक गेंद फेंको"},
"basketballSetPaddle":function(d){return "सेट हाथ"},
"basketballSetPaddleSpeedFast":function(d){return "तेज गति की गति सेट करें"},
"basketballSetPaddleSpeedNormal":function(d){return "सामान्य हाथ की गति सेट करें"},
"basketballSetPaddleSpeedRandom":function(d){return "यादृच्छिक हाथ की गति सेट करें"},
"basketballSetPaddleSpeedSlow":function(d){return "धीमी गति की गति सेट करें"},
"basketballSetPaddleSpeedTooltip":function(d){return "हाथ की गति सेट करता है"},
"basketballSetPaddleSpeedVeryFast":function(d){return "बहुत तेज हाथ की गति सेट करें"},
"basketballSetPaddleSpeedVerySlow":function(d){return "बहुत धीमी गति गति सेट करें"},
"basketballWhenBallMissesPaddle":function(d){return "जब गेंद को हाथ याद होता है"},
"basketballWhenPaddleCollided":function(d){return "जब गेंद हिट हाथ"},
...
"ifPathAhead":function(d){return "यदि पथ आगे"},
...
"no":function(d){return "नहीं"},
"noPathAhead":function(d){return "पथ अवरोधित है"},
"noPathLeft":function(d){return "बाईं ओर करने के लिए कोई पथ"},
"noPathRight":function(d){return "सही करने के लिए कोई पथ"},
"numBlocksNeeded":function(d){return "This puzzle can be solved with %1 blocks."},
"pathAhead":function(d){return "आगे पथ"},
"pathLeft":function(d){return "यदि छोड़ दिया करने के लिए पथ"},
"pathRight":function(d){return "यदि पथ सही करने के लिए"},
"pilePresent":function(d){return "वहाँ एक ढेर है"},
"playSoundBounce":function(d){return "उछलने की ध्वनि चले"},
"playSoundCheer":function(d){return "जय जयकार बजाओ"},
...
"playSoundKick":function(d){return "किक ध्वनि खेलते हैं"},
...
"playSoundSlapshot":function(d){return "स्लैपशॉट ध्वनि प्ले करें"},
"playSoundSwish":function(d){return "नेट स्विश ध्वनि खेलते हैं"},
"playSoundTooltip":function(d){return "चुनिंदा ध्वनि बजाए"},
"playSoundWhistle":function(d){return "सीटी ध्वनि खेलते हैं"},
...
"setBackground":function(d){return "सेट "+bounce_locale.v(d,"background")+" दृश्य"},
...
"setBall":function(d){return "सेट करें "+bounce_locale.v(d,"ball")+" गेंद"},
...
"setPaddle":function(d){return "चप्पू सेट"},
...
"setPlayerSpeedFast":function(d){return "तेजी से खिलाड़ी गति सेट"},
"setPlayerSpeedNormal":function(d){return "सामान्य खिलाड़ी गति सेट"},
"setPlayerSpeedRandom":function(d){return "यादृच्छिक खिलाड़ी गति सेट"},
"setPlayerSpeedSlow":function(d){return "धीमी गति से खिलाड़ी गति सेट"},
"setPlayerSpeedTooltip":function(d){return "खिलाड़ी की गति सेट"},
"setPlayerSpeedVeryFast":function(d){return "बहुत तेजी से खिलाड़ी गति सेट"},
"setPlayerSpeedVerySlow":function(d){return "बहुत ही धीमी गति से खिलाड़ी गति सेट"},
"setTeamTooltip":function(d){return "लोगो और रंग योजना सेट करता है"},
"setTeam":function(d){return "सेट करें टीम "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "सेट टीम यादृच्छिक"},
"shareBounceTwitter":function(d){return "मेरा बनाया गया उछाल का खेल देखे।मैने खुद @codeorg से लिखा है"},
"shareBounceTwitterDonor":function(d){return "मेरे बाउंस गेम को देखिये। (@codeorg के समर्थन के लिए "+bounce_locale.v(d,"donor")+" को धन्यवाद।)"},
"shareGame":function(d){return "Share your game:"},
"turnLeft":function(d){return "बाएँ मुड़ें"},
"turnRight":function(d){return "दाएँ मुड़ें"},
...
"whenBallMissesPlayer":function(d){return "जब गेंद खिलाड़ी याद करते हैं"},
...
"whenPlayerCollided":function(d){return "जब खिलाड़ी गेंद हिट"},
"whenPlayerCollidedTooltip":function(d){return "जब एक गेंद के साथ खिलाड़ी टकराया नीचे कार्रवाई निष्पादित करें।"},

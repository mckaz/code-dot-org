...
"actions":function(d){return "Izenzo"},
...
"backToPreviousLevel":function(d){return "Buyela esigabeni esedlule"},
...
"catLists":function(d){return "Umbhalo olandelanayo"},
...
"choosePrefix":function(d){return "Khetha..."},
"clearPuzzle":function(d){return "Qala phansi"},
...
"clearPuzzleConfirmHeader":function(d){return "Ingabe uqinisekile ufuna ukuqala phansi?"},
...
"copy":function(d){return "Kopisha"},
...
"currentVersion":function(d){return "Uhlobo olukhona"},
...
"debugWatchHeader":function(d){return "Bukela"},
"debugWatchNotAvailable":function(d){return "akukho"},
...
"designMode":function(d){return "Bumba, khombisa ngokudweba umbono noma isixazululo sakho"},
"dialogCancel":function(d){return "Hoxisa"},
"dialogConfirmEmail":function(d){return "Confirm email"},
"dialogOK":function(d){return "Kulungile"},
...
"dropletBlock_comment_description":function(d){return "Bhala incazelo yamanye amakhodi"},
"dropletBlock_comment_signatureOverride":function(d){return "yisho uvo lwakho"},
...
"dropletBlock_greaterThanOrEqualOperator_description":function(d){return "Vivinya ukuthi ngabe leli nani likhulu noma liyalingana naleli elinye inani. Buyisa ngokuliqiniso ukuthi ngabe lelinani elingase sandleni sokunxele esibalweni likhulu noma liyalingana naleli elisesibalweni esandleni sokudla."},
...
"dropletBlock_lessThanOrEqualOperator_description":function(d){return "Vivinya ukuthi ngabe leli nani lincane noma liyalingana naleli elinye inani.Buyisa ngokuliqiniso ukuthi ngabe leli nani elisesandleni sokunxele esibalweni lincane noma liyalingana naleli elisesibalweni esandleni sokudla"},
...
"end":function(d){return "ekugcineni"},
...
"errorEmptyFunctionBlockModal":function(d){return "Izinombolo eziguquguqukayo."},
...
"errorIncompleteBlockInFunction":function(d){return "indlela yokwenza umdlalo obukwa kumabonakude,kusetshenziswe imidwebo noma izithombe."},
...
"hideToolbox":function(d){return "(fihla)"},
"hintHeader":function(d){return "Naku engingakucebisa ngako:"},
...
"homepageUiTipsAfterDialogCancel":function(d){return "Qeda"},
...
"infinity":function(d){return "Akugcini noma utalagu"},
...
"keepPlaying":function(d){return "Qhubeka nokudlala"},
...
"ok":function(d){return "Kulungile"},
...
"projectGroupMath":function(d){return "Izibalo"},
...
"projectTypeInfinity":function(d){return "Akugcini noma utalagu"},
...
"print":function(d){return "Khiphela ephepheni"},
"projectWarning":function(d){return "Qaphela: Ususesigabeni esiyinxenye ende yomsebenzi. Ushintsho olwenzeke kulesigaba luzophinde luvele futhi ezigabeni ezilandelayo zomsebenzi."},
...
"replayButton":function(d){return "Phinda udlale"},
...
"runProgram":function(d){return "Gijima"},
...
"sendToPhone":function(d){return "Thumela kumakhalekhukwini"},
...
"showVersionsHeader":function(d){return "Umlando waloluhlobo"},
...
"startOver":function(d){return "Qala phansi"},
"startOverTitle":function(d){return "Ingabe uqinisekile ufuna ukuqala phansi?"},
...
"submitYourProject":function(d){return "Hambisa umsebenzi"},
"submitYourProjectConfirm":function(d){return "Awukwazi ukubhala kabusha umsebenzi emva kokuwuhambisa, engabe ngempela ufuna ukuwuhambisa?"},
...
"text":function(d){return "Umbhalo"},
...
"watchVideo":function(d){return "Bukela umbukiswano"},
"when":function(d){return "nini"},
...
"workspaceHeaderShort":function(d){return "indawo yokusebenzela: "},

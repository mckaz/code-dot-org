...
"jumpNortheastTooltip":function(d){return "Премества художника североизточно без да оставя следи."},
"jumpNorthwestTooltip":function(d){return "Премества художника северозападно без да оставя следи."},
"jumpSouthTooltip":function(d){return "Премества художника на изток без да оставя следи."},
"jumpSoutheastTooltip":function(d){return "Премества художника югоизточно без да оставя следи."},
"jumpSouthwestTooltip":function(d){return "Премества на художника на югозапад без да оставя следи."},
...
"moveNortheastTooltip":function(d){return "Премества художника на североизток."},
"moveNorthwestTooltip":function(d){return "Премества художника на северозапад."},
"moveSouthTooltip":function(d){return "Премества художника на юг."},
"moveSoutheastTooltip":function(d){return "Премества художника на югоизток."},
"moveSouthwestTooltip":function(d){return "Премества художника на югозапад."},
...
"setCharacter":function(d){return "задай знак за "+turtle_locale.v(d,"character")},

...
"absolute":function(d){return "ایبسولیوٹ (مطلق)"},
...
"agentDiamondPathCongrats":function(d){return "Congratulations, you found the diamond path! You have collected "+craft_locale.p(d,"count",0,"ur",{"one":"1 diamond","other":craft_locale.n(d,"count")+" diamonds"})+" so far!"},
"blockActionAdd":function(d){return "جمع"},
...
"blockActionMoveForward":function(d){return "آگے چلیں"},
...
"blockActionRepeat":function(d){return "دوبارہ"},
...
"blockDestroyBlock":function(d){return "بلاک کو تباہ کريں"},
...
"blockMoveBackward":function(d){return "پیچھے چلیں"},
"blockMoveForward":function(d){return "آگے چلیں"},
"blockPlace":function(d){return "جگہ"},
...
"blockTillSoil":function(d){return "کھيتی کاشت کریں"},
...
"blockTypeClay":function(d){return "مٹی"},
...
"blockTypeOreCoal":function(d){return "کوئلےکی دھات"},
"blockTypeOreDiamond":function(d){return "ہیرے کی دھات"},
"blockTypeOreEmerald":function(d){return "emerald ore"},
"blockTypeOreGold":function(d){return "سونے کی دھات"},
"blockTypeOreIron":function(d){return "لوہا"},
...
"cancel":function(d){return "منسوخ کریں"},
...
"eventTypeWhenRun":function(d){return "جب رن ہو تو"},
...
"itemTypeBlock":function(d){return "بلاک"},
...
"miniBlockBricks":function(d){return "اینٹھیں"},
...
"miniBlockDirt":function(d){return "مٹی"},
...
"miniBlockGravel":function(d){return "بجری"},
...
"miniBlockSand":function(d){return "ریت"},
...
"miniBlockWool":function(d){return "اون"},
...
"timeNight":function(d){return "رات"},
"timeRandom":function(d){return "بےترتیب"},

...
"basketballLaunchBall":function(d){return "新しいボールをなげる"},
"basketballLaunchBallTooltip":function(d){return "ボールをなげてゲームをはじめます。"},
"basketballSetPaddle":function(d){return "てをきめます"},
"basketballSetPaddleSpeedFast":function(d){return "手のはやさを、はやくします。"},
"basketballSetPaddleSpeedNormal":function(d){return "手のはやさを、ふつうにします。"},
"basketballSetPaddleSpeedRandom":function(d){return "手のはやさを、はやくしたりおそくしたり、いろいろかえます。"},
"basketballSetPaddleSpeedSlow":function(d){return "てのはやさを、ゆっくりにします。"},
"basketballSetPaddleSpeedTooltip":function(d){return "てのはやさを、きめられます。"},
"basketballSetPaddleSpeedVeryFast":function(d){return "てのはやさを、とてもはやくします。"},
"basketballSetPaddleSpeedVerySlow":function(d){return "てのはやさを、とてもゆっくりにします。"},
"basketballWhenBallMissesPaddle":function(d){return "ボールが、てからおちたら"},
"basketballWhenPaddleCollided":function(d){return "ボールが手に当たった場合、"},
"bounceBall":function(d){return "バウンドするボール"},
...
"playSoundCheer":function(d){return "おうえんしているおと"},
...
"playSoundKick":function(d){return "キックしているおとをかける"},
...
"playSoundSlapshot":function(d){return "なにかをたたいているおとをかける"},
"playSoundSwish":function(d){return "ボールをシュートしているおとをかける"},
"playSoundTooltip":function(d){return "選択音を再生"},
"playSoundWhistle":function(d){return "ホイッスルのおとをかける"},
...
"reinfFeedbackMsg":function(d){return "「ゲームをつづける」ボタンを おすと、ゲームに もどります。"},
...
"setBackground":function(d){return bounce_locale.v(d,"background")+"（うしろのけしき）をきめる"},
...
"setBall":function(d){return bounce_locale.v(d,"ball")+" ボールをきめる"},
...
"setPaddle":function(d){return "パドルをおく。"},
...
"setPlayerSpeedFast":function(d){return "はやいひとのスピードをきめる"},
"setPlayerSpeedNormal":function(d){return "ふつうのひとのはやさをきめる"},
"setPlayerSpeedRandom":function(d){return "はやいひとと、ゆっくりなひとの、りょうほうのはやさをきめる"},
"setPlayerSpeedSlow":function(d){return "ゆっくりなひとのはやさをきめる"},
"setPlayerSpeedTooltip":function(d){return "プレーをしているひとのはやさをきめる"},
"setPlayerSpeedVeryFast":function(d){return "いちばんはやいひとのスピートをきめる"},
"setPlayerSpeedVerySlow":function(d){return "いちばんおそいひとのスピードをきめる"},
"setTeamTooltip":function(d){return "ロゴといろをきめる"},
"setTeam":function(d){return "チーム"+bounce_locale.v(d,"team")+" をきめる"},
"setTeamRandom":function(d){return "チームをてきとうにきめる"},
"shareBounceTwitter":function(d){return "私が開発したゲーム「Bounce」をぜひプレイしてください。@codeorgを使い、書きました。"},
"shareBounceTwitterDonor":function(d){return "わたしの作ったバウンス ゲームを見てください。( "+bounce_locale.v(d,"donor")+" のサポートに感謝します @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "ポールが、とれなかったとき"},
...
"whenPlayerCollided":function(d){return "ポールが、ぶつかってしまったとき"},
"whenPlayerCollidedTooltip":function(d){return "ボールがプレイヤーに当たったら、次のアクションを実行します。"},

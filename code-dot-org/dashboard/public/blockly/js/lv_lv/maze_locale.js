...
"collect":function(d){return "iegūt"},
"collectiblePresent":function(d){return "tur ir daži dārgumi"},
"collectorCollectTooltip":function(d){return "Iegūsti priekšmetu"},
"collectorCollectedEverything":function(d){return "Apsveicam! Tu ieguvi "+maze_locale.p(d,"count",0,"lv",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNothing":function(d){return "Turpini kodēt! Tev jāiegūst pēc iespējas vairāk priekšmetu."},
"collectorCollectedSome":function(d){return "Labs darbs! Tu ieguvi "+maze_locale.p(d,"count",0,"lv",{"one":"1 item","other":maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNotEnough":function(d){return "Turpini kodēt! Tev jāiegūst vismaz "+maze_locale.p(d,"goal",0,"lv",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
"collectorCollectedTooMany":function(d){return "Šajā vietā nav pietiekoši daudz priekšmetu, ko iegūt."},
"collectorTooManyBlocks":function(d){return "Tu drīksti lietot tikai "+maze_locale.v(d,"blockLimit")+" blokus. Apskati kodu un pamēģini vēlreiz!"},
"continue":function(d){return "Turpināt"},
"corn":function(d){return "kukurūza"},
"cornTooltip":function(d){return "Iegūsti nedaudz kukurūzu"},
"didNotCollectAllCrops":function(d){return "Pārliecinies, ka tu neatstāj neiegūtus augus!"},
"didNotCollectEverything":function(d){return "Pārliecinies, ka tu iegūsti visu nektāru un pagatavo visu medu!"},
"didNotPlantEverywhere":function(d){return "Pārliecinies, ka tu iestādi kaut ko katrā zemes laukumā!"},
...
"emptyCropError":function(d){return "Tie augi visi ir beigušies."},
...
"has":function(d){return "ir"},
"haslettuce":function(d){return "tur ir salāti"},
"hascorn":function(d){return "tur ir kukurūza"},
"haspumpkin":function(d){return "tur ir ķirbji"},
...
"lettuce":function(d){return "salāti"},
"lettuceTooltip":function(d){return "Iegūsti dažus salātus"},
...
"pick":function(d){return "savākt"},
"pilePresent":function(d){return "ir kaudze"},
"plant":function(d){return "iestādi"},
"plantInNonSoilError":function(d){return "Es varu kaut ko iestādīt tikai svaigā augsnē."},
"plantTooltip":function(d){return "Iestādi asnus"},
"pumpkin":function(d){return "pumpkin"},
"pumpkinTooltip":function(d){return "Iegūsti ķirbi"},
...
"soil":function(d){return "augsne"},
"sprout":function(d){return "asns"},
...
"wrongCropError":function(d){return "Es neko nevaru iegūt no šīs vietas."},

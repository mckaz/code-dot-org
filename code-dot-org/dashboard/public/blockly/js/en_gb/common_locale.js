...
"clearPuzzleConfirm":function(d){return "This will reset the puzzle to its start state and delete all the blocks you've added o changed."},
...
"disabledButtonsInfo":function(d){return "Your progress and code will not be saved from 3 - 11 December due to Hour of Code traffic."},
"disabledButtonsWarning":function(d){return "Warning:"},
"disabledButtonsWhy":function(d){return "Why are my bubbles grey?"},
"disabledProgress1":function(d){return "Any progress you make on your course will not be saved from 3 - 11 December due to the level of traffic our site receives for the Hour of Code during this time."},
"disabledProgress2":function(d){return "This is why all your bubbles are displayed as grey (don’t worry, your progress from before this week is still safe)."},
...
"emptyFunctionBlocksErrorMsg":function(d){return "Blok funkcji musi w sobie zawierać inne bloki, aby działać."},
...
"generatedCodeInfo":function(d){return "Even top universities teach block-based coding (e.g., "+common_locale.v(d,"berkeleyLink")+", "+common_locale.v(d,"harvardLink")+"). But under the bonnet, the blocks you have assembled can also be shown in JavaScript, the world's most widely used coding language:"},
...
"hintPromptInline":function(d){return "Vrei o sugestie?"},
"hintRequest":function(d){return "Vezi sugestia"},
...
"locked":function(d){return "Încuiat"},
...
"positionBottomCenter":function(d){return "to the bottom centre position"},
...
"positionMiddleCenter":function(d){return "to the middle centre position"},
...
"positionTopCenter":function(d){return "to the top centre position"},
...
"projectGroupMath":function(d){return "Mathematics"},

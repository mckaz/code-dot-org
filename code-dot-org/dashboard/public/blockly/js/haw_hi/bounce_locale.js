...
"basketballLaunchBall":function(d){return "kīloi i ke kinipōpō hou"},
"basketballLaunchBallTooltip":function(d){return "kīloi i ke kinipōpō e pāʻani"},
"basketballSetPaddle":function(d){return "hōʻoia lima"},
"basketballSetPaddleSpeedFast":function(d){return "hoʻopaʻa i ka māmā holo o ka lima wikiwiki"},
"basketballSetPaddleSpeedNormal":function(d){return "hoʻopaʻa i ka māmā holo o ka lima maʻamau"},
"basketballSetPaddleSpeedRandom":function(d){return "hoʻopaʻa i ka māmā holo o ka lima koho wale"},
"basketballSetPaddleSpeedSlow":function(d){return "hoʻopaʻa i ka māmā holo o ka lima mālie"},
"basketballSetPaddleSpeedTooltip":function(d){return "E hoʻopaʻa ana i ka māmā holo o ka lima"},
"basketballSetPaddleSpeedVeryFast":function(d){return "e hoʻopaʻa i ka māmā holo lima wikiwiki loa"},
"basketballSetPaddleSpeedVerySlow":function(d){return "e hoʻopaʻa i ka māmā holo lima mālie loa"},
"basketballWhenBallMissesPaddle":function(d){return "when ball misses hand"},
"basketballWhenPaddleCollided":function(d){return "ke kuʻi ke kinipōpō i ka lima"},
"bounceBall":function(d){return "lele i ke kinipōpō"},

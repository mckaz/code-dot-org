...
( function( factory ) {
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(35), __webpack_require__(739) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
module.exports = __webpack_require__(3408);
...
var pixelationVersionDropdown = void 0;
var hideSlidersField = void 0;
var initialDimensionsField = void 0;

(0, _jquery2.default)(function () {
  pixelationVersionDropdown = (0, _jquery2.default)('#level_version');
  hideSlidersField = (0, _jquery2.default)('.hide-sliders');
  initialDimensionsField = (0, _jquery2.default)('.initial-dimensions');

  // When the version changes, show/hide relevant fields
  pixelationVersionDropdown.change(function () {
...
function showAndHideFieldsForVersion(version, animate) {
  ...
  // for version 1
  var version1Fields = [hideSlidersField, initialDimensionsField];
  if (version === '1') {
...
function toggleFields(fields, motion, animate) {
  if (animate) {
    (function () {
      var easing = motion === 'slideDown' ? 'easeOutBack' : 'swing';
      var speed = motion === 'slideDown' ? 400 : 200;
      var delay = motion === 'slideDown' ? 200 : 100;
      fields.forEach(function (field, index) {
        return field.delay(index * delay)[motion](speed, easing);
      });
    })();
  } else {
    fields.forEach(function (field) {
      return field[motion](0);
    });
  }
}

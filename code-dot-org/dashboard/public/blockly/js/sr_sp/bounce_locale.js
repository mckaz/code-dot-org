...
"basketballLaunchBall":function(d){return "бацити нову лопту"},
"basketballLaunchBallTooltip":function(d){return "Убаци лопту у игру."},
"basketballSetPaddle":function(d){return "постави руку"},
"basketballSetPaddleSpeedFast":function(d){return "постави брзину руке на брзо"},
"basketballSetPaddleSpeedNormal":function(d){return "постави брзину руке на нормално"},
"basketballSetPaddleSpeedRandom":function(d){return "постави насумичну брзину руке"},
"basketballSetPaddleSpeedSlow":function(d){return "постави брзину руке на споро"},
"basketballSetPaddleSpeedTooltip":function(d){return "Подешава брзину руке"},
"basketballSetPaddleSpeedVeryFast":function(d){return "поставља брзину руке на веома брзо"},
"basketballSetPaddleSpeedVerySlow":function(d){return "поставља брзину руке на веома споро"},
"basketballWhenBallMissesPaddle":function(d){return "када лопта промаши руку"},
"basketballWhenPaddleCollided":function(d){return "када лопта удари руку"},
...
"makeYourOwn":function(d){return "Направи сам своју Игру одбијања"},
...
"playSoundCheer":function(d){return "пусти звук навијања"},
...
"playSoundKick":function(d){return "пусти звук ударца"},
...
"playSoundWhistle":function(d){return "пусти звук звиждука"},
...
"repeatUntilFinish":function(d){return "понављај до циља"},
"scoreText":function(d){return "Резултат: "+bounce_locale.v(d,"playerScore")+" : "+bounce_locale.v(d,"opponentScore")},
"setBackground":function(d){return "постави "+bounce_locale.v(d,"background")+" позадину"},
"setBackgroundHardcourt":function(d){return "подеси тврду сцену"},
"setBackgroundRandom":function(d){return "подеси случајну сцену"},
...
"setBall":function(d){return "постави "+bounce_locale.v(d,"ball")+" лопту"},
...
"setPaddle":function(d){return "постави весло"},
...
"whileMsg":function(d){return "док је"},

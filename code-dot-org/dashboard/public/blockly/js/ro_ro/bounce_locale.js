...
"basketballLaunchBall":function(d){return "arunca o minge noua"},
"basketballLaunchBallTooltip":function(d){return "Arunca o minge in joc."},
"basketballSetPaddle":function(d){return "seteaza aruncarea"},
"basketballSetPaddleSpeedFast":function(d){return "seteaza viteza aruncarii"},
"basketballSetPaddleSpeedNormal":function(d){return "seteaza viteza normala de aruncare"},
"basketballSetPaddleSpeedRandom":function(d){return "seteaza viteza aleatorie de aruncare"},
"basketballSetPaddleSpeedSlow":function(d){return "seteaza aruncarea la viteza mica"},
"basketballSetPaddleSpeedTooltip":function(d){return "Seteaza viteza mainii la aruncare"},
"basketballSetPaddleSpeedVeryFast":function(d){return "seteaza viteza aruncarii foarte rapid"},
"basketballSetPaddleSpeedVerySlow":function(d){return "seteaza viteza aruncarii foarte incet"},
"basketballWhenBallMissesPaddle":function(d){return "cand mingea rateaza mana"},
"basketballWhenPaddleCollided":function(d){return "cand mingea loveste mana"},
"bounceBall":function(d){return "fă mingea să ricoșeze"},
...
"incrementOpponentScoreTooltip":function(d){return "Adaugă un punct la scorul curent al adversarului."},
"incrementPlayerScore":function(d){return "punct de scor"},
"incrementPlayerScoreTooltip":function(d){return "Adaugă un punct la scorul de jucător curent."},
"isWall":function(d){return "este un perete"},
...
"makeYourOwn":function(d){return "Creează-ți propriul joc de Bounce"},
...
"playSoundCheer":function(d){return "redă sunet de ovații"},
...
"playSoundKick":function(d){return "redă sunet de şut"},
...
"playSoundRubber":function(d){return "redă sunet cauciuc"},
"playSoundSlap":function(d){return "redă sunet pălmuire"},
"playSoundSlapshot":function(d){return "redă sunet de lovitură palmă"},
"playSoundSwish":function(d){return "redă sunet de şuierat de plasă"},
"playSoundTooltip":function(d){return "Redă sunetul ales."},
"playSoundWhistle":function(d){return "redă sunet de fluier"},
...
"setBackground":function(d){return "stabilește "+bounce_locale.v(d,"background")+" locul acțiunii"},
...
"setBallHardcourt":function(d){return "setează minge pentru suprafaţă dură"},
"setBallRandom":function(d){return "setează mingea la întâmplare"},
"setBallRetro":function(d){return "setează mingea retro"},
"setBall":function(d){return "stabilește "+bounce_locale.v(d,"ball")+" mingea"},
"setBallSpeedFast":function(d){return "setează viteza mingii la nivel rapid"},
"setBallSpeedNormal":function(d){return "setează viteza mingii la nivel normal"},
"setBallSpeedRandom":function(d){return "setează viteza mingii la nivel aleator"},
"setBallSpeedSlow":function(d){return "setează viteza mingii la nivel lent"},
"setBallSpeedTooltip":function(d){return "Setează viteza mingii"},
"setBallSpeedVeryFast":function(d){return "setează viteza mingii la nivel foarte rapid"},
"setBallSpeedVerySlow":function(d){return "setează viteza mingii la nivel foarte lent"},
"setBallTooltip":function(d){return "Setează imaginea mingii"},
"setPaddle":function(d){return "selectează paleta"},
...
"setPaddleRetro":function(d){return "setează paleta retro"},
...
"setPlayerSpeedFast":function(d){return "selectează viteza mare a jucătorului"},
"setPlayerSpeedNormal":function(d){return "selectează viteza normală a jucătorului"},
"setPlayerSpeedRandom":function(d){return "selectează aleator viteza jucătorului"},
"setPlayerSpeedSlow":function(d){return "selectează viteza jucătorului incet"},
"setPlayerSpeedTooltip":function(d){return "Setează viteza jucătorului"},
"setPlayerSpeedVeryFast":function(d){return "stabilește viteza foarte mare a jucătorului"},
"setPlayerSpeedVerySlow":function(d){return "stabilește viteza foarte mică a jucătorului"},
"setTeamTooltip":function(d){return "Stabileste logo-ul si schema de culoare"},
"setTeam":function(d){return "Seteaza echipa "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Seteaza echipa la întâmplare"},
"shareBounceTwitter":function(d){return "Hai să vezi ce  joc de ricoșeu am făcut. L-am realizat eu insămi cu @codeorg"},
"shareBounceTwitterDonor":function(d){return "Check out joc Bounce am făcut. (Mulțumesc "+bounce_locale.v(d,"donor")+" pentru sprijinirea @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "cand mingea rateaza jucătorul"},
...
"whenPlayerCollided":function(d){return "cand mingea lovește jucătorul"},
"whenPlayerCollidedTooltip":function(d){return "Execută acţiunile de mai jos când o bilă se ciocneşte cu jucătorul."},

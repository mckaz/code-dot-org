...
"jumpNortheastTooltip":function(d){return "Move o artista para nordeste sem deixar marcas."},
"jumpNorthwestTooltip":function(d){return "Move o artista para noroeste sem deixar marcas."},
"jumpSouthTooltip":function(d){return "Move o artista para sul sem deixar marcas."},
"jumpSoutheastTooltip":function(d){return "Move o artista para sudeste sem deixar marcas."},
"jumpSouthwestTooltip":function(d){return "Move o artista para sudoeste sem deixar marcas."},
...
"moveNortheastTooltip":function(d){return "Move o artista para nordeste."},
"moveNorthwestTooltip":function(d){return "Move o artista para noroeste."},
"moveSouthTooltip":function(d){return "Move o artista para sul."},
"moveSoutheastTooltip":function(d){return "Move o artista para sudeste."},
"moveSouthwestTooltip":function(d){return "Move o artista para sudoeste."},

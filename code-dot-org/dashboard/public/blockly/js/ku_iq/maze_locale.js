...
"atFlower":function(d){return "لە گوڵ"},
"atHoneycomb":function(d){return "at honeycomb"},
"avoidCowAndRemove":function(d){return "avoid the cow and remove 1"},
"collect":function(d){return "كۆبكەوە/خركەوە"},
"collectiblePresent":function(d){return "هەندێك گەنجینە هەیە"},
...
"continue":function(d){return "بەردەوام بە"},
"corn":function(d){return "دانەوێڵە/گەنمەشامی"},
...
"dirE":function(d){return "ڕۆژهەڵات"},
"dirN":function(d){return "باكور"},
"dirS":function(d){return "باشور"},
"dirW":function(d){return "ڕۆژئاوا"},
"doCode":function(d){return "بكە"},
"elseCode":function(d){return "else"},
"emptyCropError":function(d){return "That crop is all gone."},
"fill":function(d){return "١ پڕ بكەوە"},
"fillN":function(d){return "fill "+maze_locale.v(d,"shovelfuls")},
"fillSquare":function(d){return "چوارگۆشە پركردنەوە"},

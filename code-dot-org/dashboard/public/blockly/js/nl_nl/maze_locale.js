...
"collect":function(d){return "verzamel"},
"collectiblePresent":function(d){return "er zijn nog schatten"},
"collectorCollectTooltip":function(d){return "Verzamel spullen"},
"collectorCollectedEverything":function(d){return "Gefeliciteerd! Je heb alle "+maze_locale.v(d,"count")+" spullen verzameld!"},
"collectorCollectedNothing":function(d){return "Blijf programmeren! Je moet zoveel spullen verzamelen als je kan."},
"collectorCollectedSome":function(d){return "Goed gedaan! Je hebt "+maze_locale.v(d,"count")+" spullen verzameld!"},
"collectorCollectedNotEnough":function(d){return "Blijf coderen! Je moet tenminste "+maze_locale.p(d,"goal",0,"nl",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+" verzamelen."},
"collectorCollectedTooMany":function(d){return "Deze ruimte heeft niet genoeg items voor mij om te verzamelen."},
"collectorTooManyBlocks":function(d){return "Je kan maar "+maze_locale.v(d,"blockLimit")+" blokken gebruiken. Kijk naar je code en probeer het opnieuw!"},
"continue":function(d){return "Doorgaan"},
"corn":function(d){return "maïs"},
"cornTooltip":function(d){return "Oogst wat maïs"},
"didNotCollectAllCrops":function(d){return "Zorg ervoor dat er geen gewassen achterblijven!"},
"didNotCollectEverything":function(d){return "Wees er zeker van dat u geen nectar of honing achterlaat!"},
"didNotPlantEverywhere":function(d){return "Zorg ervoor dat je in elk grondvak iets plant!"},
...
"emptyCropError":function(d){return "Die oogst is helemaal verdwenen."},
...
"has":function(d){return "heeft"},
"haslettuce":function(d){return "er is sla"},
"hascorn":function(d){return "er is maïs"},
"haspumpkin":function(d){return "er zijn pompoenen"},
...
"lettuce":function(d){return "sla"},
"lettuceTooltip":function(d){return "Oogst wat sla"},
...
"pick":function(d){return "kies"},
"pilePresent":function(d){return "er is een stapel"},
"plant":function(d){return "plant"},
"plantInNonSoilError":function(d){return "Ik kan alleen iets planten in verse grond."},
"plantTooltip":function(d){return "Plant een kiem"},
"pumpkin":function(d){return "pompoen"},
"pumpkinTooltip":function(d){return "Oogst een pompoen"},
...
"soil":function(d){return "grond"},
"sprout":function(d){return "spruit"},
...
"wrongCropError":function(d){return "Ik kan dat gewas vanaf hier niet oogsten."},

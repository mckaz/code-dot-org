...
"basketballLaunchBall":function(d){return "kasta nýjum bolta"},
"basketballLaunchBallTooltip":function(d){return "Kasta bolta inn í leik."},
"basketballSetPaddle":function(d){return "stilla hönd"},
"basketballSetPaddleSpeedFast":function(d){return "stilla hönd á mikinn hraða"},
"basketballSetPaddleSpeedNormal":function(d){return "stilla hönd á venjulegan hraða"},
"basketballSetPaddleSpeedRandom":function(d){return "stilla hönd á einhvern hraða"},
"basketballSetPaddleSpeedSlow":function(d){return "stilla hönd á hægan hraða"},
"basketballSetPaddleSpeedTooltip":function(d){return "Stillir hraða handarinnar"},
"basketballSetPaddleSpeedVeryFast":function(d){return "stilla hönd á mjög mikinn hraða"},
"basketballSetPaddleSpeedVerySlow":function(d){return "stilla hönd á mjög hægan hraða"},
"basketballWhenBallMissesPaddle":function(d){return "þegar bolti hittir ekki hönd"},
"basketballWhenPaddleCollided":function(d){return "þegar bolti hittir hönd"},
...
"playSoundCheer":function(d){return "spila fagnaðarhljóð"},
...
"playSoundKick":function(d){return "spila sparkhljóð"},
...
"playSoundSlapshot":function(d){return "spila skothljóð"},
"playSoundSwish":function(d){return "spila þyt í neti"},
"playSoundTooltip":function(d){return "Spila valið hljóð."},
"playSoundWhistle":function(d){return "spila flauthljóð"},
...
"setBackground":function(d){return "nota "+bounce_locale.v(d,"background")+" bakgrunn"},
...
"setBall":function(d){return "nota "+bounce_locale.v(d,"ball")+" bolta"},
...
"setPaddle":function(d){return "nota spaða"},
...
"setPlayerSpeedFast":function(d){return "stilla leikmann á mikinn hraða"},
"setPlayerSpeedNormal":function(d){return "stilla leikmann á venjulegan hraða"},
"setPlayerSpeedRandom":function(d){return "stilla leikmann á einhvern hraða"},
"setPlayerSpeedSlow":function(d){return "stilla leikmann á lítinn hraða"},
"setPlayerSpeedTooltip":function(d){return "Stillir hraða leikmanns"},
"setPlayerSpeedVeryFast":function(d){return "stilla leikmann á mjög mikinn hraða"},
"setPlayerSpeedVerySlow":function(d){return "stilla leikmann á mjög lítinn hraða"},
"setTeamTooltip":function(d){return "Stillir merkið og litavalið"},
"setTeam":function(d){return "Nota teymi "+bounce_locale.v(d,"team")},
"setTeamRandom":function(d){return "Nota eitthvert teymi"},
"shareBounceTwitter":function(d){return "Kíktu á boltaleikinn sem ég bjó til. Ég skrifaði hann með @codeorg"},
"shareBounceTwitterDonor":function(d){return "Kíktu á Bounce leikinn sem ég bjó til. (Þakkir "+bounce_locale.v(d,"donor")+" fyrir að styðja @codeorg)"},
...
"whenBallMissesPlayer":function(d){return "þegar bolti hittir ekki leikmann"},
...
"whenPlayerCollided":function(d){return "þegar bolti hittir leikmann"},
"whenPlayerCollidedTooltip":function(d){return "Gera aðgerðirnar fyrir neðan þegar bolti rekst á leikmanninn."},

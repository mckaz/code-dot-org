...
"collect":function(d){return "kolektahin"},
"collectiblePresent":function(d){return "mayroong ilang kayamanan"},
"collectorCollectTooltip":function(d){return "Mangolekta ng aytem"},
"collectorCollectedEverything":function(d){return "Maligayang bati! Nakolekta mo ang "+maze_locale.p(d,"count",0,"fil",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNothing":function(d){return "Huwag titigil sa pag-code! Kailangan mong mangolekta na maraming mga aytem hangga't maaari."},
"collectorCollectedSome":function(d){return "Mahusay na gawain! Nakolekta mo ang "+maze_locale.p(d,"count",0,"fil",{"one":"1 item","other":maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNotEnough":function(d){return "Huwag titigil sa pag-code! Kailangan mong magkolekta ng hindi bababa sa "+maze_locale.p(d,"goal",0,"fil",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},
"collectorCollectedTooMany":function(d){return "Ang puwang na iyan ay walang sapat na mga aytem para makolekta ko."},
"collectorTooManyBlocks":function(d){return "Maaari kang gumamit ng "+maze_locale.v(d,"blockLimit")+" na mga bloke. Tingnan ang iyong code at subukan muli!"},
"continue":function(d){return "Magpatuloy"},
"corn":function(d){return "mais"},
"cornTooltip":function(d){return "Mag-ani na ilang mais"},
"didNotCollectAllCrops":function(d){return "Tiyakin na walang kang maiwang mga pananim!"},
"didNotCollectEverything":function(d){return "Tiyakin na wala kang maiwang nektar o pulut-pukyutan!"},
"didNotPlantEverywhere":function(d){return "Tiyakin na may maitanim ka sa bawat tagpi ng lupa!"},
...
"emptyCropError":function(d){return "Lahat ng pananim ay wala na."},
...
"goal":function(d){return "layunin"},
"has":function(d){return "ay mayroong"},
"haslettuce":function(d){return "mayroong letsugas"},
"hascorn":function(d){return "may mais"},
"haspumpkin":function(d){return "may mga kalabasa"},
...
"lettuce":function(d){return "letsugas"},
"lettuceTooltip":function(d){return "Mag-ani ng ilang letsugas"},
...
"pick":function(d){return "pumili"},
"pilePresent":function(d){return "meron mga tambak"},
"plant":function(d){return "magtanim"},
"plantInNonSoilError":function(d){return "Maari lang akong magtanim ng anuman sa sariwang lupa."},
"plantTooltip":function(d){return "Magtanim ng sibol"},
"pumpkin":function(d){return "kalabasa"},
"pumpkinTooltip":function(d){return "Mag-ani ng kalabasa"},
...
"soil":function(d){return "lupa"},
"sprout":function(d){return "sibol"},
...
"wrongCropError":function(d){return "Hindi ako makaani ng mga pananim mula dito."},

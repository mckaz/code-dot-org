...
"basketballLaunchBall":function(d){return "új labda dobása"},
"basketballLaunchBallTooltip":function(d){return "Dobj egy labdát a játékba."},
"basketballSetPaddle":function(d){return "kéz beállítása"},
"basketballSetPaddleSpeedFast":function(d){return "gyors kéz sebességének beállítása"},
"basketballSetPaddleSpeedNormal":function(d){return "normális kéz sebességének beállítása"},
"basketballSetPaddleSpeedRandom":function(d){return "véletlenszerű kézsebesség beállítása"},
"basketballSetPaddleSpeedSlow":function(d){return "kéz sebességét állítsa lassúra"},
"basketballSetPaddleSpeedTooltip":function(d){return "Lassú kéz sebességét állítja"},
"basketballSetPaddleSpeedVeryFast":function(d){return "nagyon gyors kéz sebességének beállítása"},
"basketballSetPaddleSpeedVerySlow":function(d){return "kéz sebességét állítsa nagyon lassúra"},
"basketballWhenBallMissesPaddle":function(d){return "amikor a labda nem éri a kezet"},
"basketballWhenPaddleCollided":function(d){return "amikor a labda a kézhez ér"},
...
"playSoundCheer":function(d){return "játssz éljenzés hangot"},
...
"playSoundKick":function(d){return "játssz ütés hangot"},
...
"playSoundSlapshot":function(d){return "játssz pofon hangot"},
"playSoundSwish":function(d){return "játssz háló suhogása hangot"},
"playSoundTooltip":function(d){return "Kiválasztott hang lejátszása."},
"playSoundWhistle":function(d){return "játssz le síp hangot"},
...
"setBackground":function(d){return "állítsd be "+bounce_locale.v(d,"background")+" jelenetet"},
...
"setBall":function(d){return "állíts be a "+bounce_locale.v(d,"ball")+" labdát"},
...
"setPaddle":function(d){return "állítsd be az ütőt"},
...
"setPlayerSpeedFast":function(d){return "játékos sebességének beállítása"},
"setPlayerSpeedNormal":function(d){return "normál játékos sebesség"},
"setPlayerSpeedRandom":function(d){return "véletlenszerű játékos sebesség"},
"setPlayerSpeedSlow":function(d){return "lassú játékos sebesség"},
"setPlayerSpeedTooltip":function(d){return "Állítsd be a játékos sebességét"},
"setPlayerSpeedVeryFast":function(d){return "nagyon gyors játékos sebesség"},
"setPlayerSpeedVerySlow":function(d){return "nagyon lassú játékos sebesség"},
"setTeamTooltip":function(d){return "Állítsd be a logót és a színsémát"},
"setTeam":function(d){return bounce_locale.v(d,"team")+" csapat beállítása"},
"setTeamRandom":function(d){return "Csapat véletlenszerű kiválasztása"},
...
"whenBallMissesPlayer":function(d){return "amikor a labda nem érintkezik a játékossal"},
...
"whenPlayerCollided":function(d){return "amikor a labda érintkezik a játékossal"},
"whenPlayerCollidedTooltip":function(d){return "Hajtsa végre az alábbi utasításokat amikor a labda érintkezik a játékossal."},

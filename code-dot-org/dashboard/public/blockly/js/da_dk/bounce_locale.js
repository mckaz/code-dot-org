...
"basketballLaunchBall":function(d){return "kast en ny bold"},
"basketballLaunchBallTooltip":function(d){return "Sæt bold i spil."},
"basketballSetPaddle":function(d){return "sæt hånd"},
"basketballSetPaddleSpeedFast":function(d){return "sæt hurtig håndhastighed"},
"basketballSetPaddleSpeedNormal":function(d){return "sæt normal håndhastighed"},
"basketballSetPaddleSpeedRandom":function(d){return "sæt tilfældig håndhastighed"},
"basketballSetPaddleSpeedSlow":function(d){return "sæt langsom håndhastighed"},
"basketballSetPaddleSpeedTooltip":function(d){return "Indstiller håndens hastighed"},
"basketballSetPaddleSpeedVeryFast":function(d){return "sæt meget hurtig håndhastighed"},
"basketballSetPaddleSpeedVerySlow":function(d){return "sæt meget langsom håndhastighed"},
"basketballWhenBallMissesPaddle":function(d){return "når bolden ikke rammer hånden"},
"basketballWhenPaddleCollided":function(d){return "når bolden rammer hånden"},
...
"playSoundCheer":function(d){return "afspil heppelyd"},
...
"playSoundKick":function(d){return "afspil sparkelyd"},
...
"playSoundSlapshot":function(d){return "afspil slagskuds lyd"},
"playSoundSwish":function(d){return "afspil hvislelyd"},
"playSoundTooltip":function(d){return "Afspil den valgte lyd."},
"playSoundWhistle":function(d){return "afspil fløjtelyd"},
...
"setBackground":function(d){return "vælg "+bounce_locale.v(d,"background")+" scene"},
...
"setBall":function(d){return "vælg "+bounce_locale.v(d,"ball")+" bold"},
...
"setPaddle":function(d){return "vælg bat"},
...
"setPlayerSpeedFast":function(d){return "indstil spillerhastighed, hurtig"},
"setPlayerSpeedNormal":function(d){return "indstil spillerhastighed, normal"},
"setPlayerSpeedRandom":function(d){return "indstil spillerhastighed, tilfældig"},
"setPlayerSpeedSlow":function(d){return "indstil spillerhastighed, langsom"},
"setPlayerSpeedTooltip":function(d){return "Indstiller spillerhastighed"},
"setPlayerSpeedVeryFast":function(d){return "indstil spillerhastighed, meget hurtig"},
"setPlayerSpeedVerySlow":function(d){return "indstil spillerhastighed, meget langsom"},
"setTeamTooltip":function(d){return "Indstiller logo og farve skabelon"},
"setTeam":function(d){return "Vælg hold"},
"setTeamRandom":function(d){return "Vælg tilfældigt hold"},
...
"whenBallMissesPaddleTooltip":function(d){return "Udfør handlingerne herunder når en bold ikke rammer battet."},
"whenBallMissesPlayer":function(d){return "når bolden ikke rammer spilleren"},
...
"whenPlayerCollided":function(d){return "når bolden rammer spilleren"},
"whenPlayerCollidedTooltip":function(d){return "Udfør handlingerne nedenfor når en bolden rammer spilleren."},

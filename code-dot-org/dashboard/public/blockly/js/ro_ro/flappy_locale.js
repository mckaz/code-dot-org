...
"reinfFeedbackMsg":function(d){return "Poţi apăsa butonul \"Încercaţi din nou\" pentru a reveni să joci jocul tău."},
...
"setGroundFlappy":function(d){return "setează solul Normal"},
...
"shareFlappyTwitter":function(d){return "Hai să vezi ce joc Flappy am făcut. L-am scris eu cu @codeorg"},
"shareFlappyTwitterDonor":function(d){return "Ia uite ce joc Flappy am făcut. (Mulțumesc "+flappy_locale.v(d,"donor")+" pentru sprijinirea @codeorg)"},
"shareGame":function(d){return "Distribuie jocul tău:"},
...
"whenClickTooltip":function(d){return "Execută acţiunile de mai jos când se produce un click."},

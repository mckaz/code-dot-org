...
"basketballLaunchBall":function(d){return "새 공을 넣음"},
"basketballLaunchBallTooltip":function(d){return "새 공을 게임에 넣기"},
"basketballSetPaddle":function(d){return "손 설정"},
"basketballSetPaddleSpeedFast":function(d){return "손을 빠르게 설정"},
"basketballSetPaddleSpeedNormal":function(d){return "손을 보통 속도로 설정"},
"basketballSetPaddleSpeedRandom":function(d){return "손을 랜덤 속도로 설정"},
"basketballSetPaddleSpeedSlow":function(d){return "손을 느리게 설정"},
"basketballSetPaddleSpeedTooltip":function(d){return "손의 속도를 설정"},
"basketballSetPaddleSpeedVeryFast":function(d){return "손을 매우 빠른 속도로 설정"},
"basketballSetPaddleSpeedVerySlow":function(d){return "손을 아주 느린 속도로 설정"},
"basketballWhenBallMissesPaddle":function(d){return "공이 손을 빗나가면"},
"basketballWhenPaddleCollided":function(d){return "공이 손에 부딪치면"},
...
"playSoundCheer":function(d){return "응원하는 소리 출력"},
...
"playSoundKick":function(d){return "공차는 소리 출력"},
...
"playSoundSlapshot":function(d){return "찰칵 소리 출력"},
"playSoundSwish":function(d){return "그물 던지는 소리 출력"},
"playSoundTooltip":function(d){return "선택 소리 출력"},
"playSoundWhistle":function(d){return "호루라기 소리 출력"},
...
"setBackground":function(d){return "배경을 "+bounce_locale.v(d,"background")+" 로 설정"},
...
"setBall":function(d){return "공을 "+bounce_locale.v(d,"ball")+" 로 설정"},
...
"setPaddle":function(d){return "라켓 설정"},
...
"setPlayerSpeedFast":function(d){return "플레이어 속도를 빠르게 설정"},
"setPlayerSpeedNormal":function(d){return "플레이어의 속도를 보통으로 설정"},
"setPlayerSpeedRandom":function(d){return "플레이어의 속도를 랜덤으로 설정"},
"setPlayerSpeedSlow":function(d){return "플레이어를 느린속도로 설정"},
"setPlayerSpeedTooltip":function(d){return "플레이어의 속도를 설정"},
"setPlayerSpeedVeryFast":function(d){return "플레이어를 매우 빠른 속도로 설정"},
"setPlayerSpeedVerySlow":function(d){return "플레이어를 매우 느린 속도로 설정"},
"setTeamTooltip":function(d){return "로고와 색상을 설정"},
"setTeam":function(d){return "팀을 "+bounce_locale.v(d,"team")+" 로 설정"},
"setTeamRandom":function(d){return "팀을 랜덤으로 설정"},
"shareBounceTwitter":function(d){return "@codeorg 에서 만든 나의 게임을 살펴보세요."},
"shareBounceTwitterDonor":function(d){return "제가 만든 Bounce game을 한번 확인해 보세요. (@codeorg 를 서포트 해주셔서 감사합니다 "+bounce_locale.v(d,"donor")+" 님)"},
...
"whenBallMissesPlayer":function(d){return "공이 플레이어를 못 맞추면"},
...
"whenPlayerCollided":function(d){return "공이 플레이어에 부딪치면"},
"whenPlayerCollidedTooltip":function(d){return "공이 플레이어에 부딪치면 아래의 동작을 실행합니다."},

...
/******/ 	return __webpack_require__(__webpack_require__.s = 3631);
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = __webpack_require__(3632);
...
var _loadVideos = __webpack_require__(3635);
...
$(window).load(function () {
  if (document.getElementsByClassName('insert_video_player').length > 0) {
    (0, _loadVideos.loadVideos)(window.location.search.indexOf("force_youtube_fallback") !== -1);
  }
});
...
(function(window, factory) {
	...
	if(typeof module == 'object' && module.exports){
		factory(__webpack_require__(2998));
...
var _url_test = __webpack_require__(1691);

var _url_test2 = _interopRequireDefault(_url_test);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function loadVideos(force_fallback) {
  if (force_fallback) {
    setupVideos("fallback");
  } else {
    (0, _url_test2.default)("https://www.youtube.com/favicon.ico?" + Math.random(), function () {
      setupVideos("youtube");
    }, function () {
      setupVideos("fallback");
    });
...
function setupVideos(player) {
  ...
  $(".insert_video_player").each(function () {
    ...
    if (player === "fallback" && downloadPath && window.addEventListener) {
      $(this).parent().append('<video ' + 'style="position:absolute; top: 0; left: 0; width: 100%; height: 100%" ' + 'width="100%" height="100%" ' + 'class="video-js lazyload" ' + 'preload="none" ' + 'controls preload="auto" >' + '  <source src="' + downloadPath + '" type="video/mp4"/>' + '</video>');
    } else {
      // Always default to YouTube player.
      $(this).parent().append('<iframe class="lazyload" ' + 'style="position:absolute; top: 0; left: 0; width: 100%; height: 100%" ' + ("data-src=\"https://www.youtube.com/embed/" + $(this).data("video-code") + "?iv_load_policy=3&rel=0&autohide=1&showinfo=0&enablejsapi=1\" ") + 'frameborder="0" ' + 'allowfullscreen=true' + ">");
    }
  });
}

...
/******/ 	return __webpack_require__(__webpack_require__.s = 3850);
/******/ })
/************************************************************************/
/******/ ({
...
var _nodeJsMarkerClusterer = __webpack_require__(3852);
...
var markerCustererOptions = {
  imagePath: (0, _getScriptData2.default)('workshopSearch').imagePath,
  gridSize: 10
}; /* globals google */
...
function loadWorkshops() {
  markerClusterer = new _nodeJsMarkerClusterer2.default(gmap, [], markerCustererOptions);

  _jquery2.default.get('/dashboardapi/v1/pd/k5workshops').done(function (data) {
    processPdWorkshops(data);
  }).always(completeProcessingPdWorkshops);
}

function processPdWorkshops(workshops) {
  _jquery2.default.each(workshops, function (i, workshop) {
...
function compileHtml(workshop, first) {
  ...
  _jquery2.default.each(workshop.sessions, function (i, session) {
    html += '<div class="workshop-date" style="white-space: nowrap;">' + session + '</div>';
  });
  html += '</div>';

  var code_studio_root = (0, _jquery2.default)('#properties').attr('data-studio-url');
...
function addGeocomplete() {
  ...
  (0, _jquery2.default)("#geocomplete").geocomplete(geocomplete_options).bind("geocode:result", function (event, result) {
    ...
    while (!marker_found && gmap.getZoom() > 4) {
      _jquery2.default.each(markersByLocation, function (index, marker) {
  ...
  (0, _jquery2.default)("#btn-submit").click(function () {
    (0, _jquery2.default)("#geocomplete").trigger("geocode");
  });

  (0, _jquery2.default)("#btn-reset").click(function () {
    (0, _jquery2.default)('#geocomplete').val('');
...
function getScriptData(name) {
  ...
  var script = document.querySelector("script[data-" + name + "]");
  try {

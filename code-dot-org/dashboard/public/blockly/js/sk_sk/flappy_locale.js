...
"flapVerySmall":function(d){return "mávni veľmi slabo"},
"flapSmall":function(d){return "mávni slabo"},
"flapNormal":function(d){return "mávni normálne"},
"flapLarge":function(d){return "mávni silno"},
"flapVeryLarge":function(d){return "mávni veľmi silno"},
...
"playSoundDie":function(d){return "prehrať smutný zvuk"},
"playSoundHit":function(d){return "prehrať zvuk nárazu"},
"playSoundPoint":function(d){return "prehrať zvuk bodu"},
"playSoundSwoosh":function(d){return "prehrať zvuk šuchotu"},
"playSoundWing":function(d){return "prehrať zvuk krídel"},
"playSoundJet":function(d){return "prehrať zvuk stíhačky"},
"playSoundCrash":function(d){return "prehrať zvuk zrážky"},
"playSoundJingle":function(d){return "prehrať zvonenie"},
...
"setBackgroundRandom":function(d){return "nastaviť náhodné prostredie"},
...
"setGapRandom":function(d){return "nastav náhodnú medzeru"},
...
"setGapHeightTooltip":function(d){return "Nastaví zvislú medzeru v prekážke"},
"setGravityRandom":function(d){return "nastaviť gravitáciu náhodne"},
"setGravityVeryLow":function(d){return "nastaviť veľmi nízku gravitáciu"},
"setGravityLow":function(d){return "nastaviť nízku gravitáciu"},
"setGravityNormal":function(d){return "nastaviť normálnu gravitáciu"},
"setGravityHigh":function(d){return "nastaviť vysokú gravitáciu"},
"setGravityVeryHigh":function(d){return "nastaviť veľmi vysokú gravitáciu"},
"setGravityTooltip":function(d){return "Nastaví úroveň gravitácie"},
...
"setObstacleRandom":function(d){return "nastaviť náhodnú prekážku"},
...
"setPlayerTooltip":function(d){return "Nastaví hráčov obrázok"},
"setScore":function(d){return "nastaviť skóre"},
"setScoreTooltip":function(d){return "Nastaví skóre hráča"},
"setSpeed":function(d){return "nastaviť rýchlosť"},
"setSpeedTooltip":function(d){return "Nastaví úroveň rýchlosti"},
"shareFlappyTwitter":function(d){return "Pozrite sa na Flappy hru, ktorú som urobil/a. Napísal/a som to sám s pomocou @codeorg"},
...
"soundCrunch":function(d){return "chrúmanie"},
"soundDie":function(d){return "smutný"},
"soundHit":function(d){return "rachot"},
"soundPoint":function(d){return "bod"},
"soundSwoosh":function(d){return "šuchot"},
...
"whenClick":function(d){return "po kliknutí na"},
"whenClickTooltip":function(d){return "Po kliknutí vykonať nasledujúce akcie."},
"whenCollideGround":function(d){return "keď dopadne na zem"},
"whenCollideGroundTooltip":function(d){return "Vykonať nižšie uvedené akcie, keď sa Flappy dotkne zeme."},
"whenCollideObstacle":function(d){return "keď narazí na prekážku"},
"whenCollideObstacleTooltip":function(d){return "Vykonať nižšie uvedené akcie, keď Flappy narazí na prekážku."},
"whenEnterObstacle":function(d){return "keď obíde prekážku"},
"whenEnterObstacleTooltip":function(d){return "Vykonať akcie uvedené nižšie, keď sa Flappy dostane k prekážke."},

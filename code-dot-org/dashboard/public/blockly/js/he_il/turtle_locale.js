...
"jumpNortheastTooltip":function(d){return "הזז/י את האומן צפון-מזרחה בלי להשאיר אף סימן."},
"jumpNorthwestTooltip":function(d){return "הזז/י את האומן צפון-מערבה בלי להשאיר אף סימן."},
"jumpSouthTooltip":function(d){return "הזז/י את האומן דרומה בלי להשאיר אף סימן."},
"jumpSoutheastTooltip":function(d){return "הזז/י את האומן דרום-מזרחה בלי להשאיר אף סימן."},
"jumpSouthwestTooltip":function(d){return "הזז/י את האומן דרום-מערבה בלי להשאיר אף סימן."},
...
"moveForwardTooltip":function(d){return "מזיז את האמן קדימה."},
"moveNorthTooltip":function(d){return "מזיז את האומן צפונה."},
"moveNortheastTooltip":function(d){return "מזיז את האמן צפון־מזרחה."},
"moveNorthwestTooltip":function(d){return "מזיז את האמן צפון־מערבה."},
"moveSouthTooltip":function(d){return "מזיז את האומן דרומה."},
"moveSoutheastTooltip":function(d){return "מזיז את האמן דרום־מזרחה."},
"moveSouthwestTooltip":function(d){return "מזיז את האמן דרום־מערבה."},

...
"catTurtle":function(d){return "Veprime"},
...
"createASnowflakeBranch":function(d){return "krijo një pjesë floku prej dëbore"},
"degrees":function(d){return "gradë"},
"depth":function(d){return "thellësi"},
"dots":function(d){return "piksela"},
"drawACircle":function(d){return "vizato një rreth"},
...
"drawASnowman":function(d){return "vizato një njeri dëbore"},
"drawASquare":function(d){return "vizato një katror"},
...
"jumpNortheastTooltip":function(d){return "Lëviz artistin në verilindje pa lënë asnjë shenjë."},
"jumpNorthwestTooltip":function(d){return "Lëviz artistin në veriperëndim pa lënë asnjë shenjë."},
"jumpSouthTooltip":function(d){return "Lëviz artistin në jug pa lënë asnjë shenjë."},
"jumpSoutheastTooltip":function(d){return "Lëviz artistin në juglindje pa lënë asnjë shenjë."},
"jumpSouthwestTooltip":function(d){return "Lëviz artistin në jugperëndim pa lënë asnjë shenjë."},
...
"moveNortheastTooltip":function(d){return "Lëviz artistin në verilindje."},
"moveNorthwestTooltip":function(d){return "Lëviz artistin në veriperëndim."},
"moveSouthTooltip":function(d){return "Lëviz artistin në jug."},
"moveSoutheastTooltip":function(d){return "Lëviz artistin në juglindje."},
"moveSouthwestTooltip":function(d){return "Lëviz artistin në jugperëndim."},
...
"notBlackColour":function(d){return "Ju duhet të zgjidhni një ngjyrë të ndryshme nga e zeza për këtë puzzle."},
"numBlocksNeeded":function(d){return "Ky puzzle mund të zgjidhej me %1 blloqe. Ju përdorët %2."},
...
"reinfFeedbackMsg":function(d){return "Ja ku është dhe vizatimi yt! Vazhdo puno me të ose vazhdo tek puzzle-i tjetër."},
"setAlpha":function(d){return "vendosni alfa"},
"setCharacter":function(d){return "set character to "+turtle_locale.v(d,"character")},
"setColour":function(d){return "vendos ngjyrën"},
"setPattern":function(d){return "vendos modelin"},
"setWidth":function(d){return "vendos gjerësinë"},

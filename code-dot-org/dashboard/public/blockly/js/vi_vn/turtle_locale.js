...
"depth":function(d){return "độ sâu"},
"dots":function(d){return "điểm ảnh"},
...
"jumpNortheastTooltip":function(d){return "Di chuyển nghệ sĩ về phía Đông Bắc mà không để lại dấu vết gì."},
"jumpNorthwestTooltip":function(d){return "Di chuyển nghệ sĩ về phía Tây Bắc mà không để lại dấu vết gì."},
"jumpSouthTooltip":function(d){return "Di chuyển về phía nam nghệ sĩ mà không để lại bất cứ dấu hiệu nào."},
"jumpSoutheastTooltip":function(d){return "Di chuyển nghệ sĩ về phía Đông Nam mà không để lại dấu vết gì."},
"jumpSouthwestTooltip":function(d){return "Di chuyển nghệ sĩ về phía Tây Nam mà không để lại dấu vết gì."},
...
"moveNortheastTooltip":function(d){return "Di chuyển nghệ sĩ về phía đông bắc."},
"moveNorthwestTooltip":function(d){return "Di chuyển nghệ sĩ về phía tây bắc."},
"moveSouthTooltip":function(d){return "Di chuyển nghệ sĩ nam."},
"moveSoutheastTooltip":function(d){return "Di chuyển nghệ sĩ về phía đông nam."},
"moveSouthwestTooltip":function(d){return "Di chuyển nghệ sĩ về phía Tây Nam."},
...
"setCharacter":function(d){return "thiết lập nhân vật "+turtle_locale.v(d,"character")},

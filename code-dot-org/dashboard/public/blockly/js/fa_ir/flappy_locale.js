...
"nextLevel":function(d){return "تبریک! شما این معما را حل کردید."},
"no":function(d){return "خیر"},
"numBlocksNeeded":function(d){return "این پازل می‌تواند با %1 بلوک حل شود."},
...
"soundRandom":function(d){return "در هم"},

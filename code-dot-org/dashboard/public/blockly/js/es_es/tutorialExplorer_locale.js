...
"filterStudentExperience":function(d){return "Experiencia del estudiante"},
...
"filterPlatform":function(d){return "Tecnología de aula"},
...
"filterPlatformNoComputers":function(d){return "Ningún ordenador o dispositivo"},
...
"filterTopicsHistory":function(d){return "Ciencias Sociales"},
"filterTopicsLa":function(d){return "Lengua"},
"filterTopicsArt":function(d){return "Arte, Medios Audiovisuales, Música"},
"filterTopicsCsOnly":function(d){return "Sólo Informática"},
"filterActivityType":function(d){return "Tipo de Actividad"},
"filterActivityTypeOnlineTutorial":function(d){return "Tutorial Auto-dirigido"},
"filterActivityTypeLessonPlan":function(d){return "Plan de Estudio"},
"filterLength":function(d){return "Extensión"},
"filterLength1Hour":function(d){return "Una hora"},
"filterLength1HourFollow":function(d){return "Una hora con seguimiento"},
"filterLengthFewHours":function(d){return "Unas pocas horas"},
"filterProgrammingLanguage":function(d){return "Idioma"},
"filterProgrammingLanguageBlocks":function(d){return "Bloques"},
"filterProgrammingLanguageTyping":function(d){return "Escribir"},
"filterProgrammingLanguageOther":function(d){return "Otros"},
"filterActivityTypeRobotics":function(d){return "Robótica"},
"backButtonBack":function(d){return "Volver a todas las actividades"},
"filterHeaderShowFilters":function(d){return "Filtros"},
"filterHeaderHideFilters":function(d){return "Aplicar"},
"filterHeaderTutorialCountSingle":function(d){return "Un resultado"},
...
"showAllTutorialsButton":function(d){return "Mostrar actividades para muchos idiomas"},
"hideAllTutorialsButton":function(d){return "Ocultar actividades para muchos idiomas"},
"noTutorialsYourLanguage":function(d){return "No hay ninguna actividad disponible en tu idioma. Prueba actividades en otros idiomas haciendo clic en el botón de abajo."},
"bottomGuidelinesLink":function(d){return "Haga clic aquí para ver nuestros criterios y nuestras reglas de envío para los tutoriales de la Hora del código."},
"bottomSpecialNeedsLink":function(d){return "Haga clic aquí para obtener más información sobre cómo ayudar a estudiantes con necesidades especiales."}};
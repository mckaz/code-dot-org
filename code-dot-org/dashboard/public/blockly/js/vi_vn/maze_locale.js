...
"atFlower":function(d){return "tại bông hoa"},
"atHoneycomb":function(d){return "tại tổ ong"},
"avoidCowAndRemove":function(d){return "tránh con bò và loại bỏ 1"},
"collect":function(d){return "thu thập"},
"collectiblePresent":function(d){return "đó là một số kho báu"},
"collectorCollectTooltip":function(d){return "Thu thập các mục"},
"collectorCollectedEverything":function(d){return "Xin chúc mừng! Bạn thu thập tất cả "+maze_locale.v(d,"count")+" món đồ"},
"collectorCollectedNothing":function(d){return "Hãy tiếp tục mã hóa! Bạn cần phải thu thập càng nhiều của các món đồ có thể."},
"collectorCollectedSome":function(d){return "Tốt lắm! Bạn đã thu thập "+maze_locale.v(d,"count")+" món đồ!"},
"collectorCollectedNotEnough":function(d){return "Hãy tiếp tục lập trình! Bạn cần thu thập ít nhất "+maze_locale.p(d,"goal",0,"vi",{"one":"1 đồ vật","other":"đồ vật"})},
"collectorCollectedTooMany":function(d){return "Không gian đó không có đủ đồ vật cho tôi để thu thập."},
"collectorTooManyBlocks":function(d){return "Bạn chỉ có thể sử dụng "+maze_locale.v(d,"blockLimit")+" khối. Hãy nhìn vào code của bạn và thử lại!"},
"continue":function(d){return "Tiếp tục"},
"corn":function(d){return "ngô"},
"cornTooltip":function(d){return "Thu hoạch một ít ngô"},
"didNotCollectAllCrops":function(d){return "Hãy chắc chắn rằng bạn không thu hoạch sót cái gì!"},
"didNotCollectEverything":function(d){return "Hãy chắc chắn rằng bạn không để sót lại bất kỳ mật hoa hoặc mật ong phía sau!"},
"didNotPlantEverywhere":function(d){return "Bảo đảm rằng bạn trồng một cái gì đó trong mỗi mảnh đất!"},
...
"emptyCropError":function(d){return "Cây trồng mất cả rồi."},
"fill":function(d){return "lấp đầy 1"},
...
"has":function(d){return "có"},
"haslettuce":function(d){return "đó là rau diếp"},
"hascorn":function(d){return "có bắp"},
"haspumpkin":function(d){return "có nhiều quả bí ngô"},
...
"lettuce":function(d){return "rau diếp"},
"lettuceTooltip":function(d){return "Thu hoạch một ít rau diếp"},
"make":function(d){return "làm"},
"moveBackward":function(d){return "Lùi lại"},
"moveEastTooltip":function(d){return "Di chuyển tôi về phía đông một bước."},
"moveForward":function(d){return "đi thẳng"},
"moveForwardTooltip":function(d){return "Di chuyển tôi về phía trước một bước."},
"moveNorthTooltip":function(d){return "Di chuyển tôi về phía bắc một bước."},
"moveSouthTooltip":function(d){return "Di chuyển tôi một bước về phía nam."},
"moveTooltip":function(d){return "Di chuyển tôi tiến lên/lùi lại một ô"},
"moveWestTooltip":function(d){return "Di chuyển tôi về phía tây một ô."},
"nectar":function(d){return "lấy phấn hoa"},
"nectarRemaining":function(d){return "phấn hoa"},
...
"pick":function(d){return "hái"},
"pilePresent":function(d){return "Một đống"},
"plant":function(d){return "trồng"},
"plantInNonSoilError":function(d){return "Tôi chỉ có thể trồng một cái gì đó trong đất tươi."},
"plantTooltip":function(d){return "Gieo hạt"},
"pumpkin":function(d){return "bí ngô"},
"pumpkinTooltip":function(d){return "Thu hoạch một quả bị ngô"},
...
"removePile":function(d){return "loại bỏ hố"},
...
"soil":function(d){return "đất"},
"sprout":function(d){return "nảy mầm"},
"step":function(d){return "Bước/ từng bước thực hiện"},
"totalHoney":function(d){return "Tổng số mật ong"},
"totalNectar":function(d){return "tổng số phấn hoa"},
...
"wrongCropError":function(d){return "Tôi không thể thu hoạch cây trồn từ đây."},

...
"collectorCollectedEverything":function(d){return "Congratulations! You collected "+maze_locale.p(d,"count",0,"te",{"one":"the item","other":"all "+maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNothing":function(d){return "Keep coding! You need to collect as many of the items as you can."},
"collectorCollectedSome":function(d){return "Great work! You collected "+maze_locale.p(d,"count",0,"te",{"one":"1 item","other":maze_locale.n(d,"count")+" items"})+"!"},
"collectorCollectedNotEnough":function(d){return "Keep coding! You need to collect at least "+maze_locale.p(d,"goal",0,"te",{"one":"1 item","other":maze_locale.n(d,"goal")+" items"})+"."},

...
"jumpNortheastTooltip":function(d){return "Liikuttaa taiteilijaa länteen piirtämättä jälkeä."},
...
"jumpSoutheastTooltip":function(d){return "Liikuttaa taiteilijaa kaakkoon piirtämättä jälkeä."},
"jumpSouthwestTooltip":function(d){return "Liikuttaa taiteilijaa lounaaseen piirtämättä jälkeä."},
...
"moveNortheastTooltip":function(d){return "Liikuttaa taiteilijaa koilliseen."},
"moveNorthwestTooltip":function(d){return "Liikuttaa taiteilijaa luoteeseen."},
"moveSouthTooltip":function(d){return "Liikuttaa taiteilijaa etelään."},
"moveSoutheastTooltip":function(d){return "Liikuttaa taiteilijaa kaakkoon."},
"moveSouthwestTooltip":function(d){return "Liikuttaa taiteilijaa lounaaseen."},
...
"setCharacter":function(d){return "aseta merkki "+turtle_locale.v(d,"character")+": ksi"},

...
"agentDiamondPathCongrats":function(d){return "Congratulations, you found the diamond path! You have collected "+craft_locale.p(d,"count",0,"te",{"one":"1 diamond","other":craft_locale.n(d,"count")+" diamonds"})+" so far!"},
...
"tooManyBlocksFail":function(d){return "Puzzle "+craft_locale.v(d,"puzzleNumber")+" completed. Congratulations! It is also possible to complete it with "+craft_locale.p(d,"numBlocks",0,"te",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."},

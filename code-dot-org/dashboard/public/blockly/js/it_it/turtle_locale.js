...
"colourTooltip":function(d){return "Cambia il colore del pennello."},
...
"jumpNortheastTooltip":function(d){return "Sposta l'artista verso nord-est senza tracciare alcun segno."},
"jumpNorthwestTooltip":function(d){return "Sposta l'artista verso nord-ovest senza tracciare alcun segno."},
"jumpSouthTooltip":function(d){return "Sposta l'artista verso sud senza tracciare alcun segno."},
"jumpSoutheastTooltip":function(d){return "Sposta l'artista verso sud-est senza tracciare alcun segno."},
"jumpSouthwestTooltip":function(d){return "Sposta l'artista verso sud-ovest senza tracciare alcun segno."},
...
"moveNortheastTooltip":function(d){return "Sposta l'artista verso nord-est."},
"moveNorthwestTooltip":function(d){return "Sposta l'artista verso nord-ovest."},
"moveSouthTooltip":function(d){return "Sposta l'artista verso sud."},
"moveSoutheastTooltip":function(d){return "Sposta l'artista verso sud-est."},
"moveSouthwestTooltip":function(d){return "Sposta l'artista verso sud-ovest."},
...
"penDown":function(d){return "abbassa il pennello"},
"penTooltip":function(d){return "Abbassa o alza il pennello, per tracciare o meno un segno."},
"penUp":function(d){return "alza il pennello"},
"reinfFeedbackMsg":function(d){return "Ecco il tuo disegno! Continua a lavorarci sopra oppure passa al prossimo esercizio."},
"setAlpha":function(d){return "imposta l'opacità"},
"setCharacter":function(d){return "imposta carattere come "+turtle_locale.v(d,"character")},
...
"showMe":function(d){return "Spiega"},
...
"widthTooltip":function(d){return "Cambia la larghezza del pennello."},
